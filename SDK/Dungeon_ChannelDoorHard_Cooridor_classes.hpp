...
class ADungeon_ChannelDoorHard_Cooridor_C : public ACellFeatures_Parent_Starship_C
{
public:
	uint8                                        Pad_2C62[0x7];                                     // Fixing Size After Last Property  
