...
{
public:
	uint8                                        Pad_19C2[0x8];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_19CB[0x10];                                    // Fixing Size After Last Property  
	struct AppleImageUtils_AppleImageUtilsImageConversionResult ConversionResult;                                  // 0x60(0x20)(BlueprintVisible, BlueprintReadOnly, NativeAccessSpecifierPublic)
	uint8                                        Pad_19D2[0x8];                                     // Fixing Size Of Struct 
