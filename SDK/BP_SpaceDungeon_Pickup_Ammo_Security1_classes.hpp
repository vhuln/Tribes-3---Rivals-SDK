...
class ABP_SpaceDungeon_Pickup_Ammo_Security1_C : public ABP_AbilityPickup_Master_C
{
public:
	...
	static class ABP_SpaceDungeon_Pickup_Ammo_Security1_C* GetDefaultObj();
