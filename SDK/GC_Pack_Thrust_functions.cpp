...
class UClass* AGC_Pack_Thrust_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Pack_Thrust_C");

	return Clss;
}


// GC_Pack_Thrust_C GC_Pack_Thrust.Default__GC_Pack_Thrust_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_Pack_Thrust_C* AGC_Pack_Thrust_C::GetDefaultObj()
{
	static class AGC_Pack_Thrust_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_Pack_Thrust_C*>(AGC_Pack_Thrust_C::StaticClass()->DefaultObject);

	return Default;
}


// Function GC_Pack_Thrust.GC_Pack_Thrust_C.OnExecute
