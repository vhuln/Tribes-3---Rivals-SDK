...
struct InterchangeCore_InterchangePipelinePropertyStatePerContext
{
public:
...
struct InterchangeCore_InterchangePipelinePropertyStates
{
public:
	bool                                         Blocked;                                           // 0x0(0x1)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct InterchangeCore_InterchangePipelinePropertyStatePerContext ImportStates;                                      // 0x1(0x1)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	struct InterchangeCore_InterchangePipelinePropertyStatePerContext ReimportStates;                                    // 0x2(0x1)(Edit, NoDestructor, NativeAccessSpecifierPublic)
};

// 0x30 (0x30 - 0x0)
// ScriptStruct InterchangeCore.InterchangeUserDefinedAttributeInfo
struct InterchangeCore_InterchangeUserDefinedAttributeInfo
{
public:
	class FString                                Name;                                              // 0x0(0x10)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_433E[0x20];                                    // Fixing Size Of Struct 
};
