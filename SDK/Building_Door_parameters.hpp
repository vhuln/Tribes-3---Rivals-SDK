...
struct ABuilding_Door_C_ExecuteUbergraph_Building_Door_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_294E[0xC];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_2952[0x7];                                     // Fixing Size After Last Property  
	...
	class ABP_DestructibleDoor_BuildingA_C*      CallFunc_FinishSpawningActor_ReturnValue;          // 0x1B8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
