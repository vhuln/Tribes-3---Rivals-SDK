...
struct AGC_DamageOverTime_Fire_C_WhileActive_Params
{
public:
	...
	uint8                                        Pad_344E[0x7];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_3490[0x7];                                     // Fixing Size After Last Property  
...
struct AGC_DamageOverTime_Fire_C_ToggleVFX_Params
{
public:
...
struct AGC_DamageOverTime_Fire_C_OnRemove_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct GameplayAbilities_GameplayCueParameters Parameters;                                        // 0x8(0xD8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
	bool                                         ReturnValue;                                       // 0xE0(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_36FE[0x3];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_372B[0x1];                                     // Fixing Size After Last Property  
...
struct AGC_DamageOverTime_Fire_C_OnActive_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct GameplayAbilities_GameplayCueParameters Parameters;                                        // 0x8(0xD8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
