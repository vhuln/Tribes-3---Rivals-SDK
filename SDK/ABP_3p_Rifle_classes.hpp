...
class UABP_3p_Rifle_C : public UValCharacterAnimInstance
{
public:
	struct Engine_PointerToUberGraphFrame        UberGraphFrame;                                    // 0x16D0(0x8)(ZeroConstructor, Transient, DuplicateTransient)
	struct ABP_3p_Rifle_ABP_3p_Rifle_C_AnimBlueprintGeneratedMutableData __AnimBlueprintMutables;                           // 0x16D8(0x30)(HasGetValueTypeHash)
	...
	uint8                                        Pad_27B4[0x8];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_2804[0x7];                                     // Fixing Size After Last Property  
