...
struct AGC_Damage_Buff_Station_AOE_C_WhileActive_Params
{
public:
	...
	uint8                                        Pad_1F30[0x7];                                     // Fixing Size After Last Property  
	class AActor*                                CallFunc_GetOwner_ReturnValue;                     // 0x1C0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AValCharacter*                         K2Node_DynamicCast_AsVal_Character;                // 0x1C8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	struct Engine_HitResult                      CallFunc_K2_SetWorldLocation_SweepHitResult;       // 0x1D8(0xE8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
};

// 0xB (0xB - 0x0)
// Function GC_Damage_Buff_Station_AOE.GC_Damage_Buff_Station_AOE_C.UpdateTeamColors
struct AGC_Damage_Buff_Station_AOE_C_UpdateTeamColors_Params
{
public:
	...
	bool                                         CallFunc_IsEnemyWith_ReturnValue;                  // 0x8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct AGC_Damage_Buff_Station_AOE_C_OnRemove_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct GameplayAbilities_GameplayCueParameters Parameters;                                        // 0x8(0xD8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct AGC_Damage_Buff_Station_AOE_C_ReceiveTick_Params
{
public:
...
struct AGC_Damage_Buff_Station_AOE_C_ExecuteUbergraph_GC_Damage_Buff_Station_AOE_Params
{
public:
