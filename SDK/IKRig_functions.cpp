...
// Parameters:
// TMap<class FName, struct IKRig_IKRigGoal>OutGoals                                                         (Parm, OutParm, NativeAccessSpecifierPublic)

void IIKGoalCreatorInterface::AddIKGoals(TMap<class FName, struct IKRig_IKRigGoal>* OutGoals)
{
...
// struct CoreUObject_Transform       Transform                                                        (ConstParm, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UIKRigComponent::SetIKRigGoalTransform(class FName GoalName, const struct CoreUObject_Transform& Transform, float PositionAlpha, float RotationAlpha)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class FName                        GoalName                                                         (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector          Position                                                         (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Quat            Rotation                                                         (ConstParm, Parm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                              PositionAlpha                                                    (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                              RotationAlpha                                                    (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UIKRigComponent::SetIKRigGoalPositionAndRotation(class FName GoalName, const struct CoreUObject_Vector& Position, const struct CoreUObject_Quat& Rotation, float PositionAlpha, float RotationAlpha)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct IKRig_IKRigGoal             Goal                                                             (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UIKRigComponent::SetIKRigGoal(struct IKRig_IKRigGoal& Goal)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct IKRig_RetargetProfile       RetargetProfile                                                  (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct IKRig_TargetRootSettings    RootSettings                                                     (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void UIKRetargeter::SetRootSettingsInRetargetProfile(struct IKRig_RetargetProfile& RetargetProfile, struct IKRig_TargetRootSettings& RootSettings)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct IKRig_RetargetProfile       RetargetProfile                                                  (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct IKRig_RetargetGlobalSettingsGlobalSettings                                                   (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void UIKRetargeter::SetGlobalSettingsInRetargetProfile(struct IKRig_RetargetProfile& RetargetProfile, struct IKRig_RetargetGlobalSettings& GlobalSettings)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct IKRig_RetargetProfile       RetargetProfile                                                  (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct IKRig_TargetChainSpeedPlantSettingsSpeedPlantSettings                                               (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
void UIKRetargeter::SetChainSpeedPlantSettingsInRetargetProfile(struct IKRig_RetargetProfile& RetargetProfile, struct IKRig_TargetChainSpeedPlantSettings& SpeedPlantSettings, class FName TargetChainName)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct IKRig_RetargetProfile       RetargetProfile                                                  (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct IKRig_TargetChainSettings   ChainSettings                                                    (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// class FName                        TargetChainName                                                  (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UIKRetargeter::SetChainSettingsInRetargetProfile(struct IKRig_RetargetProfile& RetargetProfile, struct IKRig_TargetChainSettings& ChainSettings, class FName TargetChainName)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct IKRig_RetargetProfile       RetargetProfile                                                  (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct IKRig_TargetChainIKSettings IKSettings                                                       (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// class FName                        TargetChainName                                                  (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UIKRetargeter::SetChainIKSettingsInRetargetProfile(struct IKRig_RetargetProfile& RetargetProfile, struct IKRig_TargetChainIKSettings& IKSettings, class FName TargetChainName)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct IKRig_RetargetProfile       RetargetProfile                                                  (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct IKRig_TargetChainFKSettings FKSettings                                                       (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// class FName                        TargetChainName                                                  (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UIKRetargeter::SetChainFKSettingsInRetargetProfile(struct IKRig_RetargetProfile& RetargetProfile, struct IKRig_TargetChainFKSettings& FKSettings, class FName TargetChainName)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct IKRig_RetargetProfile       RetargetProfile                                                  (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct IKRig_TargetRootSettings    ReturnValue                                                      (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)

struct IKRig_TargetRootSettings UIKRetargeter::GetRootSettingsFromRetargetProfile(struct IKRig_RetargetProfile& RetargetProfile)
{
	static class UFunction* Func = nullptr;
...
// struct IKRig_TargetRootSettings    OutSettings                                                      (Parm, OutParm, NoDestructor, NativeAccessSpecifierPublic)

void UIKRetargeter::GetRootSettingsFromRetargetAsset(class UIKRetargeter* RetargetAsset, class FName OptionalProfileName, struct IKRig_TargetRootSettings* OutSettings)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct IKRig_RetargetProfile       RetargetProfile                                                  (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct IKRig_RetargetGlobalSettingsReturnValue                                                      (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)

struct IKRig_RetargetGlobalSettings UIKRetargeter::GetGlobalSettingsFromRetargetProfile(struct IKRig_RetargetProfile& RetargetProfile)
{
	static class UFunction* Func = nullptr;
...
// class UIKRetargeter*               RetargetAsset                                                    (ConstParm, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FName                        OptionalProfileName                                              (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct IKRig_RetargetGlobalSettingsOutSettings                                                      (Parm, OutParm, NoDestructor, NativeAccessSpecifierPublic)

void UIKRetargeter::GetGlobalSettingsFromRetargetAsset(class UIKRetargeter* RetargetAsset, class FName OptionalProfileName, struct IKRig_RetargetGlobalSettings* OutSettings)
{
	static class UFunction* Func = nullptr;
...
// struct IKRig_TargetChainSettings   ReturnValue                                                      (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)

struct IKRig_TargetChainSettings UIKRetargeter::GetChainUsingGoalFromRetargetAsset(class UIKRetargeter* RetargetAsset, class FName IKGoalName)
{
	static class UFunction* Func = nullptr;
...
struct IKRig_TargetChainSettings UIKRetargeter::GetChainSettingsFromRetargetProfile(struct IKRig_RetargetProfile& RetargetProfile, class FName TargetChainName)
{
	static class UFunction* Func = nullptr;
...
struct IKRig_TargetChainSettings UIKRetargeter::GetChainSettingsFromRetargetAsset(class UIKRetargeter* RetargetAsset, class FName TargetChainName, class FName OptionalProfileName)
{
	static class UFunction* Func = nullptr;
