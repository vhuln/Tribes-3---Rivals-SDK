...
public:
	...
	uint8                                        Pad_18BF[0x18];                                    // Fixing Size Of Struct 
...
public:
	...
	TMap<class FName, struct InterchangeCore_InterchangePipelinePropertyStates> PropertiesStates;                                  // 0x38(0x50)(Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_1CDF[0x60];                                    // Fixing Size Of Struct 
	...
	struct InterchangeCore_InterchangePipelinePropertyStates FindOrAddPropertyStates(class FName PropertyPath);
...
{
public:
	uint8                                        Pad_1FF9[0x28];                                    // Fixing Size After Last Property  
...
{
public:
	uint8                                        Pad_332F[0x38];                                    // Fixing Size Of Struct 
	...
	bool GetVector2Attribute(const class FString& NodeAttributeKey, struct CoreUObject_Vector2f* OutValue);
	...
	bool GetLinearColorAttribute(const class FString& NodeAttributeKey, struct CoreUObject_LinearColor* OutValue);
	bool GetInt32Attribute(const class FString& NodeAttributeKey, int32* OutValue);
	bool GetGuidAttribute(const class FString& NodeAttributeKey, struct CoreUObject_Guid* OutValue);
	...
	bool AddVector2Attribute(const class FString& NodeAttributeKey, struct CoreUObject_Vector2f& Value);
	...
	bool AddLinearColorAttribute(const class FString& NodeAttributeKey, struct CoreUObject_LinearColor& Value);
	bool AddInt32Attribute(const class FString& NodeAttributeKey, int32& Value);
	bool AddGuidAttribute(const class FString& NodeAttributeKey, struct CoreUObject_Guid& Value);
...
public:
	...
	uint8                                        Pad_3C2B[0x50];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_400D[0xE0];                                    // Fixing Size Of Struct 
	...
	bool SetCustomReferenceObject(struct CoreUObject_SoftObjectPath& AttributeValue);
	...
	bool GetCustomReferenceObject(struct CoreUObject_SoftObjectPath* AttributeValue);
...
{
public:
	uint8                                        Pad_4188[0x70];                                    // Fixing Size Of Struct 
...
public:
	...
	void GetUserDefinedAttributeInfos(class UInterchangeBaseNode* InterchangeNode, TArray<struct InterchangeCore_InterchangeUserDefinedAttributeInfo>* UserDefinedAttributeInfos);
