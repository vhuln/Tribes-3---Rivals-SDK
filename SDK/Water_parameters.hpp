...
{
public:
	struct Water_SphericalPontoon                Pontoon;                                           // 0x0(0x2D0)(ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
...
{
public:
	struct CoreUObject_Vector                    OutWaterPlaneLocation;                             // 0x0(0x18)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    OutWaterPlaneNormal;                               // 0x18(0x18)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    OutWaterSurfacePosition;                           // 0x30(0x18)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct CoreUObject_Vector                    OutWaterVelocity;                                  // 0x50(0x18)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_114D[0x7];                                     // Fixing Size Of Struct 
};
...
{
public:
	TArray<struct Water_GerstnerWave>            OutWaves;                                          // 0x0(0x10)(Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_12BD[0x4];                                     // Fixing Size After Last Property  
...
{
public:
	struct CoreUObject_Vector                    InLocation;                                        // 0x0(0x18)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    OutWaterSurfaceLocation;                           // 0x18(0x18)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    OutWaterSurfaceNormal;                             // 0x30(0x18)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    OutWaterVelocity;                                  // 0x48(0x18)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_143F[0x7];                                     // Fixing Size After Last Property  
...
public:
	...
	uint8                                        Pad_15A1[0x7];                                     // Fixing Size Of Struct 
};
