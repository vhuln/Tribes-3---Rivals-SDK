...
public:
	...
	uint8                                        Pad_121D[0x3];                                     // Fixing Size After Last Property  
...
public:
	...
	uint8                                        Pad_13C7[0x3];                                     // Fixing Size After Last Property  
	float                                        NoiseFloorDb;                                      // 0x38(0x4)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_1546[0x3];                                     // Fixing Size After Last Property  
...
public:
	...
	uint8                                        Pad_1569[0x18];                                    // Fixing Size After Last Property  
	...
	uint8                                        Pad_1573[0x18];                                    // Fixing Size After Last Property  
	...
	uint8                                        Pad_157C[0x18];                                    // Fixing Size After Last Property  
	...
	uint8                                        Pad_1580[0x18];                                    // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_15C5[0x3];                                     // Fixing Size After Last Property  
...
public:
	...
	uint8                                        Pad_17BF[0x18];                                    // Fixing Size After Last Property  
	...
	uint8                                        Pad_17C1[0x18];                                    // Fixing Size Of Struct 
