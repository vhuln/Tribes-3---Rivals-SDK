...
struct InteractiveToolsFramework_GizmoVec2ParameterChange
{
public:
	struct CoreUObject_Vector2D                  InitialValue;                                      // 0x0(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector2D                  CurrentValue;                                      // 0x10(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};

// 0x14 (0x14 - 0x0)
// ScriptStruct InteractiveToolsFramework.GizmoElementColorAttribute
struct InteractiveToolsFramework_GizmoElementColorAttribute
{
public:
	struct CoreUObject_LinearColor               Value;                                             // 0x0(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_3D56[0x2];                                     // Fixing Size Of Struct 
};

// 0xC (0xC - 0x0)
// ScriptStruct InteractiveToolsFramework.GizmoElementMaterialAttribute
struct InteractiveToolsFramework_GizmoElementMaterialAttribute
{
public:
	...
	uint8                                        Pad_3D65[0x3];                                     // Fixing Size Of Struct 
};

// 0x60 (0x60 - 0x0)
// ScriptStruct InteractiveToolsFramework.GizmoElementMeshRenderStateAttributes
struct InteractiveToolsFramework_GizmoElementMeshRenderStateAttributes
{
public:
	struct InteractiveToolsFramework_GizmoElementMaterialAttribute Material;                                          // 0x0(0xC)(NoDestructor, NativeAccessSpecifierPublic)
	struct InteractiveToolsFramework_GizmoElementMaterialAttribute HoverMaterial;                                     // 0xC(0xC)(NoDestructor, NativeAccessSpecifierPublic)
	struct InteractiveToolsFramework_GizmoElementMaterialAttribute InteractMaterial;                                  // 0x18(0xC)(NoDestructor, NativeAccessSpecifierPublic)
	struct InteractiveToolsFramework_GizmoElementColorAttribute VertexColor;                                       // 0x24(0x14)(NoDestructor, NativeAccessSpecifierPublic)
	struct InteractiveToolsFramework_GizmoElementColorAttribute HoverVertexColor;                                  // 0x38(0x14)(NoDestructor, NativeAccessSpecifierPublic)
	struct InteractiveToolsFramework_GizmoElementColorAttribute InteractVertexColor;                               // 0x4C(0x14)(NoDestructor, NativeAccessSpecifierPublic)
};

// 0x3C (0x3C - 0x0)
// ScriptStruct InteractiveToolsFramework.GizmoElementLineRenderStateAttributes
struct InteractiveToolsFramework_GizmoElementLineRenderStateAttributes
{
public:
	struct InteractiveToolsFramework_GizmoElementColorAttribute LineColor;                                         // 0x0(0x14)(NoDestructor, NativeAccessSpecifierPublic)
	struct InteractiveToolsFramework_GizmoElementColorAttribute HoverLineColor;                                    // 0x14(0x14)(NoDestructor, NativeAccessSpecifierPublic)
	struct InteractiveToolsFramework_GizmoElementColorAttribute InteractLineColor;                                 // 0x28(0x14)(NoDestructor, NativeAccessSpecifierPublic)
};

// 0x8 (0x8 - 0x0)
// ScriptStruct InteractiveToolsFramework.GizmoFloatParameterChange
struct InteractiveToolsFramework_GizmoFloatParameterChange
{
public:
...
struct InteractiveToolsFramework_BrushStampData
{
public:
	uint8                                        Pad_3D9B[0x128];                                   // Fixing Size Of Struct 
};

// 0x20 (0x20 - 0x0)
// ScriptStruct InteractiveToolsFramework.BehaviorInfo
struct InteractiveToolsFramework_BehaviorInfo
{
public:
	...
	uint8                                        Pad_3DA0[0x18];                                    // Fixing Size Of Struct 
};

// 0x40 (0x40 - 0x0)
// ScriptStruct InteractiveToolsFramework.InputRayHit
struct InteractiveToolsFramework_InputRayHit
{
public:
	...
	struct CoreUObject_Vector                    HitNormal;                                         // 0x10(0x18)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_3DA8[0x3];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_3DAC[0x8];                                     // Fixing Size After Last Property  
...
struct InteractiveToolsFramework_InputDeviceRay
{
public:
	struct CoreUObject_Ray                       WorldRay;                                          // 0x0(0x30)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_3DB5[0x7];                                     // Fixing Size After Last Property  
	struct CoreUObject_Vector2D                  ScreenPosition;                                    // 0x38(0x10)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};

// 0x30 (0x30 - 0x0)
// ScriptStruct InteractiveToolsFramework.ActiveGizmo
struct InteractiveToolsFramework_ActiveGizmo
{
public:
	...
	uint8                                        Pad_3DBC[0x28];                                    // Fixing Size Of Struct 
};
