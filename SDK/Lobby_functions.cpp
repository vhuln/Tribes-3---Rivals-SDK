...
// Parameters:
// struct Engine_UniqueNetIdRepl      InUniqueId                                                       (ConstParm, Parm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct Engine_UniqueNetIdRepl      InPartyOwnerId                                                   (ConstParm, Parm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void ALobbyBeaconClient::ServerSetPartyOwner(struct Engine_UniqueNetIdRepl& InUniqueId, struct Engine_UniqueNetIdRepl& InPartyOwnerId)
{
...
void ALobbyBeaconClient::ServerLoginPlayer(const class FString& InSessionId, struct Engine_UniqueNetIdRepl& InUniqueId, const class FString& UrlString)
{
	static class UFunction* Func = nullptr;
...
// (Net, NetReliable, Native, Event, Protected, NetServer, NetValidate)
// Parameters:
// struct Engine_UniqueNetIdRepl      PlayerToKick                                                     (ConstParm, Parm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FText                        Reason                                                           (ConstParm, Parm, ReferenceParm, NativeAccessSpecifierPublic)

void ALobbyBeaconClient::ServerKickPlayer(struct Engine_UniqueNetIdRepl& PlayerToKick, class FText& Reason)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct CoreOnline_JoinabilitySettingsSettings                                                         (ConstParm, Parm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void ALobbyBeaconClient::ClientSetInviteFlags(struct CoreOnline_JoinabilitySettings& Settings)
{
	static class UFunction* Func = nullptr;
...
void ALobbyBeaconClient::ClientPlayerLeft(struct Engine_UniqueNetIdRepl& InUniqueId)
{
	static class UFunction* Func = nullptr;
...
void ALobbyBeaconClient::ClientPlayerJoined(class FText& NewPlayerName, struct Engine_UniqueNetIdRepl& InUniqueId)
{
	static class UFunction* Func = nullptr;
...
void ALobbyBeaconClient::ClientLoginComplete(struct Engine_UniqueNetIdRepl& InUniqueId, bool bWasSuccessful)
{
	static class UFunction* Func = nullptr;
