...
// Parameters:
// struct MovieSceneCapture_CapturedPixelsIDStreamID                                                         (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void UUserDefinedCaptureProtocol::StartCapturingFinalPixels(struct MovieSceneCapture_CapturedPixelsID& StreamID)
{
	static class UFunction* Func = nullptr;
...
// struct MovieSceneCapture_CapturedPixelsIDBufferID                                                         (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void UUserDefinedCaptureProtocol::ResolveBuffer(class UTexture* Buffer, struct MovieSceneCapture_CapturedPixelsID& BufferID)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct MovieSceneCapture_CapturedPixelsPixels                                                           (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct MovieSceneCapture_CapturedPixelsIDID                                                               (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct MovieSceneCapture_FrameMetricsFrameMetrics                                                     (Parm, NoDestructor, NativeAccessSpecifierPublic)

void UUserDefinedCaptureProtocol::OnPixelsReceived(struct MovieSceneCapture_CapturedPixels& Pixels, struct MovieSceneCapture_CapturedPixelsID& ID, const struct MovieSceneCapture_FrameMetrics& FrameMetrics)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// struct MovieSceneCapture_FrameMetricsReturnValue                                                      (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)

struct MovieSceneCapture_FrameMetrics UUserDefinedCaptureProtocol::GetCurrentFrameMetrics()
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct MovieSceneCapture_FrameMetricsInFrameMetrics                                                   (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// class FString                      ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class FString UUserDefinedCaptureProtocol::GenerateFilename(struct MovieSceneCapture_FrameMetrics& InFrameMetrics)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct MovieSceneCapture_CapturedPixelsPixelData                                                        (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct MovieSceneCapture_CapturedPixelsIDStreamID                                                         (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct MovieSceneCapture_FrameMetricsFrameMetrics                                                     (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// bool                               bCopyImageData                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UUserDefinedImageCaptureProtocol::WriteImageToDisk(struct MovieSceneCapture_CapturedPixels& PixelData, struct MovieSceneCapture_CapturedPixelsID& StreamID, struct MovieSceneCapture_FrameMetrics& FrameMetrics, bool bCopyImageData)
{
	static class UFunction* Func = nullptr;
...
class FString UUserDefinedImageCaptureProtocol::GenerateFilenameForBuffer(class UTexture* Buffer, struct MovieSceneCapture_CapturedPixelsID& StreamID)
{
	static class UFunction* Func = nullptr;
