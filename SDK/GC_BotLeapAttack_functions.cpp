...
class UClass* AGC_BotLeapAttack_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_BotLeapAttack_C");

	return Clss;
}


// GC_BotLeapAttack_C GC_BotLeapAttack.Default__GC_BotLeapAttack_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_BotLeapAttack_C* AGC_BotLeapAttack_C::GetDefaultObj()
{
	static class AGC_BotLeapAttack_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_BotLeapAttack_C*>(AGC_BotLeapAttack_C::StaticClass()->DefaultObject);
...
bool AGC_BotLeapAttack_C::OnRemove(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters, class AValCharacter* K2Node_DynamicCast_AsVal_Character, bool K2Node_DynamicCast_bSuccess, class USkeletalMeshComponent* CallFunc_GetMesh3P_ReturnValue, class UAnimInstance* CallFunc_GetAnimInstance_ReturnValue, class UValCharacterAnimInstance* K2Node_DynamicCast_AsVal_Character_Anim_Instance, bool K2Node_DynamicCast_bSuccess_1)
{
	...
	Params::AGC_BotLeapAttack_C_OnRemove_Params Parms{};
...
bool AGC_BotLeapAttack_C::OnActive(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters, class AValCharacter* K2Node_DynamicCast_AsVal_Character, bool K2Node_DynamicCast_bSuccess, class USkeletalMeshComponent* CallFunc_GetMesh3P_ReturnValue, class UAnimInstance* CallFunc_GetAnimInstance_ReturnValue, class UValCharacterAnimInstance* K2Node_DynamicCast_AsVal_Character_Anim_Instance, bool K2Node_DynamicCast_bSuccess_1)
{
	...
	Params::AGC_BotLeapAttack_C_OnActive_Params Parms{};
