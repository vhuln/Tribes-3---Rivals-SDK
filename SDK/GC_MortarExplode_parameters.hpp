...
struct AGC_MortarExplode_C_OnRemove_Params
{
public:
	...
	int32                                        CallFunc_ExecuteAction_ReturnValue;                // 0x1CC(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x34 (0x34 - 0x0)
// Function GC_MortarExplode.GC_MortarExplode_C.PlayFX
struct AGC_MortarExplode_C_PlayFX_Params
{
public:
	...
	class AValCharacter*                         ValChar;                                           // 0x20(0x8)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	...
	float                                        CallFunc_SetVariableFloat_InValue_ImplicitCast;    // 0x30(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x1E8 (0x1E8 - 0x0)
// Function GC_MortarExplode.GC_MortarExplode_C.WhileActive
struct AGC_MortarExplode_C_WhileActive_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct GameplayAbilities_GameplayCueParameters Parameters;                                        // 0x8(0xD8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
	...
	uint8                                        Pad_216E[0x7];                                     // Fixing Size After Last Property  
	double                                       K2Node_VariableSet_Magnitude_ImplicitCast;         // 0x1E0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x4 (0x4 - 0x0)
// Function GC_MortarExplode.GC_MortarExplode_C.ExecuteUbergraph_GC_MortarExplode
struct AGC_MortarExplode_C_ExecuteUbergraph_GC_MortarExplode_Params
{
public:
