...
{
	static_assert(std::is_same_v<SoftObjectPath, CoreUObject_SoftObjectPath>, "Only use this with FSoftObjectPath. This function is only templated as a workaround to C++ type-checks.");

	return reinterpret_cast<CoreUObject_SoftObjectPath&>(ObjectID);
}
