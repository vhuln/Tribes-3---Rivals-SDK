...
struct AGC_EMP_Barrel_Explode_C_OnActive_Params
{
public:
	...
	uint8                                        Pad_31F7[0x7];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_322A[0x7];                                     // Fixing Size After Last Property  
	...
	struct CoreUObject_Vector                    CallFunc_Add_VectorVector_ReturnValue;             // 0x1D0(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	struct CoreUObject_Vector                    CallFunc_Conv_DoubleToVector_ReturnValue;          // 0x208(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_3230[0x7];                                     // Fixing Size After Last Property  
	...
	double                                       CallFunc_Divide_DoubleDouble_A_ImplicitCast;       // 0x318(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                        CallFunc_MakeRotator_Roll_ImplicitCast;            // 0x320(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
