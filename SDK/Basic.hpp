...
class FSoftObjectPtr : public TPersistentObjectPtr<SoftObjPathWrapper::CoreUObject_SoftObjectPath>
{
public:
	FString GetSubPathString();
	std::string GetSubPathStringStr();

	template<class SoftObjectPath = CoreUObject_SoftObjectPath>
...
public:
	...
	uint8                                        Pad_5F10[0x4];                                     // Fixing Size After Last (Predefined) Property  
...
{
public:
	uint8                                        Pad_5F11[0x8];                                     // Fixing Size After Last (Predefined) Property  
	int32                                        ElementSize;                                       // (0x34[0x04]) NOT AUTO-GENERATED PROPERTY
	uint64                                       PropertyFlags;                                     // (0x38[0x08]) NOT AUTO-GENERATED PROPERTY
	uint8                                        Pad_5F12[0x4];                                     // Fixing Size After Last (Predefined) Property  
...
{
public:
	uint8                                        Pad_5F13[0x28];                                    // Fixing Size After Last (Predefined) Property  
...
{
public:
	uint8                                        Pad_5F14[0x28];                                    // Fixing Size After Last (Predefined) Property  
...
{
public:
	uint8                                        Pad_5F15[0x28];                                    // Fixing Size After Last (Predefined) Property  
...
{
public:
	uint8                                        Pad_5F16[0x28];                                    // Fixing Size After Last (Predefined) Property  
...
{
public:
	uint8                                        Pad_5F17[0x30];                                    // Fixing Size After Last (Predefined) Property  
...
{
public:
	uint8                                        Pad_5F18[0x28];                                    // Fixing Size After Last (Predefined) Property  
...
{
public:
	uint8                                        Pad_5F19[0x28];                                    // Fixing Size After Last (Predefined) Property  
...
{
public:
	uint8                                        Pad_5F1A[0x28];                                    // Fixing Size After Last (Predefined) Property  
