...
void UMockDataMeshTrackerComponent::OnMockDataMeshTrackerUpdated__DelegateSignature(int32 Index, TArray<struct CoreUObject_Vector>& Vertices, TArray<int32>& Triangles, TArray<struct CoreUObject_Vector>& Normals, TArray<float>& Confidence)
{
...
// Parameters:
// struct CoreUObject_LinearColor     InColor                                                          (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UMRMeshComponent::SetWireframeColor(struct CoreUObject_LinearColor& InColor)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct CoreUObject_LinearColor     ReturnValue                                                      (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

struct CoreUObject_LinearColor UMRMeshComponent::GetWireframeColor()
{
	static class UFunction* Func = nullptr;
