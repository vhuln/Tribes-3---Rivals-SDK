...
// Parameters:
// struct AIModule_AIRequestID        RequestID                                                        (Parm, NoDestructor, NativeAccessSpecifierPublic)
...
void UAIAsyncTaskBlueprintProxy::OnMoveCompleted(const struct AIModule_AIRequestID& RequestID, enum class EPathFollowingResult MovementResult)
{
...
// Parameters:
// struct GameplayTasks_GameplayResourceSetNewlyClaimed                                                     (Parm, NoDestructor, NativeAccessSpecifierPublic)
// struct GameplayTasks_GameplayResourceSetFreshlyReleased                                                  (Parm, NoDestructor, NativeAccessSpecifierPublic)

void AAIController::OnGameplayTaskResourcesClaimed(const struct GameplayTasks_GameplayResourceSet& NewlyClaimed, const struct GameplayTasks_GameplayResourceSet& FreshlyReleased)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct CoreUObject_Vector          Dest                                                             (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
enum class EPathFollowingRequestResult AAIController::MoveToLocation(struct CoreUObject_Vector& Dest, float AcceptanceRadius, bool bStopOnOverlap, bool bUsePathfinding, bool bProjectDestinationToNavigation, bool bCanStrafe, TSubclassOf<class UNavigationQueryFilter> FilterClass, bool bAllowPartialPath)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct CoreUObject_Vector          FP                                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void AAIController::K2_SetFocalPoint(const struct CoreUObject_Vector& FP)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector AAIController::GetImmediateMoveDestination()
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector AAIController::GetFocalPointOnActor(class AActor* Actor)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector AAIController::GetFocalPoint()
{
	static class UFunction* Func = nullptr;
...
// (RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// struct GameplayTags_GameplayTag    InjectTag                                                        (Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class UBehaviorTree*               BehaviorAsset                                                    (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UBehaviorTreeComponent::SetDynamicSubtree(const struct GameplayTags_GameplayTag& InjectTag, class UBehaviorTree* BehaviorAsset)
{
	static class UFunction* Func = nullptr;
...
double UBehaviorTreeComponent::GetTagCooldownEndTime(const struct GameplayTags_GameplayTag& CooldownTag)
{
	static class UFunction* Func = nullptr;
...
void UBehaviorTreeComponent::AddCooldownTagDuration(const struct GameplayTags_GameplayTag& CooldownTag, float CooldownDuration, bool bAddToExistingDuration)
{
	static class UFunction* Func = nullptr;
...
// struct CoreUObject_Vector          VectorValue                                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UBlackboardComponent::SetValueAsVector(class FName& KeyName, const struct CoreUObject_Vector& VectorValue)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class FName                        KeyName                                                          (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Rotator         VectorValue                                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)

void UBlackboardComponent::SetValueAsRotator(class FName& KeyName, const struct CoreUObject_Rotator& VectorValue)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector UBlackboardComponent::GetValueAsVector(class FName& KeyName)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Rotator UBlackboardComponent::GetValueAsRotator(class FName& KeyName)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class FName                        KeyName                                                          (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Rotator         ResultRotation                                                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UBlackboardComponent::GetRotationFromEntry(class FName& KeyName, struct CoreUObject_Rotator* ResultRotation)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class FName                        KeyName                                                          (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector          ResultLocation                                                   (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UBlackboardComponent::GetLocationFromEntry(class FName& KeyName, struct CoreUObject_Vector* ResultLocation)
{
	static class UFunction* Func = nullptr;
...
void UBTFunctionLibrary::SetBlackboardValueAsVector(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key, const struct CoreUObject_Vector& Value)
{
	static class UFunction* Func = nullptr;
...
void UBTFunctionLibrary::SetBlackboardValueAsString(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key, const class FString& Value)
{
	static class UFunction* Func = nullptr;
...
void UBTFunctionLibrary::SetBlackboardValueAsRotator(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key, const struct CoreUObject_Rotator& Value)
{
	static class UFunction* Func = nullptr;
...
void UBTFunctionLibrary::SetBlackboardValueAsObject(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key, class UObject* Value)
{
	static class UFunction* Func = nullptr;
...
void UBTFunctionLibrary::SetBlackboardValueAsName(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key, class FName Value)
{
	static class UFunction* Func = nullptr;
...
void UBTFunctionLibrary::SetBlackboardValueAsInt(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key, int32 Value)
{
	static class UFunction* Func = nullptr;
...
void UBTFunctionLibrary::SetBlackboardValueAsFloat(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key, float Value)
{
	static class UFunction* Func = nullptr;
...
void UBTFunctionLibrary::SetBlackboardValueAsEnum(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key, uint8 Value)
{
	static class UFunction* Func = nullptr;
...
void UBTFunctionLibrary::SetBlackboardValueAsClass(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key, class UClass* Value)
{
	static class UFunction* Func = nullptr;
...
void UBTFunctionLibrary::SetBlackboardValueAsBool(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key, bool Value)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector UBTFunctionLibrary::GetBlackboardValueAsVector(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key)
{
	static class UFunction* Func = nullptr;
...
class FString UBTFunctionLibrary::GetBlackboardValueAsString(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Rotator UBTFunctionLibrary::GetBlackboardValueAsRotator(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key)
{
	static class UFunction* Func = nullptr;
...
class UObject* UBTFunctionLibrary::GetBlackboardValueAsObject(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key)
{
	static class UFunction* Func = nullptr;
...
class FName UBTFunctionLibrary::GetBlackboardValueAsName(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key)
{
	static class UFunction* Func = nullptr;
...
int32 UBTFunctionLibrary::GetBlackboardValueAsInt(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key)
{
	static class UFunction* Func = nullptr;
...
float UBTFunctionLibrary::GetBlackboardValueAsFloat(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key)
{
	static class UFunction* Func = nullptr;
...
uint8 UBTFunctionLibrary::GetBlackboardValueAsEnum(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key)
{
	static class UFunction* Func = nullptr;
...
class UClass* UBTFunctionLibrary::GetBlackboardValueAsClass(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key)
{
	static class UFunction* Func = nullptr;
...
bool UBTFunctionLibrary::GetBlackboardValueAsBool(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key)
{
	static class UFunction* Func = nullptr;
...
class AActor* UBTFunctionLibrary::GetBlackboardValueAsActor(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key)
{
	static class UFunction* Func = nullptr;
...
void UBTFunctionLibrary::ClearBlackboardValueAsVector(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key)
{
	static class UFunction* Func = nullptr;
...
void UBTFunctionLibrary::ClearBlackboardValue(class UBTNode* NodeOwner, struct AIModule_BlackboardKeySelector& Key)
{
	static class UFunction* Func = nullptr;
...
class APawn* UAIBlueprintHelperLibrary::SpawnAIFromClass(class UObject* WorldContextObject, TSubclassOf<class APawn> PawnClass, class UBehaviorTree* BehaviorTree, const struct CoreUObject_Vector& Location, const struct CoreUObject_Rotator& Rotation, bool bNoCollisionFail, class AActor* Owner)
{
	static class UFunction* Func = nullptr;
...
// struct CoreUObject_Vector          Goal                                                             (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAIBlueprintHelperLibrary::SimpleMoveToLocation(class AController* Controller, struct CoreUObject_Vector& Goal)
{
	static class UFunction* Func = nullptr;
...
bool UAIBlueprintHelperLibrary::IsValidAIRotation(const struct CoreUObject_Rotator& Rotation)
{
	static class UFunction* Func = nullptr;
...
bool UAIBlueprintHelperLibrary::IsValidAILocation(const struct CoreUObject_Vector& Location)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Static, Public, HasDefaults, BlueprintCallable, BlueprintPure)
// Parameters:
// struct CoreUObject_Vector          DirectionVector                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UAIBlueprintHelperLibrary::IsValidAIDirection(const struct CoreUObject_Vector& DirectionVector)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class AController*                 Controller                                                       (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TArray<struct CoreUObject_Vector>  ReturnValue                                                      (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)

TArray<struct CoreUObject_Vector> UAIBlueprintHelperLibrary::GetCurrentPathPoints(class AController* Controller)
{
	static class UFunction* Func = nullptr;
...
// class UObject*                     WorldContextObject                                               (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class APawn*                       Pawn                                                             (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector          Destination                                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
class UAIAsyncTaskBlueprintProxy* UAIBlueprintHelperLibrary::CreateMoveToProxyObject(class UObject* WorldContextObject, class APawn* Pawn, const struct CoreUObject_Vector& Destination, class AActor* TargetActor, float AcceptanceRadius, bool bStopOnOverlap)
{
	static class UFunction* Func = nullptr;
...
// struct CoreUObject_Vector          ResultingLocation                                                (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UEnvQueryContext_BlueprintBase::ProvideSingleLocation(class UObject* QuerierObject, class AActor* QuerierActor, struct CoreUObject_Vector* ResultingLocation)
{
	static class UFunction* Func = nullptr;
...
// class UObject*                     QuerierObject                                                    (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class AActor*                      QuerierActor                                                     (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TArray<struct CoreUObject_Vector>  ResultingLocationSet                                             (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)

void UEnvQueryContext_BlueprintBase::ProvideLocationsSet(class UObject* QuerierObject, class AActor* QuerierActor, TArray<struct CoreUObject_Vector>* ResultingLocationSet)
{
	static class UFunction* Func = nullptr;
...
TArray<struct CoreUObject_Vector> UEnvQueryInstanceBlueprintWrapper::GetResultsAsLocations()
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// TArray<struct CoreUObject_Vector>  ResultLocations                                                  (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UEnvQueryInstanceBlueprintWrapper::GetQueryResultsAsLocations(TArray<struct CoreUObject_Vector>* ResultLocations)
{
	static class UFunction* Func = nullptr;
...
// (RequiredAPI, Event, Public, HasOutParams, BlueprintEvent, Const)
// Parameters:
// TArray<struct CoreUObject_Vector>  ContextLocations                                                 (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)

void UEnvQueryGenerator_BlueprintBase::DoItemGeneration(TArray<struct CoreUObject_Vector>& ContextLocations)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct CoreUObject_Vector          GeneratedVector                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UEnvQueryGenerator_BlueprintBase::AddGeneratedVector(const struct CoreUObject_Vector& GeneratedVector)
{
	static class UFunction* Func = nullptr;
...
void UPathFollowingComponent::OnActorBump(class AActor* SelfActor, class AActor* OtherActor, const struct CoreUObject_Vector& NormalImpulse, struct Engine_HitResult& Hit)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector UPathFollowingComponent::GetPathDestination()
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct CoreUObject_Vector          Left                                                             (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector          Right                                                            (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void ANavLinkProxy::SetSmartLinkEndpoints(struct CoreUObject_Vector& Left, struct CoreUObject_Vector& Right, enum class ENavLinkDirection Direction)
{
	static class UFunction* Func = nullptr;
	...
	Params::ANavLinkProxy_SetSmartLinkEndpoints_Params Parms{};
...
void ANavLinkProxy::ReceiveSmartLinkReached(class AActor* Agent, struct CoreUObject_Vector& Destination)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class UObject*                     WorldContextObject                                               (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector          Start                                                            (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector          End                                                              (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TArray<struct CoreUObject_Vector>  PathPoints                                                       (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UNavLocalGridManager::FindLocalNavigationGridPath(class UObject* WorldContextObject, struct CoreUObject_Vector& Start, struct CoreUObject_Vector& End, TArray<struct CoreUObject_Vector>* PathPoints)
{
	static class UFunction* Func = nullptr;
...
int32 UNavLocalGridManager::AddLocalNavigationGridForPoints(class UObject* WorldContextObject, TArray<struct CoreUObject_Vector>& Locations, int32 Radius2D, float Height, bool bRebuildGrids)
{
	static class UFunction* Func = nullptr;
...
int32 UNavLocalGridManager::AddLocalNavigationGridForPoint(class UObject* WorldContextObject, struct CoreUObject_Vector& Location, int32 Radius2D, float Height, bool bRebuildGrids)
{
	static class UFunction* Func = nullptr;
...
int32 UNavLocalGridManager::AddLocalNavigationGridForCapsule(class UObject* WorldContextObject, struct CoreUObject_Vector& Location, float CapsuleRadius, float CapsuleHalfHeight, int32 Radius2D, float Height, bool bRebuildGrids)
{
	static class UFunction* Func = nullptr;
...
int32 UNavLocalGridManager::AddLocalNavigationGridForBox(class UObject* WorldContextObject, struct CoreUObject_Vector& Location, const struct CoreUObject_Vector& Extent, const struct CoreUObject_Rotator& Rotation, int32 Radius2D, float Height, bool bRebuildGrids)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class AActor*                      Actor                                                            (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct AIModule_ActorPerceptionBlueprintInfoInfo                                                             (Parm, OutParm, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UAIPerceptionComponent::GetActorsPerception(class AActor* Actor, struct AIModule_ActorPerceptionBlueprintInfo* Info)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class UObject*                     WorldContextObject                                               (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct AIModule_AIStimulus         Stimulus                                                         (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
TSubclassOf<class UAISense> UAIPerceptionSystem::GetSenseClassForStimulus(class UObject* WorldContextObject, struct AIModule_AIStimulus& Stimulus)
{
	static class UFunction* Func = nullptr;
...
// struct CoreUObject_Vector          EventLocation                                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector          HitLocation                                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// class FName                        Tag                                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UAISense_Damage::ReportDamageEvent(class UObject* WorldContextObject, class AActor* DamagedActor, class AActor* Instigator, float DamageAmount, const struct CoreUObject_Vector& EventLocation, const struct CoreUObject_Vector& HitLocation, class FName Tag)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class UObject*                     WorldContextObject                                               (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector          NoiseLocation                                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UAISense_Hearing::ReportNoiseEvent(class UObject* WorldContextObject, const struct CoreUObject_Vector& NoiseLocation, float Loudness, class AActor* Instigator, float MaxRange, class FName Tag)
{
	static class UFunction* Func = nullptr;
...
void UAISense_Touch::ReportTouchEvent(class UObject* WorldContextObject, class AActor* TouchReceiver, class AActor* OtherActor, const struct CoreUObject_Vector& Location)
{
	static class UFunction* Func = nullptr;
...
void UPawnSensingComponent::HearNoiseDelegate__DelegateSignature(class APawn* Instigator, struct CoreUObject_Vector& Location, float Volume)
{
	static class UFunction* Func = nullptr;
...
// struct CoreUObject_Vector          GoalLocation                                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
