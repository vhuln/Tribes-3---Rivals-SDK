...
public:
	...
	struct ActorSequence_ActorSequenceObjectReferenceMap ObjectReferences;                                  // 0x70(0x20)(NativeAccessSpecifierPrivate)
...
{
public:
	struct MovieScene_MovieSceneSequencePlaybackSettings PlaybackSettings;                                  // 0xA0(0x20)(Edit, NoDestructor, Protected, NativeAccessSpecifierProtected)
