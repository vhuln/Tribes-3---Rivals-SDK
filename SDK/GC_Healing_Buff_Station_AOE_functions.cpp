...
class UClass* AGC_Healing_Buff_Station_AOE_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Healing_Buff_Station_AOE_C");

	return Clss;
}


// GC_Healing_Buff_Station_AOE_C GC_Healing_Buff_Station_AOE.Default__GC_Healing_Buff_Station_AOE_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_Healing_Buff_Station_AOE_C* AGC_Healing_Buff_Station_AOE_C::GetDefaultObj()
{
	static class AGC_Healing_Buff_Station_AOE_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_Healing_Buff_Station_AOE_C*>(AGC_Healing_Buff_Station_AOE_C::StaticClass()->DefaultObject);
...
bool AGC_Healing_Buff_Station_AOE_C::WhileActive(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters, float CallFunc_BreakGameplayCueParameters_NormalizedMagnitude, float CallFunc_BreakGameplayCueParameters_RawMagnitude, const struct GameplayAbilities_GameplayEffectContextHandle& CallFunc_BreakGameplayCueParameters_EffectContext, const struct GameplayTags_GameplayTag& CallFunc_BreakGameplayCueParameters_MatchedTagName, const struct GameplayTags_GameplayTag& CallFunc_BreakGameplayCueParameters_OriginalTag, const struct GameplayTags_GameplayTagContainer& CallFunc_BreakGameplayCueParameters_AggregatedSourceTags, const struct GameplayTags_GameplayTagContainer& CallFunc_BreakGameplayCueParameters_AggregatedTargetTags, const struct CoreUObject_Vector& CallFunc_BreakGameplayCueParameters_Location, const struct CoreUObject_Vector& CallFunc_BreakGameplayCueParameters_Normal, class AActor* CallFunc_BreakGameplayCueParameters_Instigator, class AActor* CallFunc_BreakGameplayCueParameters_EffectCauser, class UObject* CallFunc_BreakGameplayCueParameters_SourceObject, class UPhysicalMaterial* CallFunc_BreakGameplayCueParameters_PhysicalMaterial, int32 CallFunc_BreakGameplayCueParameters_GameplayEffectLevel, int32 CallFunc_BreakGameplayCueParameters_AbilityLevel, class USceneComponent* CallFunc_BreakGameplayCueParameters_TargetAttachComponent, bool CallFunc_BreakGameplayCueParameters_bReplicateLocationWhenUsingMinimalRepProxy, class ABP_Deployed_Buff_Station_C* K2Node_DynamicCast_AsBP_Deployed_Buff_Station, bool K2Node_DynamicCast_bSuccess, class AActor* CallFunc_GetOwner_ReturnValue, class AValCharacter* K2Node_DynamicCast_AsVal_Character, bool K2Node_DynamicCast_bSuccess_1, const struct Engine_HitResult& CallFunc_K2_SetWorldLocation_SweepHitResult)
{
	...
	Params::AGC_Healing_Buff_Station_AOE_C_WhileActive_Params Parms{};
...
void AGC_Healing_Buff_Station_AOE_C::UpdateTeamColors(class APlayerController* CallFunc_GetPlayerController_ReturnValue, bool CallFunc_IsEnemyWith_ReturnValue, bool CallFunc_IsLocallyViewed_ReturnValue, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::AGC_Healing_Buff_Station_AOE_C_UpdateTeamColors_Params Parms{};
...
bool AGC_Healing_Buff_Station_AOE_C::OnRemove(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;
	...
	Params::AGC_Healing_Buff_Station_AOE_C_OnRemove_Params Parms{};
...
void AGC_Healing_Buff_Station_AOE_C::ReceiveTick(float DeltaSeconds)
{
	...
	Params::AGC_Healing_Buff_Station_AOE_C_ReceiveTick_Params Parms{};
...
void AGC_Healing_Buff_Station_AOE_C::ExecuteUbergraph_GC_Healing_Buff_Station_AOE(int32 EntryPoint, float K2Node_Event_DeltaSeconds)
{
	static class UFunction* Func = nullptr;
	...
	Params::AGC_Healing_Buff_Station_AOE_C_ExecuteUbergraph_GC_Healing_Buff_Station_AOE_Params Parms{};
