...
class UClass* UGA_Skydive_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_Skydive_C");

	return Clss;
}


// GA_Skydive_C GA_Skydive.Default__GA_Skydive_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_Skydive_C* UGA_Skydive_C::GetDefaultObj()
{
	static class UGA_Skydive_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_Skydive_C*>(UGA_Skydive_C::StaticClass()->DefaultObject);

	return Default;
}


// Function GA_Skydive.GA_Skydive_C.K2_ActivateAbility
// (Event, Protected, BlueprintEvent)
// Parameters:

void UGA_Skydive_C::K2_ActivateAbility()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GA_Skydive_C", "K2_ActivateAbility");
...
void UGA_Skydive_C::K2_OnEndAbility(bool bWasCancelled, bool bWasRetriggered)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GA_Skydive_C", "K2_OnEndAbility");

	Params::UGA_Skydive_C_K2_OnEndAbility_Params Parms{};
