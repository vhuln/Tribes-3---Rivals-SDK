...
{
public:
	uint8                                        Pad_18D5[0x30];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_1925[0x30];                                    // Fixing Size Of Struct 
	...
	bool SetCustomGlobalTransform(struct CoreUObject_Transform& AttributeValue, bool bAddApplyDelegate);
	bool SetCustomActorClassName(const class FString& AttributeValue);
	bool GetCustomMobility(uint8* AttributeValue);
	bool GetCustomGlobalTransform(struct CoreUObject_Transform* AttributeValue);
...
{
public:
	uint8                                        Pad_1992[0x40];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_1A68[0x60];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_1ACA[0x40];                                    // Fixing Size Of Struct 
	...
	bool SetCustomLightColor(struct CoreUObject_Color& AttributeValue, bool bAddApplyDelegate);
	...
	bool GetCustomLightColor(struct CoreUObject_Color* AttributeValue);
...
{
public:
	uint8                                        Pad_1B23[0x30];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_1B66[0x20];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_1B8C[0x20];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_1BBA[0x20];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_1BE3[0x30];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_1C18[0x20];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_1C77[0x50];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_21AE[0x290];                                   // Fixing Size Of Struct 
	...
	bool SetCustomPaddingColor(struct CoreUObject_Color& AttributeValue, bool bAddApplyDelegate);
	...
	bool SetCustomChromaKeyColor(struct CoreUObject_Color& AttributeValue, bool bAddApplyDelegate);
	...
	bool SetCustomAlphaCoverageThresholds(struct CoreUObject_Vector4& AttributeValue, bool bAddApplyDelegate);
	...
	bool GetCustomPaddingColor(struct CoreUObject_Color* AttributeValue);
	...
	bool GetCustomChromaKeyColor(struct CoreUObject_Color* AttributeValue);
	...
	bool GetCustomAlphaCoverageThresholds(struct CoreUObject_Vector4* AttributeValue);
...
{
public:
	uint8                                        Pad_2205[0x30];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_2272[0x98];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_22D7[0x20];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_257F[0x340];                                   // Fixing Size Of Struct 

	static class UClass* StaticClass();
	static class UInterchangeAnimSequenceFactoryNode* GetDefaultObj();

	bool SetCustomSkeletonSoftObjectPath(struct CoreUObject_SoftObjectPath& AttributeValue);
	...
	void GetSceneNodeAnimationPayloadKeys(TMap<class FString, struct InterchangeNodes_InterchangeAnimationPayLoadKey>* OutSceneNodeAnimationPayloadKeys);
	class UClass* GetObjectClass();
	void GetMorphTargetNodeAnimationPayloadKeys(TMap<class FString, struct InterchangeNodes_InterchangeAnimationPayLoadKey>* OutMorphTargetNodeAnimationPayloads);
	bool GetCustomSkeletonSoftObjectPath(struct CoreUObject_SoftObjectPath* AttributeValue);
...
{
public:
	uint8                                        Pad_2619[0x20];                                    // Fixing Size Of Struct 

	static class UClass* StaticClass();
	static class UInterchangeCommonPipelineDataFactoryNode* GetDefaultObj();

	bool SetCustomGlobalOffsetTransform(class UInterchangeBaseNodeContainer* NodeContainer, struct CoreUObject_Transform& AttributeValue);
	bool SetBakeMeshes(class UInterchangeBaseNodeContainer* NodeContainer, bool& AttributeValue);
	bool GetCustomGlobalOffsetTransform(struct CoreUObject_Transform* AttributeValue);
...
{
public:
	uint8                                        Pad_2A98[0x70];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_2AEB[0x10];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_2B2E[0x20];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_2B6F[0x10];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_2C1D[0x98];                                    // Fixing Size Of Struct 
	...
	bool SetCustomGeometricTransform(struct CoreUObject_Transform& AttributeValue);
	...
	bool GetCustomGeometricTransform(struct CoreUObject_Transform* AttributeValue);
...
{
public:
	uint8                                        Pad_2E1F[0x170];                                   // Fixing Size Of Struct 
	...
	bool SetCustomVertexColorOverride(struct CoreUObject_Color& AttributeValue);
	...
	bool GetCustomVertexColorOverride(struct CoreUObject_Color* AttributeValue);
...
{
public:
	uint8                                        Pad_2FF6[0xC8];                                    // Fixing Size Of Struct 
	...
	bool SetCustomSkeletonSoftObjectPath(struct CoreUObject_SoftObjectPath& AttributeValue);
	bool SetCustomPhysicAssetSoftObjectPath(struct CoreUObject_SoftObjectPath& AttributeValue);
	...
	bool GetCustomSkeletonSoftObjectPath(struct CoreUObject_SoftObjectPath* AttributeValue);
	bool GetCustomPhysicAssetSoftObjectPath(struct CoreUObject_SoftObjectPath* AttributeValue);
...
{
public:
	uint8                                        Pad_3095[0x30];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_344B[0xE8];                                    // Fixing Size Of Struct 
	...
	bool SetCustomDistanceFieldReplacementMesh(struct CoreUObject_SoftObjectPath& AttributeValue, bool bAddApplyDelegate);
	bool SetCustomBuildScale3D(struct CoreUObject_Vector& AttributeValue, bool bAddApplyDelegate);
	...
	bool GetCustomDistanceFieldReplacementMesh(struct CoreUObject_SoftObjectPath* AttributeValue);
	bool GetCustomBuildScale3D(struct CoreUObject_Vector* AttributeValue);
...
{
public:
	uint8                                        Pad_35F6[0xC0];                                    // Fixing Size Of Struct 
