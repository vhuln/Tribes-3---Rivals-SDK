...
public:
	enum class ELocationAccuracy                 Accuracy;                                          // 0x0(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_3C0[0x3];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_3C2[0x3];                                      // Fixing Size Of Struct 
};
...
{
public:
	struct LocationServicesBPLibrary_LocationServicesData ReturnValue;                                       // 0x0(0x18)(Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)
};
