...
class UClass* IAudioComponentGroupExtension::StaticClass()
{
...
class IAudioComponentGroupExtension* IAudioComponentGroupExtension::GetDefaultObj()
{
	static class IAudioComponentGroupExtension* Default = nullptr;

	if (!Default)
		Default = static_cast<IAudioComponentGroupExtension*>(IAudioComponentGroupExtension::StaticClass()->DefaultObject);
...
bool IAudioGameplayCondition::ConditionMet_Position(struct CoreUObject_Vector& Position)
{
...
// Parameters:
// TArray<struct AudioExtensions_AudioParameter>ReturnValue                                                      (ConstParm, Parm, OutParm, ZeroConstructor, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)

TArray<struct AudioExtensions_AudioParameter> UAudioParameterComponent::GetParameters()
{
	static class UFunction* Func = nullptr;
