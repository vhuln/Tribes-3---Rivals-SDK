...
// struct SmartObjectsModule_SmartObjectClaimHandleClaimHandle                                                      (Parm, NoDestructor, NativeAccessSpecifierPublic)
...
class UAITask_UseGameplayBehaviorSmartObject* UAITask_UseGameplayBehaviorSmartObject::UseSmartObjectWithGameplayBehavior(class AAIController* Controller, const struct SmartObjectsModule_SmartObjectClaimHandle& ClaimHandle, bool bLockAILogic)
{
...
class UAITask_UseGameplayBehaviorSmartObject* UAITask_UseGameplayBehaviorSmartObject::MoveToAndUseSmartObjectWithGameplayBehavior(class AAIController* Controller, const struct SmartObjectsModule_SmartObjectClaimHandle& ClaimHandle, bool bLockAILogic)
{
	static class UFunction* Func = nullptr;
