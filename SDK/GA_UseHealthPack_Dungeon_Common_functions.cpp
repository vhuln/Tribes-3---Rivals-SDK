...
// BlueprintGeneratedClass GA_UseHealthPack_Dungeon_Common.GA_UseHealthPack_Dungeon_Common_C
// (None)

class UClass* UGA_UseHealthPack_Dungeon_Common_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GA_UseHealthPack_Dungeon_Common_C");

	return Clss;
}


// GA_UseHealthPack_Dungeon_Common_C GA_UseHealthPack_Dungeon_Common.Default__GA_UseHealthPack_Dungeon_Common_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UGA_UseHealthPack_Dungeon_Common_C* UGA_UseHealthPack_Dungeon_Common_C::GetDefaultObj()
{
	static class UGA_UseHealthPack_Dungeon_Common_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UGA_UseHealthPack_Dungeon_Common_C*>(UGA_UseHealthPack_Dungeon_Common_C::StaticClass()->DefaultObject);
...
void UGA_UseHealthPack_Dungeon_Common_C::GetHealingAmount(double IncomingMagnitude, double* Value, double CallFunc_Multiply_DoubleDouble_ReturnValue, class AActor* CallFunc_GetAvatarActorFromActorInfo_ReturnValue, class AValCharacter* K2Node_DynamicCast_AsVal_Character, bool K2Node_DynamicCast_bSuccess, int32 CallFunc_GetHealthMax_ReturnValue, double CallFunc_Conv_IntToDouble_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GA_UseHealthPack_Dungeon_Common_C", "GetHealingAmount");

	Params::UGA_UseHealthPack_Dungeon_Common_C_GetHealingAmount_Params Parms{};
...
bool UGA_UseHealthPack_Dungeon_Common_C::K2_CanActivateAbility(const struct GameplayAbilities_GameplayAbilityActorInfo& ActorInfo, const struct GameplayAbilities_GameplayAbilitySpecHandle& Handle, struct GameplayTags_GameplayTagContainer* RelevantTags, bool CallFunc_IsDedicatedServer_ReturnValue, class AValCharacter* K2Node_DynamicCast_AsVal_Character, bool K2Node_DynamicCast_bSuccess, class AValPlayerController* CallFunc_GetPlayer_ReturnValue, int32 CallFunc_GetHealthMax_ReturnValue, int32 CallFunc_GetHealth_ReturnValue, class UAbilitySystemComponent* CallFunc_GetAbilitySystemComponent_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, TScriptInterface<class IGameplayTagAssetInterface> CallFunc_HasMatchingGameplayTag_self_CastInput, bool CallFunc_HasMatchingGameplayTag_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_BooleanAND_ReturnValue_1)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GA_UseHealthPack_Dungeon_Common_C", "K2_CanActivateAbility");

	Params::UGA_UseHealthPack_Dungeon_Common_C_K2_CanActivateAbility_Params Parms{};
...
// Function GA_UseHealthPack_Dungeon_Common.GA_UseHealthPack_Dungeon_Common_C.Take Cost
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void UGA_UseHealthPack_Dungeon_Common_C::Take_Cost()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GA_UseHealthPack_Dungeon_Common_C", "Take Cost");
...
// Function GA_UseHealthPack_Dungeon_Common.GA_UseHealthPack_Dungeon_Common_C.K2_ActivateAbility
// (Event, Protected, BlueprintEvent)
// Parameters:

void UGA_UseHealthPack_Dungeon_Common_C::K2_ActivateAbility()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GA_UseHealthPack_Dungeon_Common_C", "K2_ActivateAbility");
...
// Function GA_UseHealthPack_Dungeon_Common.GA_UseHealthPack_Dungeon_Common_C.BeginPlay
// (Event, Public, BlueprintEvent)
// Parameters:

void UGA_UseHealthPack_Dungeon_Common_C::BeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GA_UseHealthPack_Dungeon_Common_C", "BeginPlay");
