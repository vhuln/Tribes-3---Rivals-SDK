...
{
public:
	uint8                                        Pad_1FB[0x30];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_20C[0x10];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_227[0x40];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_25A[0x50];                                     // Fixing Size Of Struct 
	...
	bool GetCustomAnimationPayloadKey(struct InterchangeNodes_InterchangeAnimationPayLoadKey* AnimationPayLoadKey);
...
{
public:
	uint8                                        Pad_277[0x10];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_319[0x220];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_437[0x40];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_685[0x60];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_796[0x40];                                     // Fixing Size Of Struct 
	...
	bool SetCustomLightColor(struct CoreUObject_LinearColor& AttributeValue);
	...
	bool GetCustomLightColor(struct CoreUObject_LinearColor* AttributeValue);
...
{
public:
	uint8                                        Pad_856[0x30];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_9E7[0x20];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_A78[0x20];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_AFA[0x20];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_BE3[0x30];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_D3E[0x40];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_EEE[0x20];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_12C7[0x10];                                    // Fixing Size Of Struct 

	static class UClass* StaticClass();
	static class UInterchangeMaterialInstanceNode* GetDefaultObj();

	bool SetCustomParent(const class FString& AttributeValue);
	bool GetVectorParameterValue(const class FString& ParameterName, struct CoreUObject_LinearColor* AttributeValue);
	...
	bool AddVectorParameterValue(const class FString& ParameterName, struct CoreUObject_LinearColor& AttributeValue);
...
{
public:
	uint8                                        Pad_1CD7[0x188];                                   // Fixing Size Of Struct 
	...
	bool SetCustomBoundingBox(struct CoreUObject_Box& AttributeValue);
	...
	bool GetCustomBoundingBox(struct CoreUObject_Box* AttributeValue);
};
...
{
public:
	uint8                                        Pad_2C7F[0x2C0];                                   // Fixing Size Of Struct 
	...
	bool SetCustomTimeZeroLocalTransform(class UInterchangeBaseNodeContainer* BaseNodeContainer, struct CoreUObject_Transform& AttributeValue, bool bResetCache);
	bool SetCustomLocalTransform(class UInterchangeBaseNodeContainer* BaseNodeContainer, struct CoreUObject_Transform& AttributeValue, bool bResetCache);
	bool SetCustomGeometricTransform(struct CoreUObject_Transform& AttributeValue);
	bool SetCustomBindPoseLocalTransform(class UInterchangeBaseNodeContainer* BaseNodeContainer, struct CoreUObject_Transform& AttributeValue, bool bResetCache);
	...
	bool GetCustomTimeZeroLocalTransform(struct CoreUObject_Transform* AttributeValue);
	bool GetCustomTimeZeroGlobalTransform(class UInterchangeBaseNodeContainer* BaseNodeContainer, struct CoreUObject_Transform& GlobalOffsetTransform, struct CoreUObject_Transform* AttributeValue, bool bForceRecache);
	bool GetCustomLocalTransform(struct CoreUObject_Transform* AttributeValue);
	bool GetCustomGlobalTransform(class UInterchangeBaseNodeContainer* BaseNodeContainer, struct CoreUObject_Transform& GlobalOffsetTransform, struct CoreUObject_Transform* AttributeValue, bool bForceRecache);
	bool GetCustomGeometricTransform(struct CoreUObject_Transform* AttributeValue);
	bool GetCustomBindPoseLocalTransform(struct CoreUObject_Transform* AttributeValue);
	bool GetCustomBindPoseGlobalTransform(class UInterchangeBaseNodeContainer* BaseNodeContainer, struct CoreUObject_Transform& GlobalOffsetTransform, struct CoreUObject_Transform* AttributeValue, bool bForceRecache);
...
{
public:
	uint8                                        Pad_3581[0x10];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_363C[0x10];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_3A6C[0x50];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_3B8E[0x98];                                    // Fixing Size Of Struct 
