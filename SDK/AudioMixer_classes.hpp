...
{
public:
	uint8                                        Pad_3EE[0x60];                                     // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_40A[0x18];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_40D[0x18];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_412[0x18];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_419[0x18];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_41C[0x18];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_41D[0x18];                                     // Fixing Size Of Struct 
...
public:
	...
	TArray<struct Engine_SoundSubmixSpectralAnalysisBandSettings> MakePresetSpectralAnalysisBandSettings(enum class EAudioSpectrumBandPresetType InBandPresetType, int32 InNumBands, int32 InAttackTimeMsec, int32 InReleaseTimeMsec);
	TArray<struct Engine_SoundSubmixSpectralAnalysisBandSettings> MakeMusicalSpectralAnalysisBandSettings(int32 InNumSemitones, enum class EMusicalNoteName InStartingMusicalNote, int32 InStartingOctave, int32 InAttackTimeMsec, int32 InReleaseTimeMsec);
	TArray<struct Engine_SoundSubmixSpectralAnalysisBandSettings> MakeFullSpectrumSpectralAnalysisBandSettings(int32 InNumBands, float InMinimumFrequency, float InMaximumFrequency, int32 InAttackTimeMsec, int32 InReleaseTimeMsec);
	...
	class FString Conv_AudioOutputDeviceInfoToString(struct AudioMixer_AudioOutputDeviceInfo& Info);
	...
	void AddSourceEffectToPresetChain(class UObject* WorldContextObject, class USoundEffectSourcePresetChain* PresetChain, const struct Engine_SourceEffectChainEntry& Entry);
...
public:
	...
	uint8                                        Pad_A46[0x18];                                     // Fixing Size Of Struct 
...
public:
	...
	uint8                                        BitPad_47 : 4;                                     // Fixing Bit-Field Size  
	...
	uint8                                        BitPad_48 : 5;                                     // Fixing Bit-Field Size  
	uint8                                        Pad_C23[0x3];                                      // Fixing Size After Last Property  
	...
	struct Engine_SoundAttenuationSettings       AttenuationOverrides;                              // 0x2B0(0x3D0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	...
	struct Engine_SoundModulationDefaultRoutingSettings ModulationRouting;                                 // 0x6D8(0x168)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	...
	TArray<struct Engine_SoundSubmixSendInfo>    SoundSubmixSends;                                  // 0x858(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct Engine_SoundSourceBusSendInfo> BusSends;                                          // 0x868(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct Engine_SoundSourceBusSendInfo> PreEffectBusSends;                                 // 0x878(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
	...
	uint8                                        BitPad_49 : 6;                                     // Fixing Bit-Field Size  
	uint8                                        Pad_C3D[0x3];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_C4F[0x20];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_C55[0x28];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_CBB[0x88];                                     // Fixing Size After Last Property  
	struct AudioMixer_SubmixEffectDynamicsProcessorSettings Settings;                                          // 0xF0(0x60)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)

	static class UClass* StaticClass();
	static class USubmixEffectDynamicsProcessorPreset* GetDefaultObj();

	void SetSettings(struct AudioMixer_SubmixEffectDynamicsProcessorSettings& Settings);
...
{
public:
	uint8                                        Pad_CF4[0x38];                                     // Fixing Size After Last Property  
	struct AudioMixer_SubmixEffectSubmixEQSettings Settings;                                          // 0xA0(0x10)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)

	static class UClass* StaticClass();
	static class USubmixEffectSubmixEQPreset* GetDefaultObj();

	void SetSettings(struct AudioMixer_SubmixEffectSubmixEQSettings& InSettings);
};
...
{
public:
	uint8                                        Pad_D5B[0x68];                                     // Fixing Size After Last Property  
	struct AudioMixer_SubmixEffectReverbSettings Settings;                                          // 0xD0(0x40)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	void SetSettings(struct AudioMixer_SubmixEffectReverbSettings& InSettings);
};
...
{
public:
	uint8                                        Pad_D7E[0x80];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_16E9[0x1C8];                                   // Fixing Size Of Struct 
	...
	void StartOtherClock(class UObject* WorldContextObject, class FName OtherClockName, const struct Engine_QuartzQuantizationBoundary& InQuantizationBoundary, FDelegateProperty_& InDelegate);
	void StartClock(class UObject* WorldContextObject, class UQuartzClockHandle** ClockHandle);
	void SetTicksPerSecond(class UObject* WorldContextObject, struct Engine_QuartzQuantizationBoundary& QuantizationBoundary, FDelegateProperty_& Delegate, class UQuartzClockHandle** ClockHandle, float TicksPerSecond);
	void SetThirtySecondNotesPerMinute(class UObject* WorldContextObject, struct Engine_QuartzQuantizationBoundary& QuantizationBoundary, FDelegateProperty_& Delegate, class UQuartzClockHandle** ClockHandle, float ThirtySecondsNotesPerMinute);
	void SetSecondsPerTick(class UObject* WorldContextObject, struct Engine_QuartzQuantizationBoundary& QuantizationBoundary, FDelegateProperty_& Delegate, class UQuartzClockHandle** ClockHandle, float SecondsPerTick);
	void SetMillisecondsPerTick(class UObject* WorldContextObject, struct Engine_QuartzQuantizationBoundary& QuantizationBoundary, FDelegateProperty_& Delegate, class UQuartzClockHandle** ClockHandle, float MillisecondsPerTick);
	void SetBeatsPerMinute(class UObject* WorldContextObject, struct Engine_QuartzQuantizationBoundary& QuantizationBoundary, FDelegateProperty_& Delegate, class UQuartzClockHandle** ClockHandle, float BeatsPerMinute);
	void ResumeClock(class UObject* WorldContextObject, class UQuartzClockHandle** ClockHandle);
	void ResetTransportQuantized(class UObject* WorldContextObject, const struct Engine_QuartzQuantizationBoundary& InQuantizationBoundary, FDelegateProperty_& InDelegate, class UQuartzClockHandle** ClockHandle);
	...
	void NotifyOnQuantizationBoundary(class UObject* WorldContextObject, const struct Engine_QuartzQuantizationBoundary& InQuantizationBoundary, FDelegateProperty_& InDelegate, float InMsOffset);
	...
	struct Engine_QuartzTransportTimeStamp GetCurrentTimestamp(class UObject* WorldContextObject);
...
{
public:
	uint8                                        Pad_1EB7[0x20];                                    // Fixing Size Of Struct 
	...
	struct Engine_QuartzTransportTimeStamp GetCurrentClockTimestamp(class UObject* WorldContextObject, class FName& InClockName);
	...
	class UQuartzClockHandle* CreateNewClock(class UObject* WorldContextObject, class FName ClockName, const struct Engine_QuartzClockSettings& InSettings, bool bOverrideSettingsIfClockExists, bool bUseAudioEngineClockManager);
};
