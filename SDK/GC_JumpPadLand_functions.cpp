...
class UClass* AGC_JumpPadLand_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_JumpPadLand_C");

	return Clss;
}


// GC_JumpPadLand_C GC_JumpPadLand.Default__GC_JumpPadLand_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_JumpPadLand_C* AGC_JumpPadLand_C::GetDefaultObj()
{
	static class AGC_JumpPadLand_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_JumpPadLand_C*>(AGC_JumpPadLand_C::StaticClass()->DefaultObject);
...
void AGC_JumpPadLand_C::PlayFX(double ExplosionRadius, const struct CoreUObject_Vector& Location, class UValGrenadeAudioVisual* AV, class AActor* Owner, class UNiagaraComponent* CallFunc_SpawnSystemAtLocation_ReturnValue, bool CallFunc_IsValid_ReturnValue, float CallFunc_SetVariableFloat_InValue_ImplicitCast)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GC_JumpPadLand_C", "PlayFX");

	Params::AGC_JumpPadLand_C_PlayFX_Params Parms{};
...
// float                              Magnitude                                                        (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
bool AGC_JumpPadLand_C::WhileActive(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters, const struct CoreUObject_Vector& Location, float Magnitude, float CallFunc_BreakGameplayCueParameters_NormalizedMagnitude, float CallFunc_BreakGameplayCueParameters_RawMagnitude, const struct GameplayAbilities_GameplayEffectContextHandle& CallFunc_BreakGameplayCueParameters_EffectContext, const struct GameplayTags_GameplayTag& CallFunc_BreakGameplayCueParameters_MatchedTagName, const struct GameplayTags_GameplayTag& CallFunc_BreakGameplayCueParameters_OriginalTag, const struct GameplayTags_GameplayTagContainer& CallFunc_BreakGameplayCueParameters_AggregatedSourceTags, const struct GameplayTags_GameplayTagContainer& CallFunc_BreakGameplayCueParameters_AggregatedTargetTags, const struct CoreUObject_Vector& CallFunc_BreakGameplayCueParameters_Location, const struct CoreUObject_Vector& CallFunc_BreakGameplayCueParameters_Normal, class AActor* CallFunc_BreakGameplayCueParameters_Instigator, class AActor* CallFunc_BreakGameplayCueParameters_EffectCauser, class UObject* CallFunc_BreakGameplayCueParameters_SourceObject, class UPhysicalMaterial* CallFunc_BreakGameplayCueParameters_PhysicalMaterial, int32 CallFunc_BreakGameplayCueParameters_GameplayEffectLevel, int32 CallFunc_BreakGameplayCueParameters_AbilityLevel, class USceneComponent* CallFunc_BreakGameplayCueParameters_TargetAttachComponent, bool CallFunc_BreakGameplayCueParameters_bReplicateLocationWhenUsingMinimalRepProxy, class ABP_JumpPad_C* K2Node_DynamicCast_AsBP_Jump_Pad, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsValid_ReturnValue, double CallFunc_PlayFX_ExplosionRadius_ImplicitCast)
{
	...
	Parms.K2Node_DynamicCast_AsBP_Jump_Pad = K2Node_DynamicCast_AsBP_Jump_Pad;
	Parms.K2Node_DynamicCast_bSuccess = K2Node_DynamicCast_bSuccess;
	Parms.CallFunc_IsValid_ReturnValue = CallFunc_IsValid_ReturnValue;
	Parms.CallFunc_PlayFX_ExplosionRadius_ImplicitCast = CallFunc_PlayFX_ExplosionRadius_ImplicitCast;
