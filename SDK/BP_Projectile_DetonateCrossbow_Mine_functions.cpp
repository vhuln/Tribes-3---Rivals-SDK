...
class UClass* ABP_Projectile_DetonateCrossbow_Mine_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_Projectile_DetonateCrossbow_Mine_C");

	return Clss;
}


// BP_Projectile_DetonateCrossbow_Mine_C BP_Projectile_DetonateCrossbow_Mine.Default__BP_Projectile_DetonateCrossbow_Mine_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_Projectile_DetonateCrossbow_Mine_C* ABP_Projectile_DetonateCrossbow_Mine_C::GetDefaultObj()
{
	static class ABP_Projectile_DetonateCrossbow_Mine_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_Projectile_DetonateCrossbow_Mine_C*>(ABP_Projectile_DetonateCrossbow_Mine_C::StaticClass()->DefaultObject);

	return Default;
}


// Function BP_Projectile_DetonateCrossbow_Mine.BP_Projectile_DetonateCrossbow_Mine_C.Spawn on Projectile Impact
...
// Function BP_Projectile_DetonateCrossbow_Mine.BP_Projectile_DetonateCrossbow_Mine_C.Spawn Actor
...
void ABP_Projectile_DetonateCrossbow_Mine_C::Spawn_Actor(const struct Engine_HitResult& Hit, class AActor** Actor, bool CallFunc_BreakHitResult_bBlockingHit, bool CallFunc_BreakHitResult_bInitialOverlap, float CallFunc_BreakHitResult_Time, float CallFunc_BreakHitResult_Distance, const struct CoreUObject_Vector& CallFunc_BreakHitResult_Location, const struct CoreUObject_Vector& CallFunc_BreakHitResult_ImpactPoint, const struct CoreUObject_Vector& CallFunc_BreakHitResult_Normal, const struct CoreUObject_Vector& CallFunc_BreakHitResult_ImpactNormal, class UPhysicalMaterial* CallFunc_BreakHitResult_PhysMat, class AActor* CallFunc_BreakHitResult_HitActor, class UPrimitiveComponent* CallFunc_BreakHitResult_HitComponent, class FName CallFunc_BreakHitResult_HitBoneName, class FName CallFunc_BreakHitResult_BoneName, int32 CallFunc_BreakHitResult_HitItem, int32 CallFunc_BreakHitResult_ElementIndex, int32 CallFunc_BreakHitResult_FaceIndex, const struct CoreUObject_Vector& CallFunc_BreakHitResult_TraceStart, const struct CoreUObject_Vector& CallFunc_BreakHitResult_TraceEnd, class AActor* CallFunc_Spawn_Actor_Actor, class ABP_DetonateCrossbow_Mine_C* K2Node_DynamicCast_AsBP_Detonate_Crossbow_Mine, bool K2Node_DynamicCast_bSuccess)
{
	...
	if (!Func)
		Func = Class->GetFunction("BP_Projectile_DetonateCrossbow_Mine_C", "Spawn Actor");

	Params::ABP_Projectile_DetonateCrossbow_Mine_C_Spawn_Actor_Params Parms{};
...
// Function BP_Projectile_DetonateCrossbow_Mine.BP_Projectile_DetonateCrossbow_Mine_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ABP_Projectile_DetonateCrossbow_Mine_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Projectile_DetonateCrossbow_Mine_C", "ReceiveBeginPlay");
...
// Function BP_Projectile_DetonateCrossbow_Mine.BP_Projectile_DetonateCrossbow_Mine_C.ExecuteUbergraph_BP_Projectile_DetonateCrossbow_Mine
// (Final, UbergraphFunction)
// Parameters:
// int32                              EntryPoint                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_Projectile_DetonateCrossbow_Mine_C::ExecuteUbergraph_BP_Projectile_DetonateCrossbow_Mine(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_Projectile_DetonateCrossbow_Mine_C", "ExecuteUbergraph_BP_Projectile_DetonateCrossbow_Mine");

	Params::ABP_Projectile_DetonateCrossbow_Mine_C_ExecuteUbergraph_BP_Projectile_DetonateCrossbow_Mine_Params Parms{};
