...
struct Party_SocialPlatformDescription
{
public:
...
struct Party_UserPlatform
{
public:
	struct Party_SocialPlatformDescription       PlatformDescription;                               // 0x0(0x58)(NativeAccessSpecifierPrivate)
};

// 0x98 (0x98 - 0x0)
// ScriptStruct Party.PartyMemberPlatformData
struct Party_PartyMemberPlatformData
{
public:
	struct Party_UserPlatform                    Platform;                                          // 0x0(0x58)(NativeAccessSpecifierPublic)
	struct Engine_UniqueNetIdRepl                UniqueID;                                          // 0x58(0x30)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct Party_PartyMemberJoinInProgressRequest
{
public:
	struct Engine_UniqueNetIdRepl                Target;                                            // 0x0(0x30)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct Party_PartyMemberJoinInProgressResponse
{
public:
	struct Engine_UniqueNetIdRepl                Requester;                                         // 0x0(0x30)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct Party_PartyMemberJoinInProgressData
{
public:
	struct Party_PartyMemberJoinInProgressRequest Request;                                           // 0x0(0x38)(NativeAccessSpecifierPublic)
	TArray<struct Party_PartyMemberJoinInProgressResponse> Responses;                                         // 0x38(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
};

// 0x18 (0x18 - 0x0)
// ScriptStruct Party.OnlinePartyRepDataBase
struct Party_OnlinePartyRepDataBase
{
public:
	uint8                                        Pad_1129[0x18];                                    // Fixing Size Of Struct 
};

// 0x258 (0x270 - 0x18)
// ScriptStruct Party.PartyMemberRepData
struct Party_PartyMemberRepData : public Party_OnlinePartyRepDataBase
{
public:
	uint8                                        Pad_1145[0x10];                                    // Fixing Size After Last Property  
	struct Party_PartyMemberPlatformData         PlatformData;                                      // 0x28(0x98)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_1146[0x90];                                    // Fixing Size After Last Property  
	...
	uint8                                        Pad_114C[0x37];                                    // Fixing Size After Last Property  
	class FString                                JoinMethod;                                        // 0x188(0x10)(ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	uint8                                        Pad_114E[0x30];                                    // Fixing Size After Last Property  
	struct Party_PartyMemberJoinInProgressData   JoinInProgressData;                                // 0x1C8(0x48)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_1153[0x60];                                    // Fixing Size Of Struct 
};

// 0x50 (0x50 - 0x0)
// ScriptStruct Party.PartyPlatformSessionInfo
struct Party_PartyPlatformSessionInfo
{
public:
	...
	struct Engine_UniqueNetIdRepl                OwnerPrimaryId;                                    // 0x20(0x30)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
};

// 0x3 (0x3 - 0x0)
// ScriptStruct Party.PartyPrivacySettings
struct Party_PartyPrivacySettings
{
public:
...
struct Party_PartyRepData : public Party_OnlinePartyRepDataBase
{
public:
	uint8                                        Pad_116D[0x9];                                     // Fixing Size After Last Property  
	struct Party_PartyPrivacySettings            PrivacySettings;                                   // 0x21(0x3)(NoDestructor, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_1175[0x34];                                    // Fixing Size After Last Property  
	TArray<struct Party_PartyPlatformSessionInfo> PlatformSessions;                                  // 0x58(0x10)(ZeroConstructor, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_1176[0x18];                                    // Fixing Size Of Struct 
};

// 0x40 (0x40 - 0x0)
// ScriptStruct Party.SocialChatChannelConfig
struct Party_SocialChatChannelConfig
{
public:
