...
public:
	...
	struct CoreUObject_Guid                      AssetGuid;                                         // 0x38(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, Protected, HasGetValueTypeHash, NativeAccessSpecifierProtected)
...
{
public:
	uint8                                        Pad_45B[0x8];                                      // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_642[0x18];                                     // Fixing Size Of Struct 
	...
	void EnableGravityOverride(struct CoreUObject_Vector& InVector);
...
{
public:
	TArray<struct CoreUObject_Vector3f>          Vertices;                                          // 0x28(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct CoreUObject_Vector3f>          Normals;                                           // 0x38(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	...
	TArray<struct ClothingSystemRuntimeInterface_ClothVertBoneData> BoneData;                                          // 0x68(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_6BE[0x50];                                     // Fixing Size Of Struct 
