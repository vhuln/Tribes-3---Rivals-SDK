...
public:
	...
	uint8                                        Pad_CC3[0x5];                                      // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_CD0[0x6];                                      // Fixing Size Of Struct 
...
{
public:
	struct Engine_DataTableRowHandle             DefaultClickAction;                                // 0x28(0x10)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct Engine_DataTableRowHandle             DefaultBackAction;                                 // 0x38(0x10)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	struct CommonInput_InputHoldData             KeyboardAndMouse;                                  // 0x28(0x8)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct CommonInput_InputHoldData             Gamepad;                                           // 0x30(0x8)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
	struct CommonInput_InputHoldData             Touch;                                             // 0x38(0x8)(Edit, DisableEditOnInstance, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_CF2[0x3];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_CF5[0x4];                                      // Fixing Size After Last Property  
	...
	TArray<struct CommonInput_InputDeviceIdentifierPair> GamepadHardwareIdMapping;                          // 0x80(0x10)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
	...
	TArray<struct CommonInput_CommonInputKeyBrushConfiguration> InputBrushDataMap;                                 // 0xE0(0x10)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
	TArray<struct CommonInput_CommonInputKeySetBrushConfiguration> InputBrushKeySets;                                 // 0xF0(0x10)(Edit, ZeroConstructor, DisableEditOnInstance, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_D09[0x3];                                      // Fixing Size After Last Property  
...
public:
	...
	struct DeveloperSettings_PerPlatformSettings PlatformInput;                                     // 0x60(0x10)(Edit, ContainsInstancedReference, NativeAccessSpecifierPrivate)
	TMap<class FName, struct CommonInput_CommonInputPlatformBaseData> CommonInputPlatformData;                           // 0x70(0x50)(Config, Deprecated, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_D17[0x3];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_D1C[0x5];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_D1F[0x8];                                      // Fixing Size After Last Property  
...
{
public:
	uint8                                        Pad_D65[0x38];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_D68[0x4];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_D6F[0x2];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_D72[0x8];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_D75[0x17];                                     // Fixing Size Of Struct 
