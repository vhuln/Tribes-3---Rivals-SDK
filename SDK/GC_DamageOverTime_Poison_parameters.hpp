...
struct AGC_DamageOverTime_Poison_C_WhileActive_Params
{
public:
	...
	uint8                                        Pad_33FC[0x7];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_3423[0x7];                                     // Fixing Size After Last Property  
...
struct AGC_DamageOverTime_Poison_C_ToggleVFX_Params
{
public:
...
struct AGC_DamageOverTime_Poison_C_OnRemove_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct GameplayAbilities_GameplayCueParameters Parameters;                                        // 0x8(0xD8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
	...
	uint8                                        Pad_35FE[0x2];                                     // Fixing Size After Last Property  
...
struct AGC_DamageOverTime_Poison_C_OnActive_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct GameplayAbilities_GameplayCueParameters Parameters;                                        // 0x8(0xD8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
