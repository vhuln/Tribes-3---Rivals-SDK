...
// Parameters:
// TArray<struct CustomMeshComponent_CustomMeshTriangle>Triangles                                                        (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UCustomMeshComponent::SetCustomMeshTriangles(TArray<struct CustomMeshComponent_CustomMeshTriangle>& Triangles)
{
...
void UCustomMeshComponent::AddCustomMeshTriangles(TArray<struct CustomMeshComponent_CustomMeshTriangle>& Triangles)
{
	static class UFunction* Func = nullptr;
