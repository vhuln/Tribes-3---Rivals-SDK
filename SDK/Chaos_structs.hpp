...
struct Chaos_ClosestPhysicsObjectResult
{
public:
	uint8                                        Pad_19FF[0x28];                                    // Fixing Size Of Struct 
};

// 0x10 (0x10 - 0x0)
// ScriptStruct Chaos.SolverCollisionFilterSettings
struct Chaos_SolverCollisionFilterSettings
{
public:
...
struct Chaos_SolverBreakingFilterSettings
{
public:
	bool                                         FilterEnabled;                                     // 0x0(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct Chaos_SolverTrailingFilterSettings
{
public:
	bool                                         FilterEnabled;                                     // 0x0(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct Chaos_ChaosSolverConfiguration
{
public:
	...
	uint8                                        Pad_1A51[0x2];                                     // Fixing Size After Last Property  
	struct Chaos_SolverCollisionFilterSettings   CollisionFilterSettings;                           // 0x24(0x10)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1A56[0x3];                                     // Fixing Size After Last Property  
	struct Chaos_SolverBreakingFilterSettings    BreakingFilterSettings;                            // 0x38(0x10)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1A5C[0x3];                                     // Fixing Size After Last Property  
	struct Chaos_SolverTrailingFilterSettings    TrailingFilterSettings;                            // 0x4C(0x10)(Edit, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1A66[0x3];                                     // Fixing Size Of Struct 
};

// 0xB0 (0xB0 - 0x0)
// ScriptStruct Chaos.ManagedArrayCollection
struct Chaos_ManagedArrayCollection
{
public:
	uint8                                        Pad_1A6A[0xB0];                                    // Fixing Size Of Struct 
};

// 0xC0 (0xC0 - 0x0)
// ScriptStruct Chaos.SolverCollisionData
struct Chaos_SolverCollisionData
{
public:
	struct CoreUObject_Vector                    Location;                                          // 0x0(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    AccumulatedImpulse;                                // 0x18(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    Normal;                                            // 0x30(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    Velocity1;                                         // 0x48(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    Velocity2;                                         // 0x60(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    AngularVelocity1;                                  // 0x78(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    AngularVelocity2;                                  // 0x90(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct Chaos_SolverBreakingData
{
public:
	struct CoreUObject_Vector                    Location;                                          // 0x0(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    Velocity;                                          // 0x18(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    AngularVelocity;                                   // 0x30(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1A84[0x4];                                     // Fixing Size Of Struct 
};

// 0x58 (0x58 - 0x0)
// ScriptStruct Chaos.SolverTrailingData
struct Chaos_SolverTrailingData
{
public:
	struct CoreUObject_Vector                    Location;                                          // 0x0(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    Velocity;                                          // 0x18(0x18)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct Chaos_RecordedFrame
{
public:
	TArray<struct CoreUObject_Transform>         Transforms;                                        // 0x0(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	...
	TArray<struct Chaos_SolverCollisionData>     Collisions;                                        // 0x40(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct Chaos_SolverBreakingData>      Breakings;                                         // 0x50(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TSet<struct Chaos_SolverTrailingData>        Trailings;                                         // 0x60(0x50)(NativeAccessSpecifierPublic)
	float                                        Timestamp;                                         // 0xB0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1A9B[0x4];                                     // Fixing Size Of Struct 
};

// 0x10 (0x10 - 0x0)
// ScriptStruct Chaos.RecordedTransformTrack
struct Chaos_RecordedTransformTrack
{
public:
	TArray<struct Chaos_RecordedFrame>           Records;                                           // 0x0(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
};

// 0xC (0xC - 0x0)
// ScriptStruct Chaos.SolverRemovalFilterSettings
struct Chaos_SolverRemovalFilterSettings
{
public:
	bool                                         FilterEnabled;                                     // 0x0(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1AA0[0x3];                                     // Fixing Size After Last Property  
	float                                        MinMass;                                           // 0x4(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
