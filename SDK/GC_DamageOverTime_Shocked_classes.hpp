...
class AGC_DamageOverTime_Shocked_C : public AValGameplayCueNotify_Actor
{
public:
	...
	uint8                                        Pad_184D[0x7];                                     // Fixing Size After Last Property  
