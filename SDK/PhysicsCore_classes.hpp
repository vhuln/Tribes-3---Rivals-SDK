...
public:
	...
	uint8                                        Pad_2A5[0x5];                                      // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_2BD[0x2];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_2BF[0x2];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_2CA[0x4];                                      // Fixing Size After Last Property  
	...
	struct PhysicsCore_PhysicalMaterialStrength  Strength;                                          // 0x64(0xC)(Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_2ED[0x1];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_2F7[0x2];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_303[0x2];                                      // Fixing Size After Last Property  
	struct Chaos_ChaosSolverConfiguration        SolverOptions;                                     // 0x78(0x68)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
