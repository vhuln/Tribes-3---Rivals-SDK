...
// Parameters:
// struct InterchangePipelines_InterchangePipelineMeshesUtilitiesContextContext                                                          (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void UInterchangePipelineMeshesUtilities::SetContext(struct InterchangePipelines_InterchangePipelineMeshesUtilitiesContext& Context)
{
...
// Parameters:
// class FString                      MeshInstanceUid                                                  (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct InterchangePipelines_InterchangeMeshInstanceReturnValue                                                      (ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)

struct InterchangePipelines_InterchangeMeshInstance UInterchangePipelineMeshesUtilities::GetMeshInstanceByUid(const class FString& MeshInstanceUid)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class FString                      MeshGeometryUid                                                  (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct InterchangePipelines_InterchangeMeshGeometryReturnValue                                                      (ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)

struct InterchangePipelines_InterchangeMeshGeometry UInterchangePipelineMeshesUtilities::GetMeshGeometryByUid(const class FString& MeshGeometryUid)
{
	static class UFunction* Func = nullptr;
