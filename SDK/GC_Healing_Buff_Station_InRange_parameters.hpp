...
struct AGC_Healing_Buff_Station_InRange_C_WhileActive_Params
{
public:
	...
	uint8                                        Pad_1F52[0x3];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_1F57[0x4];                                     // Fixing Size After Last Property  
	...
	bool                                         CallFunc_Greater_DoubleDouble_ReturnValue;         // 0x1B9(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1F84[0x6];                                     // Fixing Size After Last Property  
	class ABP_Deployed_Buff_Station_C*           K2Node_DynamicCast_AsBP_Deployed_Buff_Station;     // 0x1C0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess;                       // 0x1C8(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_1F85[0x7];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_1F87[0x7];                                     // Fixing Size After Last Property  
	...
	class APlayerController*                     CallFunc_GetPlayerController_ReturnValue_1;        // 0x1F0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AValPlayerController*                  K2Node_DynamicCast_AsVal_Player_Controller;        // 0x1F8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class AValCharacter*                         CallFunc_GetValCharacter_ReturnValue;              // 0x208(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsEnemyWith_ReturnValue;                  // 0x210(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsValid_ReturnValue;                      // 0x211(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsLocallyViewed_ReturnValue;              // 0x212(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_EqualEqual_ObjectObject_ReturnValue;      // 0x213(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_BooleanAND_ReturnValue;                   // 0x214(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
struct AGC_Healing_Buff_Station_InRange_C_OnRemove_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct GameplayAbilities_GameplayCueParameters Parameters;                                        // 0x8(0xD8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct AGC_Healing_Buff_Station_InRange_C_ReceiveTick_Params
{
public:
...
struct AGC_Healing_Buff_Station_InRange_C_ExecuteUbergraph_GC_Healing_Buff_Station_InRange_Params
{
public:
