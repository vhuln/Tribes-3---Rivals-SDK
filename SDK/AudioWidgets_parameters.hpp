...
{
public:
	TArray<struct AudioWidgets_MeterChannelInfo> InMeterChannelInfo;                                // 0x0(0x10)(ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
};
...
{
public:
	TArray<struct AudioWidgets_MeterChannelInfo> ReturnValue;                                       // 0x0(0x10)(Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)
};
...
{
public:
	struct SlateCore_SlateColor                  InColor;                                           // 0x0(0x14)(Parm, NativeAccessSpecifierPublic)
};
...
{
public:
	struct CoreUObject_Vector2D                  InOutputRange;                                     // 0x0(0x10)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
{
public:
	struct CoreUObject_Vector2D                  InHandStartEndRatio;                               // 0x0(0x10)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
