...
{
public:
	uint8                                        Pad_1226[0x8];                                     // Fixing Size After Last Property  
	struct RigVM_RigVMGraphFunctionStore         GraphFunctionStore;                                // 0x370(0x20)(NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_1357[0x20];                                    // Fixing Size After Last Property  
	struct RigVM_RigVMByteCode                   ByteCodeStorage;                                   // 0x60(0xA0)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_1359[0x8];                                     // Fixing Size After Last Property  
	struct RigVM_RigVMInstructionArray           Instructions;                                      // 0x108(0x10)(Transient, NativeAccessSpecifierPrivate)
	uint8                                        Pad_135B[0x8];                                     // Fixing Size After Last Property  
	TArray<class FName>                          FunctionNamesStorage;                              // 0x120(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                        Pad_135C[0x38];                                    // Fixing Size After Last Property  
	TArray<struct RigVM_RigVMParameter>          Parameters;                                        // 0x168(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TMap<class FName, int32>                     ParametersNameMap;                                 // 0x178(0x50)(NativeAccessSpecifierPrivate)
	uint8                                        Pad_135D[0x98];                                    // Fixing Size After Last Property  
	...
	uint8                                        Pad_135F[0x40];                                    // Fixing Size Of Struct 

	static class UClass* StaticClass();
	static class URigVM* GetDefaultObj();

	void SetParameterValueVector2D(class FName& InParameterName, struct CoreUObject_Vector2D& InValue, int32 InArrayIndex);
	void SetParameterValueVector(class FName& InParameterName, struct CoreUObject_Vector& InValue, int32 InArrayIndex);
	void SetParameterValueTransform(class FName& InParameterName, struct CoreUObject_Transform& InValue, int32 InArrayIndex);
	void SetParameterValueString(class FName& InParameterName, const class FString& InValue, int32 InArrayIndex);
	void SetParameterValueQuat(class FName& InParameterName, struct CoreUObject_Quat& InValue, int32 InArrayIndex);
	...
	struct RigVM_RigVMStatistics GetStatistics();
	class FString GetRigVMFunctionName(int32 InFunctionIndex);
	struct CoreUObject_Vector2D GetParameterValueVector2D(class FName& InParameterName, int32 InArrayIndex);
	struct CoreUObject_Vector GetParameterValueVector(class FName& InParameterName, int32 InArrayIndex);
	struct CoreUObject_Transform GetParameterValueTransform(class FName& InParameterName, int32 InArrayIndex);
	class FString GetParameterValueString(class FName& InParameterName, int32 InArrayIndex);
	struct CoreUObject_Quat GetParameterValueQuat(class FName& InParameterName, int32 InArrayIndex);
	...
	bool Execute(struct RigVM_RigVMExtendedExecuteContext* Context, class FName& InEntryName);
...
public:
	...
	uint8                                        Pad_137A[0xC8];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_1394[0x40];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_13A3[0x28];                                    // Fixing Size Of Struct 
...
public:
	...
	struct RigVM_RigVMUserWorkflow               Workflow;                                          // 0x30(0x58)(Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
	uint8                                        Pad_13DA[0x10];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_148C[0x8];                                     // Fixing Size After Last Property  
	struct RigVM_RigVMRuntimeSettings            VMRuntimeSettings;                                 // 0x30(0x18)(NativeAccessSpecifierPublic)
	uint8                                        Pad_148E[0x10];                                    // Fixing Size After Last Property  
	...
	struct RigVM_RigVMExtendedExecuteContext     ExtendedExecuteContext;                            // 0x60(0x1B8)(NativeAccessSpecifierPrivate)
	struct RigVM_RigVMDrawContainer              DrawContainer;                                     // 0x218(0x18)(NativeAccessSpecifierPublic)
	uint8                                        Pad_1490[0x18];                                    // Fixing Size After Last Property  
	TArray<class FName>                          EventQueue;                                        // 0x248(0x10)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	uint8                                        Pad_1491[0x90];                                    // Fixing Size After Last Property  
	...
	uint8                                        Pad_1493[0x40];                                    // Fixing Size Of Struct 
	...
	struct RigVM_RigVMExtendedExecuteContext GetExtendedExecuteContext();
	float GetDeltaTime();
