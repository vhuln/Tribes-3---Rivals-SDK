...
struct DataRegistry_DataRegistryLookup
{
public:
	uint8                                        Pad_C3B[0x20];                                     // Fixing Size Of Struct 
};

// 0x8 (0x8 - 0x0)
// ScriptStruct DataRegistry.DataRegistryType
struct DataRegistry_DataRegistryType
{
public:
...
struct DataRegistry_DataRegistryId
{
public:
	struct DataRegistry_DataRegistryType         RegistryType;                                      // 0x0(0x8)(Edit, BlueprintVisible, ZeroConstructor, SaveGame, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct DataRegistry_DataRegistrySource_DataTableRules
{
public:
	...
	uint8                                        Pad_C4C[0x3];                                      // Fixing Size After Last Property  
...
struct DataRegistry_DataRegistryIdFormat
{
public:
	struct GameplayTags_GameplayTag              BaseGameplayTag;                                   // 0x0(0x8)(Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};

// 0x14 (0x14 - 0x0)
// ScriptStruct DataRegistry.DataRegistryCachePolicy
struct DataRegistry_DataRegistryCachePolicy
{
public:
...
struct DataRegistry_DataRegistrySourceItemId
{
public:
	uint8                                        Pad_C58[0x40];                                     // Fixing Size Of Struct 
};
