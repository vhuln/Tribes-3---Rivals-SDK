...
struct AGC_Damage_Buff_Station_InRange_C_WhileActive_Params
{
public:
	...
	uint8                                        Pad_3597[0x4];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_35B7[0x6];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_35D1[0x7];                                     // Fixing Size After Last Property  
	...
	class AValPlayerController*                  K2Node_DynamicCast_AsVal_Player_Controller;        // 0x1D8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class AValCharacter*                         CallFunc_GetValCharacter_ReturnValue;              // 0x1F0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AValCharacter*                         K2Node_DynamicCast_AsVal_Character;                // 0x1F8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_DynamicCast_bSuccess_2;                     // 0x200(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_IsLocallyViewed_ReturnValue;              // 0x201(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_EqualEqual_ObjectObject_ReturnValue;      // 0x202(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3609[0x5];                                     // Fixing Size After Last Property  
	...
	bool                                         CallFunc_IsEnemyWith_ReturnValue;                  // 0x211(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3613[0x6];                                     // Fixing Size After Last Property  
...
struct AGC_Damage_Buff_Station_InRange_C_OnRemove_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct GameplayAbilities_GameplayCueParameters Parameters;                                        // 0x8(0xD8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct AGC_Damage_Buff_Station_InRange_C_ReceiveTick_Params
{
public:
...
struct AGC_Damage_Buff_Station_InRange_C_ExecuteUbergraph_GC_Damage_Buff_Station_InRange_Params
{
public:
