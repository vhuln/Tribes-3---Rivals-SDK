...
public:
	...
	uint8                                        Pad_261[0x2];                                      // Fixing Size After Last Property  
	...
	TArray<struct BuildPatchServices_FileManifestData> FileManifestList;                                  // 0xF0(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct BuildPatchServices_ChunkInfoData> ChunkList;                                         // 0x100(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct BuildPatchServices_CustomFieldData> CustomFields;                                      // 0x110(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
