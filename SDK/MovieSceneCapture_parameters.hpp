...
{
public:
	struct MovieSceneCapture_CapturedPixelsID    StreamID;                                          // 0x0(0x50)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct MovieSceneCapture_CapturedPixelsID    BufferID;                                          // 0x8(0x50)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
{
public:
	struct MovieSceneCapture_CapturedPixels      Pixels;                                            // 0x0(0x10)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct MovieSceneCapture_CapturedPixelsID    ID;                                                // 0x10(0x50)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct MovieSceneCapture_FrameMetrics        FrameMetrics;                                      // 0x60(0x10)(Parm, NoDestructor, NativeAccessSpecifierPublic)
};
...
{
public:
	struct MovieSceneCapture_FrameMetrics        ReturnValue;                                       // 0x0(0x10)(Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
{
public:
	struct MovieSceneCapture_FrameMetrics        InFrameMetrics;                                    // 0x0(0x10)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	struct MovieSceneCapture_CapturedPixels      PixelData;                                         // 0x0(0x10)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct MovieSceneCapture_CapturedPixelsID    StreamID;                                          // 0x10(0x50)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
	struct MovieSceneCapture_FrameMetrics        FrameMetrics;                                      // 0x60(0x10)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_987[0x7];                                      // Fixing Size Of Struct 
};
...
public:
	class UTexture*                              Buffer;                                            // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct MovieSceneCapture_CapturedPixelsID    StreamID;                                          // 0x8(0x50)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
