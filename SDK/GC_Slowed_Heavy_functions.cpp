...
class UClass* AGC_Slowed_Heavy_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Slowed_Heavy_C");

	return Clss;
}


// GC_Slowed_Heavy_C GC_Slowed_Heavy.Default__GC_Slowed_Heavy_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_Slowed_Heavy_C* AGC_Slowed_Heavy_C::GetDefaultObj()
{
	static class AGC_Slowed_Heavy_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_Slowed_Heavy_C*>(AGC_Slowed_Heavy_C::StaticClass()->DefaultObject);
...
bool AGC_Slowed_Heavy_C::WhileActive(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters, class ABP_CharPlayer_C* K2Node_DynamicCast_AsBP_Char_Player, bool K2Node_DynamicCast_bSuccess, class AValCharacter* K2Node_DynamicCast_AsVal_Character, bool K2Node_DynamicCast_bSuccess_1, class USkeletalMeshComponent* CallFunc_GetMesh1P_ReturnValue, class USkeletalMeshComponent* CallFunc_GetMesh3P_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UNiagaraComponent* CallFunc_Create_1P3P_VFX_Active_1PVFX, class UNiagaraSystem* CallFunc_Create_1P3P_VFX_1P_System_Ref, class UNiagaraComponent* CallFunc_Create_1P3P_VFX_Active_3PVFX, class UNiagaraSystem* CallFunc_Create_1P3P_VFX_3P_System_Ref)
{
	...
	Params::AGC_Slowed_Heavy_C_WhileActive_Params Parms{};
...
void AGC_Slowed_Heavy_C::ToggleVFX(class UNiagaraComponent* CallFunc_Update_1P3P_VFX_Active_1P, class UNiagaraComponent* CallFunc_Update_1P3P_VFX_Active_3P)
{
	static class UFunction* Func = nullptr;
	...
	Params::AGC_Slowed_Heavy_C_ToggleVFX_Params Parms{};
...
bool AGC_Slowed_Heavy_C::OnRemove(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, class UNiagaraComponent* CallFunc_SpawnSystemAttached_ReturnValue)
{
	...
	Params::AGC_Slowed_Heavy_C_OnRemove_Params Parms{};
...
bool AGC_Slowed_Heavy_C::OnActive(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;
	...
	Params::AGC_Slowed_Heavy_C_OnActive_Params Parms{};
