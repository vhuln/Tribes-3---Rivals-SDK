...
struct Slate_VirtualKeyboardOptions
{
public:
...
struct Slate_InputChord
{
public:
	struct InputCore_Key                         Key;                                               // 0x0(0x18)(Edit, BlueprintVisible, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_17[0x7];                                       // Fixing Size Of Struct 
};

// 0x20 (0x20 - 0x0)
// ScriptStruct Slate.Anchors
struct Slate_Anchors
{
public:
	struct CoreUObject_Vector2D                  Minimum;                                           // 0x0(0x10)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector2D                  Maximum;                                           // 0x10(0x10)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};

// 0x4 (0x4 - 0x0)
// ScriptStruct Slate.CharRange
struct Slate_CharRange
{
public:
...
struct Slate_CharRangeList
{
public:
	TArray<struct Slate_CharRange>               Ranges;                                            // 0x0(0x10)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
};

// 0x4 (0x4 - 0x0)
// ScriptStruct Slate.CustomizedToolMenuEntry
struct Slate_CustomizedToolMenuEntry
{
public:
...
struct Slate_CustomizedToolMenuSection
{
public:
	enum class ECustomizedToolMenuVisibility     Visibility;                                        // 0x0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct Slate_CustomizedToolMenuNameArray
{
public:
...
struct Slate_CustomizedToolMenu
{
public:
	class FName                                  Name;                                              // 0x0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMap<class FName, struct Slate_CustomizedToolMenuEntry> Entries;                                           // 0x8(0x50)(NativeAccessSpecifierPublic)
	TMap<class FName, struct Slate_CustomizedToolMenuSection> Sections;                                          // 0x58(0x50)(NativeAccessSpecifierPublic)
	TMap<class FName, struct Slate_CustomizedToolMenuNameArray> EntryOrder;                                        // 0xA8(0x50)(NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_2A[0xE8];                                      // Fixing Size Of Struct 
};
