...
struct UABP_Proximity_Mine_C_AnimGraph_Params
{
public:
...
struct UABP_Proximity_Mine_C_BlueprintUpdateAnimation_Params
{
public:
...
struct UABP_Proximity_Mine_C_ExecuteUbergraph_ABP_Proximity_Mine_Params
{
public:
	int32                                        EntryPoint;                                        // 0x0(0x4)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_6D1[0x4];                                      // Fixing Size After Last Property  
	class AActor*                                CallFunc_GetOwningActor_ReturnValue;               // 0x8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class ABP_Proximity_Mine_C*                  K2Node_DynamicCast_AsBP_Proximity_Mine;            // 0x10(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
