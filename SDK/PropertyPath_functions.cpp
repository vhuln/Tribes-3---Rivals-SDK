...
// (Final, Native, Public)
// Parameters:
// struct PropertyPath_PropertyPathTestStructInStruct                                                         (Parm, NativeAccessSpecifierPublic)

void UPropertyPathTestObject::SetStructRef(const struct PropertyPath_PropertyPathTestStruct& InStruct)
{
...
void UPropertyPathTestObject::SetStructConstRef(const struct PropertyPath_PropertyPathTestStruct& InStruct)
{
	static class UFunction* Func = nullptr;
...
void UPropertyPathTestObject::SetStruct(const struct PropertyPath_PropertyPathTestStruct& InStruct)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct PropertyPath_PropertyPathTestStructReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct PropertyPath_PropertyPathTestStruct UPropertyPathTestObject::GetStructRef()
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, Const)
// Parameters:
// struct PropertyPath_PropertyPathTestStructReturnValue                                                      (ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)

struct PropertyPath_PropertyPathTestStruct UPropertyPathTestObject::GetStructConstRef()
{
	static class UFunction* Func = nullptr;
...
struct PropertyPath_PropertyPathTestStruct UPropertyPathTestObject::GetStruct()
{
	static class UFunction* Func = nullptr;
