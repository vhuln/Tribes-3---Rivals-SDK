...
public:
	...
	uint8                                        Pad_119E[0x118];                                   // Fixing Size After Last Property  
	...
	void SetVisualFidelity(class UObject* WorldContextObject, const struct Engine_LatentActionInfo& LatentInfo, class UAnimationCompressionLibraryDatabase* DatabaseAsset, enum class EACLVisualFidelityChangeResult* Result, enum class EACLVisualFidelity VisualFidelity);
