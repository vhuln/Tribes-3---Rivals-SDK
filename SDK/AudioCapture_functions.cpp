...
// Parameters:
// struct AudioCapture_AudioCaptureDeviceInfoOutInfo                                                          (Parm, OutParm, NoDestructor, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UAudioCapture::GetAudioCaptureDeviceInfo(struct AudioCapture_AudioCaptureDeviceInfo* OutInfo)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct AudioCapture_AudioInputDeviceInfoInfo                                                             (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// class FString                      ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class FString UAudioCaptureBlueprintLibrary::Conv_AudioInputDeviceInfoToString(struct AudioCapture_AudioInputDeviceInfo& Info)
{
	static class UFunction* Func = nullptr;
