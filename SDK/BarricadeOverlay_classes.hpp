...
class UBarricadeOverlay_C : public UValCharacterOverlay_NPC
{
public:
	...
	uint8                                        Pad_2237[0x7];                                     // Fixing Size After Last Property  
	...
	static class UBarricadeOverlay_C* GetDefaultObj();
	...
	void BindAll(FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, bool CallFunc_IsValid_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_IsBindingReady_Value, bool CallFunc_BooleanAND_ReturnValue);
	void OnUpdateVisibility(bool Visible, bool Hovered, bool bClose, bool bShowHealthBar);
	void OnInitialized();
	void ExecuteUbergraph_BarricadeOverlay(int32 EntryPoint, bool K2Node_Event_Visible, bool K2Node_Event_Hovered, bool K2Node_Event_bClose, bool K2Node_Event_bShowHealthBar);
};
