...
class AGC_Damage_Buff_Station_AOE_C : public AGameplayCueNotify_Actor
{
public:
	...
	void ExecuteUbergraph_GC_Damage_Buff_Station_AOE(int32 EntryPoint, float K2Node_Event_DeltaSeconds);
};
