...
{
public:
	struct SkeletalMerging_SkeletonMergeParams   Params;                                            // 0x0(0x18)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
{
public:
	struct SkeletalMerging_SkeletalMeshMergeParams Params;                                            // 0x0(0x40)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
