...
struct Qos_QosSubspaceComparisonParams
{
public:
...
public:
	...
	uint8                                        Pad_FB4[0x4];                                      // Fixing Size Of Struct 
};

// 0x38 (0x38 - 0x0)
// ScriptStruct Qos.QosDatacenterInfo
struct Qos_QosDatacenterInfo
{
public:
	...
	uint8                                        Pad_FBC[0x7];                                      // Fixing Size After Last Property  
	TArray<struct Qos_QosPingServerInfo>         Servers;                                           // 0x28(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
};

// 0x40 (0x40 - 0x0)
// ScriptStruct Qos.QosRegionInfo
struct Qos_QosRegionInfo
{
public:
	...
	struct Qos_QosSubspaceComparisonParams       SubspaceBiasParams;                                // 0x2C(0x10)(NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_FC0[0x4];                                      // Fixing Size Of Struct 
};

// 0x68 (0x68 - 0x0)
// ScriptStruct Qos.DatacenterQosInstance
struct Qos_DatacenterQosInstance
{
public:
	struct Qos_QosDatacenterInfo                 Definition;                                        // 0x0(0x38)(Transient, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_FC9[0x3];                                      // Fixing Size After Last Property  
	...
	struct CoreUObject_DateTime                  LastCheckTimestamp;                                // 0x58(0x8)(ZeroConstructor, Transient, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_FCE[0x7];                                      // Fixing Size Of Struct 
};

// 0x50 (0x50 - 0x0)
// ScriptStruct Qos.RegionQosInstance
struct Qos_RegionQosInstance
{
public:
	struct Qos_QosRegionInfo                     Definition;                                        // 0x0(0x40)(Transient, NativeAccessSpecifierPublic)
	TArray<struct Qos_DatacenterQosInstance>     DatacenterOptions;                                 // 0x40(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
};
