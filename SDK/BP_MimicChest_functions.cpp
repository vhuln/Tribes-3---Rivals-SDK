...
// BlueprintGeneratedClass BP_MimicChest.BP_MimicChest_C
// (Actor)

class UClass* ABP_MimicChest_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_MimicChest_C");

	return Clss;
}


// BP_MimicChest_C BP_MimicChest.Default__BP_MimicChest_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_MimicChest_C* ABP_MimicChest_C::GetDefaultObj()
{
	static class ABP_MimicChest_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_MimicChest_C*>(ABP_MimicChest_C::StaticClass()->DefaultObject);
...
class FText ABP_MimicChest_C::GetContextDescriptionOverride()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "GetContextDescriptionOverride");

	Params::ABP_MimicChest_C_GetContextDescriptionOverride_Params Parms{};
...
class FText ABP_MimicChest_C::GetContextTitleOverride()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "GetContextTitleOverride");

	Params::ABP_MimicChest_C_GetContextTitleOverride_Params Parms{};
...
enum class ERarity ABP_MimicChest_C::GetContextPingRarity()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "GetContextPingRarity");

	Params::ABP_MimicChest_C_GetContextPingRarity_Params Parms{};
...
enum class EValPingType ABP_MimicChest_C::GetContextPingType()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "GetContextPingType");

	Params::ABP_MimicChest_C_GetContextPingType_Params Parms{};
...
struct CoreUObject_Vector ABP_MimicChest_C::GetPingOffset()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "GetPingOffset");

	Params::ABP_MimicChest_C_GetPingOffset_Params Parms{};
...
struct CoreUObject_Vector ABP_MimicChest_C::GetPreviewDetectionOffset()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "GetPreviewDetectionOffset");

	Params::ABP_MimicChest_C_GetPreviewDetectionOffset_Params Parms{};
...
void ABP_MimicChest_C::OnStateUpdate(enum class EValMimicChestState Value, bool K2Node_SwitchEnum_CmpSuccess)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "OnStateUpdate");

	Params::ABP_MimicChest_C_OnStateUpdate_Params Parms{};
...
void ABP_MimicChest_C::OnMaterialSelected(int32 Value, bool CallFunc_Array_IsNotEmpty_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, bool CallFunc_BooleanAND_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "OnMaterialSelected");

	Params::ABP_MimicChest_C_OnMaterialSelected_Params Parms{};
...
void ABP_MimicChest_C::UpdateVFX(int32 Value, bool K2Node_SwitchInteger_CmpSuccess, bool CallFunc_IsValid_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "UpdateVFX");

	Params::ABP_MimicChest_C_UpdateVFX_Params Parms{};
...
void ABP_MimicChest_C::UpdateSelectedMaterial(int32 Value, class FText CallFunc_Conv_StringToText_ReturnValue, class APawn* CallFunc_GetInstigator_ReturnValue, class APlayerController* CallFunc_GetPlayerController_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsEnemyWith_ReturnValue, bool CallFunc_Not_PreBool_ReturnValue, bool CallFunc_IsDedicatedServer_ReturnValue, class UMaterialInstance* CallFunc_Array_Get_Item, class UBoxComponent* CallFunc_GetCollisionComp_ReturnValue)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "UpdateSelectedMaterial");

	Params::ABP_MimicChest_C_UpdateSelectedMaterial_Params Parms{};
...
void ABP_MimicChest_C::PlayFX(class APawn* CallFunc_GetInstigator_ReturnValue, const struct CoreUObject_Vector& CallFunc_K2_GetActorLocation_ReturnValue, bool CallFunc_HasAuthority_ReturnValue, bool CallFunc_IsValid_ReturnValue, const struct GameplayAbilities_GameplayCueParameters& CallFunc_MakeGameplayCueParameters_ReturnValue, float CallFunc_MakeGameplayCueParameters_RawMagnitude_ImplicitCast, float CallFunc_SetLifeSpan_InLifespan_ImplicitCast)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "PlayFX");

	Params::ABP_MimicChest_C_PlayFX_Params Parms{};
...
void ABP_MimicChest_C::OnTimerUpdated(float Time)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "OnTimerUpdated");

	Params::ABP_MimicChest_C_OnTimerUpdated_Params Parms{};
...
void ABP_MimicChest_C::BndEvt__BP_Loot_Crate_InteractCollisionComp_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct Engine_HitResult& SweepResult)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "BndEvt__BP_Loot_Crate_InteractCollisionComp_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature");

	Params::ABP_MimicChest_C_BndEvt__BP_Loot_Crate_InteractCollisionComp_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params Parms{};
...
void ABP_MimicChest_C::BndEvt__BP_Pickup_Master_InteractCollisionComp_K2Node_ComponentBoundEvent_2_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "BndEvt__BP_Pickup_Master_InteractCollisionComp_K2Node_ComponentBoundEvent_2_ComponentEndOverlapSignature__DelegateSignature");

	Params::ABP_MimicChest_C_BndEvt__BP_Pickup_Master_InteractCollisionComp_K2Node_ComponentBoundEvent_2_ComponentEndOverlapSignature__DelegateSignature_Params Parms{};
...
// Function BP_MimicChest.BP_MimicChest_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void ABP_MimicChest_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "ReceiveBeginPlay");
...
void ABP_MimicChest_C::ReceiveTick(float DeltaSeconds)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "ReceiveTick");

	Params::ABP_MimicChest_C_ReceiveTick_Params Parms{};
...
// Function BP_MimicChest.BP_MimicChest_C.Explode
// (Event, Public, BlueprintCallable, BlueprintEvent)
// Parameters:

void ABP_MimicChest_C::Explode()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "Explode");
...
void ABP_MimicChest_C::ClientSelectMaterial(int32 Value)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "ClientSelectMaterial");

	Params::ABP_MimicChest_C_ClientSelectMaterial_Params Parms{};
...
void ABP_MimicChest_C::AddScanner(int32 Amount)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "AddScanner");

	Params::ABP_MimicChest_C_AddScanner_Params Parms{};
...
void ABP_MimicChest_C::ExecuteUbergraph_BP_MimicChest(int32 EntryPoint, int32 Temp_int_Array_Index_Variable, class UPrimitiveComponent* K2Node_ComponentBoundEvent_OverlappedComponent_1, class AActor* K2Node_ComponentBoundEvent_OtherActor_1, class UPrimitiveComponent* K2Node_ComponentBoundEvent_OtherComp_1, int32 K2Node_ComponentBoundEvent_OtherBodyIndex_1, bool K2Node_ComponentBoundEvent_bFromSweep, const struct Engine_HitResult& K2Node_ComponentBoundEvent_SweepResult, int32 Temp_int_Loop_Counter_Variable, class ABP_ValChar_Master_C* K2Node_DynamicCast_AsBP_Val_Char_Master, bool K2Node_DynamicCast_bSuccess, bool CallFunc_CanInteract_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Array_Index_Variable_1, int32 CallFunc_Array_Add_ReturnValue, bool CallFunc_Array_IsEmpty_ReturnValue, class UPrimitiveComponent* K2Node_ComponentBoundEvent_OverlappedComponent, class AActor* K2Node_ComponentBoundEvent_OtherActor, class UPrimitiveComponent* K2Node_ComponentBoundEvent_OtherComp, int32 K2Node_ComponentBoundEvent_OtherBodyIndex, bool CallFunc_Not_PreBool_ReturnValue, class ABP_ValChar_Master_C* K2Node_DynamicCast_AsBP_Val_Char_Master_1, bool K2Node_DynamicCast_bSuccess_1, bool CallFunc_Array_RemoveItem_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, float K2Node_Event_DeltaSeconds, const struct CoreUObject_Vector& CallFunc_K2_GetComponentLocation_ReturnValue, class APawn* CallFunc_GetInstigator_ReturnValue, class ABP_ValChar_Master_C* K2Node_DynamicCast_AsBP_Val_Char_Master_2, bool K2Node_DynamicCast_bSuccess_2, int32 K2Node_CustomEvent_Value, class APawn* CallFunc_GetInstigator_ReturnValue_1, bool CallFunc_DoesEffectContainerSpecHaveEffects_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_1, float CallFunc_GetSetByCallerMagnitudeByTag_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate_2, int32 Temp_int_Loop_Counter_Variable_1, int32 CallFunc_Add_IntInt_ReturnValue_1, bool CallFunc_HasAuthority_ReturnValue, bool CallFunc_Array_IsNotEmpty_ReturnValue, bool CallFunc_IsDedicatedServer_ReturnValue, bool CallFunc_HasAuthority_ReturnValue_1, TArray<class AActor*>& K2Node_MakeArray_Array, TMap<class AActor*, struct Engine_HitResult> CallFunc_FindActorsInExplosion_OutResults, bool CallFunc_FindActorsInExplosion_ReturnValue, int32 K2Node_Event_Amount, TArray<class AActor*>& CallFunc_Map_Keys_Keys, TArray<class AActor*>& CallFunc_Map_Keys_Keys_1, class AActor* CallFunc_Array_Get_Item, class AActor* CallFunc_Array_Get_Item_1, bool CallFunc_EqualEqual_ObjectObject_ReturnValue, const struct Engine_HitResult& CallFunc_Map_Find_Value, bool CallFunc_Map_Find_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BreakHitResult_bBlockingHit, bool CallFunc_BreakHitResult_bInitialOverlap, float CallFunc_BreakHitResult_Time, float CallFunc_BreakHitResult_Distance, const struct CoreUObject_Vector& CallFunc_BreakHitResult_Location, const struct CoreUObject_Vector& CallFunc_BreakHitResult_ImpactPoint, const struct CoreUObject_Vector& CallFunc_BreakHitResult_Normal, const struct CoreUObject_Vector& CallFunc_BreakHitResult_ImpactNormal, class UPhysicalMaterial* CallFunc_BreakHitResult_PhysMat, class AActor* CallFunc_BreakHitResult_HitActor, class UPrimitiveComponent* CallFunc_BreakHitResult_HitComponent, class FName CallFunc_BreakHitResult_HitBoneName, class FName CallFunc_BreakHitResult_BoneName, int32 CallFunc_BreakHitResult_HitItem, int32 CallFunc_BreakHitResult_ElementIndex, int32 CallFunc_BreakHitResult_FaceIndex, const struct CoreUObject_Vector& CallFunc_BreakHitResult_TraceStart, const struct CoreUObject_Vector& CallFunc_BreakHitResult_TraceEnd, const struct Engine_HitResult& CallFunc_Map_Find_Value_1, bool CallFunc_Map_Find_ReturnValue_1, const struct Engine_HitResult& CallFunc_MakeHitResult_ReturnValue, bool CallFunc_NotEqual_ObjectObject_ReturnValue, int32 CallFunc_Array_Add_ReturnValue_1, bool CallFunc_IsEnemyWith_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, int32 CallFunc_Array_Length_ReturnValue_1, bool CallFunc_Less_IntInt_ReturnValue_1, int32 CallFunc_Add_IntInt_ReturnValue_2, int32 CallFunc_Clamp_ReturnValue, bool CallFunc_EqualEqual_IntInt_ReturnValue, class APlayerState* CallFunc_GetPlayerState_ReturnValue, bool CallFunc_GetTeamFromObject_bHasATeam, int32 CallFunc_GetTeamFromObject_TeamId, float CallFunc_FindActorsInExplosion_OuterDamageRadius_ImplicitCast, double K2Node_VariableSet_ExplosionDamage_ImplicitCast)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("BP_MimicChest_C", "ExecuteUbergraph_BP_MimicChest");

	Params::ABP_MimicChest_C_ExecuteUbergraph_BP_MimicChest_Params Parms{};
