...
// BlueprintGeneratedClass AU_HealthMaxScaledIncrease.AU_HealthMaxScaledIncrease_C
// (None)

class UClass* UAU_HealthMaxScaledIncrease_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("AU_HealthMaxScaledIncrease_C");

	return Clss;
}


// AU_HealthMaxScaledIncrease_C AU_HealthMaxScaledIncrease.Default__AU_HealthMaxScaledIncrease_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UAU_HealthMaxScaledIncrease_C* UAU_HealthMaxScaledIncrease_C::GetDefaultObj()
{
	static class UAU_HealthMaxScaledIncrease_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UAU_HealthMaxScaledIncrease_C*>(UAU_HealthMaxScaledIncrease_C::StaticClass()->DefaultObject);
...
void UAU_HealthMaxScaledIncrease_C::EventActivateUpgrade(float Value)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AU_HealthMaxScaledIncrease_C", "EventActivateUpgrade");

	Params::UAU_HealthMaxScaledIncrease_C_EventActivateUpgrade_Params Parms{};
...
// Function AU_HealthMaxScaledIncrease.AU_HealthMaxScaledIncrease_C.EventUnapplyAbilityUpgrade
// (Event, Public, BlueprintEvent)
// Parameters:

void UAU_HealthMaxScaledIncrease_C::EventUnapplyAbilityUpgrade()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("AU_HealthMaxScaledIncrease_C", "EventUnapplyAbilityUpgrade");
