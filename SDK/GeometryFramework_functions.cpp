...
// Parameters:
// struct CoreUObject_Color           NewColor                                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UBaseDynamicMeshComponent::SetConstantOverrideColor(const struct CoreUObject_Color& NewColor)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Color UBaseDynamicMeshComponent::GetConstantOverrideColor()
{
	static class UFunction* Func = nullptr;
