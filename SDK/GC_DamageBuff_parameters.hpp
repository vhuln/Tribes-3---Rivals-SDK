...
struct AGC_DamageBuff_C_OnActive_Params
{
public:
	...
	class USkeletalMeshComponent*                CallFunc_GetGunMesh1P_ReturnValue;                 // 0x108(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	class USkeletalMeshComponent*                CallFunc_GetVFXFP_Gun_ReturnValue;                 // 0x110(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
struct AGC_DamageBuff_C_UpdateTeamColor_Params
{
public:
	...
	uint8                                        Pad_3274[0x6];                                     // Fixing Size After Last Property  
...
struct AGC_DamageBuff_C_Update_VFX_Params
{
public:
...
struct AGC_DamageBuff_C_OnRemove_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct GameplayAbilities_GameplayCueParameters Parameters;                                        // 0x8(0xD8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
	...
	uint8                                        Pad_32D0[0x1];                                     // Fixing Size After Last Property  
	...
	class USkeletalMeshComponent*                CallFunc_GetVFXFP_Gun_ReturnValue;                 // 0xF8(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
};
