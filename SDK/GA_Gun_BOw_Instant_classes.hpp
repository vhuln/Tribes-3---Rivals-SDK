...
class UGA_Gun_BOw_Instant_C : public UGA_Gun_Master_Instant_C
{
public:
	struct Engine_PointerToUberGraphFrame        UberGraphFrame;                                    // 0x8B8(0x8)(ZeroConstructor, Transient, DuplicateTransient)

	static class UClass* StaticClass();
	static class UGA_Gun_BOw_Instant_C* GetDefaultObj();

	void K2_ActivateAbility();
	void ExecuteUbergraph_GA_Gun_BOw_Instant(int32 EntryPoint);
};
