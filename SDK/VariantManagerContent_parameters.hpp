...
public:
	...
	uint8                                        Pad_28B[0x4];                                      // Fixing Size After Last Property  
...
public:
	...
	uint8                                        Pad_2A7[0x7];                                      // Fixing Size Of Struct 
};
...
public:
	...
	uint8                                        Pad_2B0[0x3];                                      // Fixing Size Of Struct 
};
...
public:
	...
	uint8                                        Pad_2CE[0x7];                                      // Fixing Size After Last Property  
...
public:
	...
	uint8                                        Pad_492[0x8];                                      // Fixing Size After Last Property  
	struct CoreUObject_Transform                 CameraTransform;                                   // 0x10(0x60)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_505[0x4];                                      // Fixing Size After Last Property  
	struct VariantManagerContent_VariantDependency Dependency;                                        // 0x8(0x58)(Parm, OutParm, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_60B[0x7];                                      // Fixing Size After Last Property  
...
public:
	...
	struct VariantManagerContent_VariantDependency ReturnValue;                                       // 0x8(0x58)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
{
public:
	struct VariantManagerContent_VariantDependency Dependency;                                        // 0x0(0x58)(Parm, OutParm, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_6BA[0x4];                                      // Fixing Size Of Struct 
};
...
public:
	class UObject*                               WorldContextObject;                                // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_77B[0x8];                                      // Fixing Size After Last Property  
	struct CoreUObject_Transform                 CameraTransform;                                   // 0x10(0x60)(ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        FOVDegrees;                                        // 0x70(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        MinZ;                                              // 0x74(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        Gamma;                                             // 0x78(0x4)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_789[0x4];                                      // Fixing Size Of Struct 
};
...
public:
	...
	uint8                                        Pad_7BB[0x4];                                      // Fixing Size After Last Property  
