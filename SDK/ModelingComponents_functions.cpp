...
// struct CoreUObject_Transform       WithTransform                                                    (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UPreviewGeometry::CreateInWorld(class UWorld* World, struct CoreUObject_Transform& WithTransform)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct ModelingComponents_CreateTextureObjectParamsCreateTexParams                                                  (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct ModelingComponents_CreateTextureObjectResultReturnValue                                                      (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)

struct ModelingComponents_CreateTextureObjectResult UModelingObjectsCreationAPI::CreateTextureObject(struct ModelingComponents_CreateTextureObjectParams& CreateTexParams)
{
	static class UFunction* Func = nullptr;
...
// (Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct ModelingComponents_CreateActorParamsCreateActorParams                                                (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct ModelingComponents_CreateActorResultReturnValue                                                      (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)

struct ModelingComponents_CreateActorResult UModelingObjectsCreationAPI::CreateNewActor(struct ModelingComponents_CreateActorParams& CreateActorParams)
{
	static class UFunction* Func = nullptr;
...
// (Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct ModelingComponents_CreateMeshObjectParamsCreateMeshParams                                                 (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
// struct ModelingComponents_CreateMeshObjectResultReturnValue                                                      (Parm, OutParm, ReturnParm, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)

struct ModelingComponents_CreateMeshObjectResult UModelingObjectsCreationAPI::CreateMeshObject(struct ModelingComponents_CreateMeshObjectParams& CreateMeshParams)
{
	static class UFunction* Func = nullptr;
...
// (Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct ModelingComponents_CreateMaterialObjectParamsCreateMaterialParams                                             (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct ModelingComponents_CreateMaterialObjectResultReturnValue                                                      (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)

struct ModelingComponents_CreateMaterialObjectResult UModelingObjectsCreationAPI::CreateMaterialObject(struct ModelingComponents_CreateMaterialObjectParams& CreateMaterialParams)
{
	static class UFunction* Func = nullptr;
