...
struct NiagaraShader_SimulationStageMetaData
{
public:
	...
	struct CoreUObject_IntVector                 ElementCount;                                      // 0x10(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_AF9[0x3];                                      // Fixing Size After Last Property  
	...
	uint8                                        BitPad_45 : 4;                                     // Fixing Bit-Field Size  
	uint8                                        Pad_B07[0x3];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_B0A[0x4];                                      // Fixing Size After Last Property  
	struct CoreUObject_IntPoint                  ParticleIterationStateRange;                       // 0x5C(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_B0D[0x4];                                      // Fixing Size After Last Property  
	...
	struct CoreUObject_IntVector                 GpuDispatchNumThreads;                             // 0x98(0xC)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_B1A[0x4];                                      // Fixing Size Of Struct 
};

// 0x60 (0x60 - 0x0)
// ScriptStruct NiagaraShader.NiagaraCompileEvent
struct NiagaraShader_NiagaraCompileEvent
{
public:
	...
	uint8                                        Pad_B24[0x7];                                      // Fixing Size After Last Property  
	...
	struct CoreUObject_Guid                      NodeGuid;                                          // 0x28(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Guid                      PinGuid;                                           // 0x38(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct CoreUObject_Guid>              StackGuids;                                        // 0x48(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_B32[0x7];                                      // Fixing Size Of Struct 
};

// 0x50 (0x50 - 0x0)
// ScriptStruct NiagaraShader.NiagaraDataInterfaceGeneratedFunction
struct NiagaraShader_NiagaraDataInterfaceGeneratedFunction
{
public:
	uint8                                        Pad_B38[0x30];                                     // Fixing Size After Last Property  
	TArray<struct NiagaraCore_NiagaraVariableCommonReference> VariadicInputs;                                    // 0x30(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	TArray<struct NiagaraCore_NiagaraVariableCommonReference> VariadicOutputs;                                   // 0x40(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
};

// 0x38 (0x38 - 0x0)
// ScriptStruct NiagaraShader.NiagaraDataInterfaceGPUParamInfo
struct NiagaraShader_NiagaraDataInterfaceGPUParamInfo
{
public:
	...
	uint8                                        Pad_B40[0x4];                                      // Fixing Size After Last Property  
	TArray<struct NiagaraShader_NiagaraDataInterfaceGeneratedFunction> GeneratedFunctions;                                // 0x28(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
};

// 0x18 (0x18 - 0x0)
// ScriptStruct NiagaraShader.NiagaraShaderScriptExternalConstant
struct NiagaraShader_NiagaraShaderScriptExternalConstant
{
public:
...
struct NiagaraShader_NiagaraShaderScriptParametersMetadata
{
public:
	TArray<struct NiagaraShader_NiagaraDataInterfaceGPUParamInfo> DataInterfaceParamInfo;                            // 0x0(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_B4B[0x7];                                      // Fixing Size After Last Property  
	TArray<struct NiagaraShader_NiagaraShaderScriptExternalConstant> ExternalConstants;                                 // 0x28(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_B4C[0x20];                                     // Fixing Size Of Struct 
};
