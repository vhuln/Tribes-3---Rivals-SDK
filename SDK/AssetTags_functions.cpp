...
// Parameters:
// struct CoreUObject_SoftObjectPath  AssetPath                                                        (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// TArray<class FName>                ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)

TArray<class FName> UAssetTagsSubsystem::K2_GetCollectionsContainingAsset(struct CoreUObject_SoftObjectPath& AssetPath)
{
...
TArray<class FName> UAssetTagsSubsystem::GetCollectionsContainingAssetData(struct CoreUObject_AssetData& AssetData)
{
	static class UFunction* Func = nullptr;
...
TArray<struct CoreUObject_AssetData> UAssetTagsSubsystem::GetAssetsInCollection(class FName Name)
{
	static class UFunction* Func = nullptr;
