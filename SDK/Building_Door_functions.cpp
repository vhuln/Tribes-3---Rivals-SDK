...
class UClass* ABuilding_Door_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("Building_Door_C");

	return Clss;
}


// Building_Door_C Building_Door.Default__Building_Door_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABuilding_Door_C* ABuilding_Door_C::GetDefaultObj()
{
	static class ABuilding_Door_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABuilding_Door_C*>(ABuilding_Door_C::StaticClass()->DefaultObject);
...
void ABuilding_Door_C::ExecuteUbergraph_Building_Door(int32 EntryPoint, const struct CoreUObject_Transform& CallFunc_MakeTransform_ReturnValue, const struct CoreUObject_Vector& CallFunc_BreakTransform_Location, const struct CoreUObject_Rotator& CallFunc_BreakTransform_Rotation, const struct CoreUObject_Vector& CallFunc_BreakTransform_Scale, bool CallFunc_IsDedicatedServer_ReturnValue, const struct CoreUObject_Transform& CallFunc_K2_GetComponentToWorld_ReturnValue, const struct CoreUObject_Rotator& CallFunc_TransformRotation_ReturnValue, const struct CoreUObject_Vector& CallFunc_TransformLocation_ReturnValue, const struct CoreUObject_Transform& CallFunc_MakeTransform_ReturnValue_1, class AActor* CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue, class ABP_DestructibleDoor_BuildingA_C* CallFunc_FinishSpawningActor_ReturnValue)
{
	...
	Params::ABuilding_Door_C_ExecuteUbergraph_Building_Door_Params Parms{};
