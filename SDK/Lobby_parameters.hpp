...
{
public:
	struct Engine_UniqueNetIdRepl                InUniqueId;                                        // 0x0(0x30)(ConstParm, Parm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct Engine_UniqueNetIdRepl                InPartyOwnerId;                                    // 0x30(0x30)(ConstParm, Parm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct Engine_UniqueNetIdRepl                InUniqueId;                                        // 0x10(0x30)(ConstParm, Parm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct Engine_UniqueNetIdRepl                PlayerToKick;                                      // 0x0(0x30)(ConstParm, Parm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
{
public:
	struct CoreOnline_JoinabilitySettings        Settings;                                          // 0x0(0x14)(ConstParm, Parm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	struct Engine_UniqueNetIdRepl                InUniqueId;                                        // 0x18(0x30)(ConstParm, Parm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_FF4[0x7];                                      // Fixing Size Of Struct 
};
