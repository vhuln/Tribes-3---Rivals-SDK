...
class UClass* AGC_PhaseShift_Portal_Start_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_PhaseShift_Portal_Start_C");

	return Clss;
}


// GC_PhaseShift_Portal_Start_C GC_PhaseShift_Portal_Start.Default__GC_PhaseShift_Portal_Start_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_PhaseShift_Portal_Start_C* AGC_PhaseShift_Portal_Start_C::GetDefaultObj()
{
	static class AGC_PhaseShift_Portal_Start_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_PhaseShift_Portal_Start_C*>(AGC_PhaseShift_Portal_Start_C::StaticClass()->DefaultObject);
...
bool AGC_PhaseShift_Portal_Start_C::WhileActive(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters)
{
	...
	Params::AGC_PhaseShift_Portal_Start_C_WhileActive_Params Parms{};
...
bool AGC_PhaseShift_Portal_Start_C::OnRemove(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters, bool CallFunc_IsLocallyViewed_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, bool CallFunc_IsValid_ReturnValue_2)
{
	static class UFunction* Func = nullptr;
	...
	Params::AGC_PhaseShift_Portal_Start_C_OnRemove_Params Parms{};
...
bool AGC_PhaseShift_Portal_Start_C::OnActive(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters, float CallFunc_BreakGameplayCueParameters_NormalizedMagnitude, float CallFunc_BreakGameplayCueParameters_RawMagnitude, const struct GameplayAbilities_GameplayEffectContextHandle& CallFunc_BreakGameplayCueParameters_EffectContext, const struct GameplayTags_GameplayTag& CallFunc_BreakGameplayCueParameters_MatchedTagName, const struct GameplayTags_GameplayTag& CallFunc_BreakGameplayCueParameters_OriginalTag, const struct GameplayTags_GameplayTagContainer& CallFunc_BreakGameplayCueParameters_AggregatedSourceTags, const struct GameplayTags_GameplayTagContainer& CallFunc_BreakGameplayCueParameters_AggregatedTargetTags, const struct CoreUObject_Vector& CallFunc_BreakGameplayCueParameters_Location, const struct CoreUObject_Vector& CallFunc_BreakGameplayCueParameters_Normal, class AActor* CallFunc_BreakGameplayCueParameters_Instigator, class AActor* CallFunc_BreakGameplayCueParameters_EffectCauser, class UObject* CallFunc_BreakGameplayCueParameters_SourceObject, class UPhysicalMaterial* CallFunc_BreakGameplayCueParameters_PhysicalMaterial, int32 CallFunc_BreakGameplayCueParameters_GameplayEffectLevel, int32 CallFunc_BreakGameplayCueParameters_AbilityLevel, class USceneComponent* CallFunc_BreakGameplayCueParameters_TargetAttachComponent, bool CallFunc_BreakGameplayCueParameters_bReplicateLocationWhenUsingMinimalRepProxy, class ABP_ValChar_Master_C* K2Node_DynamicCast_AsBP_Val_Char_Master, bool K2Node_DynamicCast_bSuccess, bool CallFunc_IsLocallyViewed_ReturnValue, class USkeletalMeshComponent* CallFunc_GetMesh1P_ReturnValue, const struct CoreUObject_Vector& CallFunc_GetSocketLocation_ReturnValue, class UNiagaraComponent* CallFunc_SpawnSystemAtLocation_ReturnValue, class UNiagaraComponent* CallFunc_SpawnSystemAtLocation_ReturnValue_1, class APawn* CallFunc_GetPlayerPawn_ReturnValue, bool CallFunc_IsEnemyWith_ReturnValue, class UNiagaraComponent* CallFunc_Create_1P3P_VFX_Active_1PVFX, class UNiagaraSystem* CallFunc_Create_1P3P_VFX_1P_System_Ref, class UNiagaraComponent* CallFunc_Create_1P3P_VFX_Active_3PVFX, class UNiagaraSystem* CallFunc_Create_1P3P_VFX_3P_System_Ref, const struct Engine_HitResult& CallFunc_K2_SetWorldLocation_SweepHitResult)
{
	...
	Params::AGC_PhaseShift_Portal_Start_C_OnActive_Params Parms{};
...
void AGC_PhaseShift_Portal_Start_C::ReceiveTick(float DeltaSeconds)
{
	...
	Params::AGC_PhaseShift_Portal_Start_C_ReceiveTick_Params Parms{};
...
void AGC_PhaseShift_Portal_Start_C::K2_HandleGameplayCue(class AActor* MyTarget, enum class EGameplayCueEvent EventType, struct GameplayAbilities_GameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;
	...
	Params::AGC_PhaseShift_Portal_Start_C_K2_HandleGameplayCue_Params Parms{};
...
void AGC_PhaseShift_Portal_Start_C::ExecuteUbergraph_GC_PhaseShift_Portal_Start(int32 EntryPoint, bool CallFunc_IsValid_ReturnValue, float K2Node_Event_DeltaSeconds, class AActor* K2Node_Event_MyTarget, enum class EGameplayCueEvent K2Node_Event_EventType, const struct GameplayAbilities_GameplayCueParameters& K2Node_Event_Parameters, const struct CoreUObject_Vector& CallFunc_GetSocketLocation_ReturnValue, const struct Engine_HitResult& CallFunc_K2_SetWorldLocation_SweepHitResult)
{
	static class UFunction* Func = nullptr;
	...
	Params::AGC_PhaseShift_Portal_Start_C_ExecuteUbergraph_GC_PhaseShift_Portal_Start_Params Parms{};
