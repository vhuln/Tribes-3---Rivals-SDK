...
// Parameters:
// struct CoreUObject_Vector2D        InMeshRange                                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UMediaPlateComponent::SetMeshRange(const struct CoreUObject_Vector2D& InMeshRange)
{
	static class UFunction* Func = nullptr;
...
bool UMediaPlateComponent::Seek(struct CoreUObject_Timespan& Time)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D UMediaPlateComponent::GetMeshRange()
{
	static class UFunction* Func = nullptr;
