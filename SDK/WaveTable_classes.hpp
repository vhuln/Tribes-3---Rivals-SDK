...
{
public:
	uint8                                        Pad_105F[0x8];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_1063[0x2];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_1066[0x7];                                     // Fixing Size After Last Property  
	TArray<struct WaveTable_WaveTableBankEntry>  Entries;                                           // 0x40(0x10)(Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_106A[0x10];                                    // Fixing Size Of Struct 
