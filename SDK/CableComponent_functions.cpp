...
// Parameters:
// TArray<struct CoreUObject_Vector>  Locations                                                        (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)

void UCableComponent::GetCableParticleLocations(TArray<struct CoreUObject_Vector>* Locations)
{
	static class UFunction* Func = nullptr;
