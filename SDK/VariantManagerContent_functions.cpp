...
// struct CoreUObject_Transform       CameraTransform                                                  (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UVariant::SetThumbnailFromCamera(class UObject* WorldContextObject, struct CoreUObject_Transform& CameraTransform, float FOVDegrees, float MinZ, float Gamma)
{
	static class UFunction* Func = nullptr;
...
// struct VariantManagerContent_VariantDependencyDependency                                                       (Parm, OutParm, NativeAccessSpecifierPublic)

void UVariant::SetDependency(int32 Index, struct VariantManagerContent_VariantDependency* Dependency)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// int32                              Index                                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct VariantManagerContent_VariantDependencyReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct VariantManagerContent_VariantDependency UVariant::GetDependency(int32 Index)
{
	static class UFunction* Func = nullptr;
...
int32 UVariant::AddDependency(struct VariantManagerContent_VariantDependency* Dependency)
{
	static class UFunction* Func = nullptr;
...
void UVariantSet::SetThumbnailFromCamera(class UObject* WorldContextObject, struct CoreUObject_Transform& CameraTransform, float FOVDegrees, float MinZ, float Gamma)
{
	static class UFunction* Func = nullptr;
