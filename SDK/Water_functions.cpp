...
// Parameters:
// struct Water_SphericalPontoon      Pontoon                                                          (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)

void UBuoyancyComponent::OnPontoonExitedWater(struct Water_SphericalPontoon& Pontoon)
{
...
void UBuoyancyComponent::OnPontoonEnteredWater(struct Water_SphericalPontoon& Pontoon)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct CoreUObject_Vector          OutWaterPlaneLocation                                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector          OutWaterPlaneNormal                                              (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector          OutWaterSurfacePosition                                          (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
// struct CoreUObject_Vector          OutWaterVelocity                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UBuoyancyComponent::GetLastWaterSurfaceInfo(struct CoreUObject_Vector* OutWaterPlaneLocation, struct CoreUObject_Vector* OutWaterPlaneNormal, struct CoreUObject_Vector* OutWaterSurfacePosition, float* OutWaterDepth, int32* OutWaterBodyIdx, struct CoreUObject_Vector* OutWaterVelocity)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// TArray<struct Water_GerstnerWave>  OutWaves                                                         (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)

void UGerstnerWaterWaveGeneratorBase::GenerateGerstnerWaves(TArray<struct Water_GerstnerWave>* OutWaves)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector AWaterBody::GetWaterVelocityVectorAtSplineInputKey(float InKey)
{
	static class UFunction* Func = nullptr;
...
// struct CoreUObject_Vector          OutWaterSurfaceLocation                                          (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector          OutWaterSurfaceNormal                                            (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector          OutWaterVelocity                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                              OutWaterDepth                                                    (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               bIncludeDepth                                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWaterBodyComponent::GetWaterSurfaceInfoAtLocation(struct CoreUObject_Vector& InLocation, struct CoreUObject_Vector* OutWaterSurfaceLocation, struct CoreUObject_Vector* OutWaterSurfaceNormal, struct CoreUObject_Vector* OutWaterVelocity, float* OutWaterDepth, bool bIncludeDepth)
{
	static class UFunction* Func = nullptr;
