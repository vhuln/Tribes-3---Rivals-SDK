...
struct InterchangePipelines_InterchangeLodSceneNodeContainer
{
public:
...
struct InterchangePipelines_InterchangeMeshInstance
{
public:
	...
	uint8                                        Pad_1A80[0x5];                                     // Fixing Size After Last Property  
	TMap<int32, struct InterchangePipelines_InterchangeLodSceneNodeContainer> SceneNodePerLodIndex;                              // 0x20(0x50)(Edit, NativeAccessSpecifierPublic)
...
struct InterchangePipelines_InterchangeMeshGeometry
{
public:
...
struct InterchangePipelines_InterchangePipelineMeshesUtilitiesContext
{
public:
