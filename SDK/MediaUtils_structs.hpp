...
struct MediaUtils_MediaPlayerTrackOptions
{
public:
...
struct MediaUtils_MediaPlayerOptions
{
public:
	struct MediaUtils_MediaPlayerTrackOptions    Tracks;                                            // 0x0(0x1C)(BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_1997[0x4];                                     // Fixing Size After Last Property  
	struct CoreUObject_Timespan                  SeekTime;                                          // 0x20(0x8)(BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_19A4[0x6];                                     // Fixing Size Of Struct 
};
