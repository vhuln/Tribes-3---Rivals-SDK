...
{
public:
	uint8                                        Pad_1172[0x18];                                    // Fixing Size Of Struct 
...
public:
	...
	struct MetasoundFrontend_MetasoundFrontendDocument Document;                                          // 0x30(0x1C8)(Transient, NativeAccessSpecifierPrivate)
