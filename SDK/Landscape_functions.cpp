...
// struct CoreUObject_LinearColor     Value                                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void ALandscapeProxy::SetLandscapeMaterialVectorParameterValue(class FName ParameterName, const struct CoreUObject_LinearColor& Value)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct CoreUObject_Transform       InWorldTransform                                                 (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Box2D           InExtents                                                        (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
...
void ALandscape::RenderHeightmap(struct CoreUObject_Transform& InWorldTransform, struct CoreUObject_Box2D& InExtents, class UTextureRenderTarget2D* OutRenderTarget)
{
	static class UFunction* Func = nullptr;
...
float ULandscapeComponent::EditorGetPaintLayerWeightByNameAtLocation(struct CoreUObject_Vector& InLocation, class FName InPaintLayerName)
{
	static class UFunction* Func = nullptr;
...
float ULandscapeComponent::EditorGetPaintLayerWeightAtLocation(struct CoreUObject_Vector& InLocation, class ULandscapeLayerInfoObject* PaintLayer)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct Landscape_LandscapeBrushParametersInParameters                                                     (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
...
class UTextureRenderTarget2D* ALandscapeBlueprintBrushBase::RenderLayer(struct Landscape_LandscapeBrushParameters& InParameters)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct CoreUObject_Transform       InLandscapeTransform                                             (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_IntPoint        InLandscapeSize                                                  (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_IntPoint        InLandscapeRenderTargetSize                                      (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void ALandscapeBlueprintBrushBase::Initialize(struct CoreUObject_Transform& InLandscapeTransform, struct CoreUObject_IntPoint& InLandscapeSize, struct CoreUObject_IntPoint& InLandscapeRenderTargetSize)
{
	static class UFunction* Func = nullptr;
