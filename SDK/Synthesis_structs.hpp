...
struct Synthesis_Synth1PatchCable
{
public:
	...
	uint8                                        Pad_26B7[0x3];                                     // Fixing Size Of Struct 
};

// 0x4 (0x4 - 0x0)
// ScriptStruct Synthesis.PatchId
struct Synthesis_PatchId
{
public:
...
struct Synthesis_EpicSynth1Patch
{
public:
	...
	uint8                                        Pad_26C4[0x7];                                     // Fixing Size After Last Property  
	TArray<struct Synthesis_Synth1PatchCable>    PatchCables;                                       // 0x8(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};

// 0xD8 (0xE0 - 0x8)
// ScriptStruct Synthesis.ModularSynthPreset
struct Synthesis_ModularSynthPreset : public Engine_TableRowBase
{
public:
	...
	uint8                                        BitPad_AE : 7;                                     // Fixing Bit-Field Size  
	...
	uint8                                        Pad_26D1[0x3];                                     // Fixing Size After Last Property  
	...
	uint8                                        BitPad_B0 : 6;                                     // Fixing Bit-Field Size  
	...
	uint8                                        Pad_26EA[0x1];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_26F8[0x1];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_26FB[0x2];                                     // Fixing Size After Last Property  
	...
	uint8                                        BitPad_B4 : 6;                                     // Fixing Bit-Field Size  
	...
	uint8                                        Pad_2732[0x2];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_2736[0x3];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_273D[0x3];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_2742[0x4];                                     // Fixing Size After Last Property  
	TArray<struct Synthesis_EpicSynth1Patch>     Patches;                                           // 0xD0(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};

// 0xF0 (0xF0 - 0x0)
// ScriptStruct Synthesis.ModularSynthPresetBankEntry
struct Synthesis_ModularSynthPresetBankEntry
{
public:
	class FString                                PresetName;                                        // 0x0(0x10)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct Synthesis_ModularSynthPreset          Preset;                                            // 0x10(0xE0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};

// 0x8 (0x8 - 0x0)
// ScriptStruct Synthesis.SourceEffectBitCrusherBaseSettings
struct Synthesis_SourceEffectBitCrusherBaseSettings
{
public:
...
struct Synthesis_SourceEffectBitCrusherSettings
{
public:
	...
	uint8                                        Pad_2758[0x4];                                     // Fixing Size After Last Property  
	struct Engine_SoundModulationDestinationSettings SampleRateModulation;                              // 0x8(0x58)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	...
	struct Engine_SoundModulationDestinationSettings BitModulation;                                     // 0x68(0x58)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};

// 0x18 (0x18 - 0x0)
// ScriptStruct Synthesis.SourceEffectChorusBaseSettings
struct Synthesis_SourceEffectChorusBaseSettings
{
public:
	float                                        Depth;                                             // 0x0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct Synthesis_SourceEffectChorusSettings
{
public:
	...
	struct Engine_SoundModulationDestinationSettings DepthModulation;                                   // 0x18(0x58)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct Engine_SoundModulationDestinationSettings FrequencyModulation;                               // 0x70(0x58)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct Engine_SoundModulationDestinationSettings FeedbackModulation;                                // 0xC8(0x58)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct Engine_SoundModulationDestinationSettings WetModulation;                                     // 0x120(0x58)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct Engine_SoundModulationDestinationSettings DryModulation;                                     // 0x178(0x58)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct Engine_SoundModulationDestinationSettings SpreadModulation;                                  // 0x1D0(0x58)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
};

// 0x10 (0x10 - 0x0)
// ScriptStruct Synthesis.SourceEffectConvolutionReverbSettings
struct Synthesis_SourceEffectConvolutionReverbSettings
{
public:
	...
	uint8                                        Pad_2778[0x3];                                     // Fixing Size Of Struct 
};

// 0x28 (0x28 - 0x0)
// ScriptStruct Synthesis.SourceEffectDynamicsProcessorSettings
struct Synthesis_SourceEffectDynamicsProcessorSettings
{
public:
	...
	uint8                                        Pad_277C[0x2];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_2784[0x3];                                     // Fixing Size Of Struct 
};

// 0xC (0xC - 0x0)
// ScriptStruct Synthesis.SourceEffectEnvelopeFollowerSettings
struct Synthesis_SourceEffectEnvelopeFollowerSettings
{
public:
	...
	uint8                                        Pad_2789[0x2];                                     // Fixing Size Of Struct 
};

// 0x10 (0x10 - 0x0)
// ScriptStruct Synthesis.SourceEffectEQBand
struct Synthesis_SourceEffectEQBand
{
public:
	...
	uint8                                        Pad_2791[0x3];                                     // Fixing Size Of Struct 
};

// 0x10 (0x10 - 0x0)
// ScriptStruct Synthesis.SourceEffectEQSettings
struct Synthesis_SourceEffectEQSettings
{
public:
	TArray<struct Synthesis_SourceEffectEQBand>  EQBands;                                           // 0x0(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};

// 0x28 (0x28 - 0x0)
// ScriptStruct Synthesis.SourceEffectFilterAudioBusModulationSettings
struct Synthesis_SourceEffectFilterAudioBusModulationSettings
{
public:
	...
	uint8                                        Pad_279A[0x3];                                     // Fixing Size After Last Property  
...
struct Synthesis_SourceEffectFilterSettings
{
public:
	...
	uint8                                        Pad_27A7[0x2];                                     // Fixing Size After Last Property  
	...
	TArray<struct Synthesis_SourceEffectFilterAudioBusModulationSettings> AudioBusModulation;                                // 0x10(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};

// 0xC (0xC - 0x0)
// ScriptStruct Synthesis.SourceEffectFoldbackDistortionSettings
struct Synthesis_SourceEffectFoldbackDistortionSettings
{
public:
...
struct Synthesis_SourceEffectMidSideSpreaderSettings
{
public:
	...
	uint8                                        Pad_27B0[0x1];                                     // Fixing Size Of Struct 
};

// 0xC (0xC - 0x0)
// ScriptStruct Synthesis.SourceEffectIndividualFilterSettings
struct Synthesis_SourceEffectIndividualFilterSettings
{
public:
...
struct Synthesis_SourceEffectMotionFilterModulationSettings
{
public:
	...
	struct CoreUObject_Vector2D                  ModulationInputRange;                              // 0x8(0x10)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector2D                  ModulationOutputMinimumRange;                      // 0x18(0x10)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector2D                  ModulationOutputMaximumRange;                      // 0x28(0x10)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_27CC[0x4];                                     // Fixing Size Of Struct 
};

// 0x78 (0x78 - 0x0)
// ScriptStruct Synthesis.SourceEffectMotionFilterSettings
struct Synthesis_SourceEffectMotionFilterSettings
{
public:
	...
	struct Synthesis_SourceEffectIndividualFilterSettings FilterASettings;                                   // 0x8(0xC)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct Synthesis_SourceEffectIndividualFilterSettings FilterBSettings;                                   // 0x14(0xC)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	TMap<enum class ESourceEffectMotionFilterModDestination, struct Synthesis_SourceEffectMotionFilterModulationSettings> ModulationMappings;                                // 0x20(0x50)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_27E0[0x4];                                     // Fixing Size Of Struct 
};

// 0x8 (0x8 - 0x0)
// ScriptStruct Synthesis.SourceEffectPannerSettings
struct Synthesis_SourceEffectPannerSettings
{
public:
...
struct Synthesis_SourceEffectPhaserSettings
{
public:
	...
	uint8                                        Pad_27FD[0x2];                                     // Fixing Size Of Struct 
};

// 0x20 (0x20 - 0x0)
// ScriptStruct Synthesis.SourceEffectRingModulationSettings
struct Synthesis_SourceEffectRingModulationSettings
{
public:
	...
	uint8                                        Pad_2800[0x3];                                     // Fixing Size After Last Property  
	float                                        Frequency;                                         // 0x4(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct Synthesis_SourceEffectSimpleDelaySettings
{
public:
	...
	uint8                                        Pad_280B[0x3];                                     // Fixing Size Of Struct 
};

// 0x24 (0x24 - 0x0)
// ScriptStruct Synthesis.SourceEffectStereoDelaySettings
struct Synthesis_SourceEffectStereoDelaySettings
{
public:
	...
	uint8                                        Pad_2813[0x3];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_281A[0x2];                                     // Fixing Size After Last Property  
...
struct Synthesis_SourceEffectWaveShaperSettings
{
public:
...
struct Synthesis_SubmixEffectConvolutionReverbSettings
{
public:
	float                                        NormalizationVolumeDb;                             // 0x0(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        WetVolumeDb;                                       // 0x4(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_2827[0x1];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_2833[0x2];                                     // Fixing Size After Last Property  
...
struct Synthesis_SubmixEffectDelaySettings
{
public:
...
struct Synthesis_SubmixEffectFilterSettings
{
public:
	...
	uint8                                        Pad_2846[0x2];                                     // Fixing Size After Last Property  
...
struct Synthesis_SubmixEffectFlexiverbSettings
{
public:
...
struct Synthesis_DynamicsBandSettings
{
public:
...
struct Synthesis_SubmixEffectMultibandCompressorSettings
{
public:
	...
	uint8                                        Pad_2861[0x1];                                     // Fixing Size After Last Property  
	float                                        LookAheadMsec;                                     // 0x4(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_2865[0x4];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_2872[0x3];                                     // Fixing Size After Last Property  
	TArray<struct Synthesis_DynamicsBandSettings> Bands;                                             // 0x28(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};

// 0x24 (0x24 - 0x0)
// ScriptStruct Synthesis.SubmixEffectStereoDelaySettings
struct Synthesis_SubmixEffectStereoDelaySettings
{
public:
	enum class EStereoDelaySourceEffect          DelayMode;                                         // 0x0(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2877[0x3];                                     // Fixing Size After Last Property  
	float                                        DelayTimeMsec;                                     // 0x4(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        Feedback;                                          // 0x8(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        DelayRatio;                                        // 0xC(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        WetLevel;                                          // 0x10(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	bool                                         bFilterEnabled;                                    // 0x18(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	enum class EStereoDelayFiltertype            FilterType;                                        // 0x19(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_2883[0x2];                                     // Fixing Size After Last Property  
	float                                        FilterFrequency;                                   // 0x1C(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        FilterQ;                                           // 0x20(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
struct Synthesis_SubmixEffectStereoToQuadSettings
{
public:
...
public:
	...
	uint8                                        Pad_288D[0x3];                                     // Fixing Size After Last Property  
...
struct Synthesis_SubmixEffectTapDelaySettings
{
public:
	float                                        MaximumDelayLength;                                // 0x0(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        InterpolationTime;                                 // 0x4(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TArray<struct Synthesis_TapDelayInfo>        Taps;                                              // 0x8(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};

// 0x428 (0x430 - 0x8)
// ScriptStruct Synthesis.Synth2DSliderStyle
struct Synthesis_Synth2DSliderStyle : public SlateCore_SlateWidgetStyle
{
public:
	uint8                                        Pad_2896[0x8];                                     // Fixing Size After Last Property  
	struct SlateCore_SlateBrush                  NormalThumbImage;                                  // 0x10(0xD0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct SlateCore_SlateBrush                  DisabledThumbImage;                                // 0xE0(0xD0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct SlateCore_SlateBrush                  NormalBarImage;                                    // 0x1B0(0xD0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct SlateCore_SlateBrush                  DisabledBarImage;                                  // 0x280(0xD0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct SlateCore_SlateBrush                  BackgroundImage;                                   // 0x350(0xD0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_289D[0xC];                                     // Fixing Size Of Struct 
};

// 0x358 (0x360 - 0x8)
// ScriptStruct Synthesis.SynthKnobStyle
struct Synthesis_SynthKnobStyle : public SlateCore_SlateWidgetStyle
{
public:
	uint8                                        Pad_28A1[0x8];                                     // Fixing Size After Last Property  
	struct SlateCore_SlateBrush                  LargeKnob;                                         // 0x10(0xD0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct SlateCore_SlateBrush                  LargeKnobOverlay;                                  // 0xE0(0xD0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct SlateCore_SlateBrush                  MediumKnob;                                        // 0x1B0(0xD0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	struct SlateCore_SlateBrush                  MediumKnobOverlay;                                 // 0x280(0xD0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_28A8[0x7];                                     // Fixing Size Of Struct 
};

// 0x8 (0x10 - 0x8)
// ScriptStruct Synthesis.SynthSlateStyle
struct Synthesis_SynthSlateStyle : public SlateCore_SlateWidgetStyle
{
public:
	...
	uint8                                        Pad_28AB[0x6];                                     // Fixing Size Of Struct 
};
