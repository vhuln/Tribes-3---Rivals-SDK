...
// Parameters:
// struct SkeletalMerging_SkeletonMergeParamsParams                                                           (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
class USkeleton* USkeletalMergingLibrary::MergeSkeletons(struct SkeletalMerging_SkeletonMergeParams& Params)
{
...
// (Final, Native, Static, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct SkeletalMerging_SkeletalMeshMergeParamsParams                                                           (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
class USkeletalMesh* USkeletalMergingLibrary::MergeMeshes(struct SkeletalMerging_SkeletalMeshMergeParams& Params)
{
	static class UFunction* Func = nullptr;
