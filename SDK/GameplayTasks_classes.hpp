...
{
public:
	uint8                                        Pad_960[0x8];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_966[0x2];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_973[0x25];                                     // Fixing Size After Last Property  
...
public:
	...
	uint8                                        Pad_9BF[0x7];                                      // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_A4B[0x18];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_A4E[0x10];                                     // Fixing Size After Last Property  
...
public:
	...
	uint8                                        Pad_B5D[0x30];                                     // Fixing Size After Last Property  
	...
	class UGameplayTask_SpawnActor* SpawnActor(TScriptInterface<class IGameplayTaskOwnerInterface> TaskOwner, const struct CoreUObject_Vector& SpawnLocation, const struct CoreUObject_Rotator& SpawnRotation, TSubclassOf<class AActor> Class, bool bSpawnOnlyOnAuthority);
...
public:
	...
	uint8                                        Pad_B8E[0x18];                                     // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_BEF[0x10];                                     // Fixing Size Of Struct 
