...
public:
	...
	bool GetAudioCaptureDeviceInfo(struct AudioCapture_AudioCaptureDeviceInfo* OutInfo);
};
...
public:
	...
	class FString Conv_AudioInputDeviceInfoToString(struct AudioCapture_AudioInputDeviceInfo& Info);
};
...
public:
	...
	uint8                                        Pad_18BC[0xBC];                                    // Fixing Size Of Struct 
