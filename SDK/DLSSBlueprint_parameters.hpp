...
public:
	...
	uint8                                        Pad_452[0x7];                                      // Fixing Size Of Struct 
};
...
public:
	enum class EUDLSSMode                        DLSSMode;                                          // 0x0(0x1)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_4D5[0x7];                                      // Fixing Size After Last Property  
	struct CoreUObject_Vector2D                  ScreenResolution;                                  // 0x8(0x10)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_4D8[0x3];                                      // Fixing Size After Last Property  
