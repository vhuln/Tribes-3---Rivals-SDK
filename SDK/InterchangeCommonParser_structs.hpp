...
struct InterchangeCommonParser_InterchangeCurveKey
{
public:
	...
	uint8                                        Pad_1C4C[0x1];                                     // Fixing Size After Last Property  
...
struct InterchangeCommonParser_InterchangeCurve
{
public:
	TArray<struct InterchangeCommonParser_InterchangeCurveKey> Keys;                                              // 0x0(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
};

// 0x70 (0x70 - 0x0)
// ScriptStruct InterchangeCommonParser.InterchangeStepCurve
struct InterchangeCommonParser_InterchangeStepCurve
{
public:
	TArray<float>                                KeyTimes;                                          // 0x0(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_1C54[0x60];                                    // Fixing Size Of Struct 
};
