...
struct AGC_Turret_Detection_C_WhileActive_Params
{
public:
	...
	uint8                                        Pad_31D7[0x7];                                     // Fixing Size After Last Property  
	class APlayerController*                     CallFunc_GetPlayerController_ReturnValue;          // 0x1C0(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class AValPlayerController*                  K2Node_DynamicCast_AsVal_Player_Controller;        // 0x1C8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class AValCharacter*                         CallFunc_GetValCharacter_ReturnValue;              // 0x1D8(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                         CallFunc_IsLocallyViewed_ReturnValue;              // 0x1E1(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0xE1 (0xE1 - 0x0)
// Function GC_Turret_Detection.GC_Turret_Detection_C.OnRemove
struct AGC_Turret_Detection_C_OnRemove_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct GameplayAbilities_GameplayCueParameters Parameters;                                        // 0x8(0xD8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct AGC_Turret_Detection_C_ReceiveTick_Params
{
public:
...
struct AGC_Turret_Detection_C_ExecuteUbergraph_GC_Turret_Detection_Params
{
public:
