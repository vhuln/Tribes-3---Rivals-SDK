...
class UClass* AGC_BotHitReaction_Latched_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_BotHitReaction_Latched_C");

	return Clss;
}


// GC_BotHitReaction_Latched_C GC_BotHitReaction_Latched.Default__GC_BotHitReaction_Latched_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_BotHitReaction_Latched_C* AGC_BotHitReaction_Latched_C::GetDefaultObj()
{
	static class AGC_BotHitReaction_Latched_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_BotHitReaction_Latched_C*>(AGC_BotHitReaction_Latched_C::StaticClass()->DefaultObject);
