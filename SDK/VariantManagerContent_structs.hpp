...
struct VariantManagerContent_FunctionCaller
{
public:
...
struct VariantManagerContent_CapturedPropSegment
{
public:
...
struct VariantManagerContent_VariantDependency
{
public:
	...
	uint8                                        Pad_8B8[0x7];                                      // Fixing Size Of Struct 
};
