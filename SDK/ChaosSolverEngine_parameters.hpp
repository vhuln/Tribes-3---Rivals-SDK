...
{
public:
	struct ChaosSolverEngine_ChaosPhysicsCollisionInfo PhysicsCollision;                                  // 0x0(0xC0)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
	struct Engine_HitResult                      ReturnValue;                                       // 0xC0(0xE8)(Parm, OutParm, ReturnParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)
};
