...
struct ModularGameplay_ActorInitStateChangedParams
{
public:
	...
	struct GameplayTags_GameplayTag              FeatureState;                                      // 0x18(0x8)(Edit, BlueprintVisible, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
