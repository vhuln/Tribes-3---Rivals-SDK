...
// (Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// TArray<struct AudioExtensions_AudioParameter>InParameters                                                     (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)

void IAudioParameterControllerInterface::SetParameters_Blueprint(TArray<struct AudioExtensions_AudioParameter>& InParameters)
{
	static class UFunction* Func = nullptr;
