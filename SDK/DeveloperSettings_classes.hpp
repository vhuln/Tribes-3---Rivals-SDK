...
{
public:
	uint8                                        Pad_266[0x10];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_270[0x18];                                     // Fixing Size Of Struct 
...
{
public:
	TMap<TSubclassOf<class UPlatformSettings>, struct DeveloperSettings_PlatformSettingsInstances> SettingsMap;                                       // 0x28(0x50)(Transient, NativeAccessSpecifierPrivate)
	uint8                                        Pad_278[0x8];                                      // Fixing Size Of Struct 
