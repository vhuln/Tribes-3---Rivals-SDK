...
{
public:
	uint8                                        Pad_BF[0x10];                                      // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_DC[0x1];                                       // Fixing Size After Last Property  
	...
	struct MediaAssets_MediaSourceCacheSettings  CacheSettings;                                     // 0xDC(0x8)(Edit, NoDestructor, AdvancedDisplay, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_E3[0x7];                                       // Fixing Size After Last Property  
	...
	uint8                                        Pad_E4[0x1];                                       // Fixing Size After Last Property  
	...
	uint8                                        Pad_E5[0x2];                                       // Fixing Size After Last Property  
	...
	uint8                                        Pad_E7[0x8];                                       // Fixing Size After Last Property  
	struct CoreUObject_Vector2D                  MeshRange;                                         // 0x108(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	...
	uint8                                        Pad_E8[0x38];                                      // Fixing Size Of Struct 

	static class UClass* StaticClass();
	static class UMediaPlateComponent* GetDefaultObj();

	void SetPlayOnlyWhenVisible(bool bInPlayOnlyWhenVisible);
	void SetMeshRange(const struct CoreUObject_Vector2D& InMeshRange);
	...
	struct CoreUObject_Vector2D GetMeshRange();
