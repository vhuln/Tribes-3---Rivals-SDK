...
class AGC_Healing_Buff_Station_InRange_C : public AGameplayCueNotify_Actor
{
public:
	...
	void ExecuteUbergraph_GC_Healing_Buff_Station_InRange(int32 EntryPoint, float K2Node_Event_DeltaSeconds);
};
