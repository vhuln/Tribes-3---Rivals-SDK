...
public:
	...
	uint8                                        Pad_FBD[0x7];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_FBF[0x8];                                      // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_100C[0x3];                                     // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_1072[0x3];                                     // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_10C7[0x50];                                    // Fixing Size After Last Property  
	...
	uint8                                        Pad_10CD[0x38];                                    // Fixing Size After Last Property  
	...
	uint8                                        Pad_10D9[0x10];                                    // Fixing Size After Last Property  
	...
	uint8                                        Pad_10DF[0x28];                                    // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_1250[0x40];                                    // Fixing Size Of Struct 
...
{
public:
	TArray<struct AnimationSharing_PerSkeletonAnimationSharingSetup> SkeletonSetups;                                    // 0x28(0x10)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	struct AnimationSharing_AnimationSharingScalability ScalabilitySettings;                               // 0x38(0x10)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
