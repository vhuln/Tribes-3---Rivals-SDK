...
// Parameters:
// struct LocalizableMessage_LocalizableMessageMessage                                                          (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void ULocalizableMessageLibrary::Reset_LocalizableMessage(struct LocalizableMessage_LocalizableMessage& Message)
{
...
// Parameters:
// struct LocalizableMessage_LocalizableMessageMessage                                                          (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool ULocalizableMessageLibrary::IsEmpty_LocalizableMessage(struct LocalizableMessage_LocalizableMessage& Message)
{
	static class UFunction* Func = nullptr;
...
class FText ULocalizableMessageLibrary::Conv_LocalizableMessageToText(class UObject* WorldContextObject, struct LocalizableMessage_LocalizableMessage& Message)
{
	static class UFunction* Func = nullptr;
