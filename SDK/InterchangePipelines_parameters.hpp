...
{
public:
	struct InterchangePipelines_InterchangePipelineMeshesUtilitiesContext Context;                                           // 0x0(0x5)(ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_19A1[0x7];                                     // Fixing Size Of Struct 
};
...
public:
	...
	bool                                         ReturnValue;                                       // 0x10(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_19AB[0x7];                                     // Fixing Size Of Struct 
};
...
public:
	class FString                                MeshInstanceUid;                                   // 0x0(0x10)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct InterchangePipelines_InterchangeMeshInstance ReturnValue;                                       // 0x10(0x80)(ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)
};
...
public:
	class FString                                MeshGeometryUid;                                   // 0x0(0x10)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct InterchangePipelines_InterchangeMeshGeometry ReturnValue;                                       // 0x10(0x38)(ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)
};
