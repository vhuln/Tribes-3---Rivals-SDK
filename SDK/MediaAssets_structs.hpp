...
struct MediaAssets_MediaMetadataItemBPT
{
public:
...
struct MediaAssets_MediaMetadataItemsBPT
{
public:
	TArray<struct MediaAssets_MediaMetadataItemBPT> Items;                                             // 0x0(0x10)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NativeAccessSpecifierPublic)
};

// 0x8 (0x8 - 0x0)
// ScriptStruct MediaAssets.MediaSoundComponentSpectralData
struct MediaAssets_MediaSoundComponentSpectralData
{
public:
...
struct MediaAssets_MediaCaptureDevice
{
public:
