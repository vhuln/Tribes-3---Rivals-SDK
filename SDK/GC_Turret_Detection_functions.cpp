...
class UClass* AGC_Turret_Detection_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Turret_Detection_C");

	return Clss;
}


// GC_Turret_Detection_C GC_Turret_Detection.Default__GC_Turret_Detection_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_Turret_Detection_C* AGC_Turret_Detection_C::GetDefaultObj()
{
	static class AGC_Turret_Detection_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_Turret_Detection_C*>(AGC_Turret_Detection_C::StaticClass()->DefaultObject);
...
bool AGC_Turret_Detection_C::WhileActive(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters, float CallFunc_BreakGameplayCueParameters_NormalizedMagnitude, float CallFunc_BreakGameplayCueParameters_RawMagnitude, const struct GameplayAbilities_GameplayEffectContextHandle& CallFunc_BreakGameplayCueParameters_EffectContext, const struct GameplayTags_GameplayTag& CallFunc_BreakGameplayCueParameters_MatchedTagName, const struct GameplayTags_GameplayTag& CallFunc_BreakGameplayCueParameters_OriginalTag, const struct GameplayTags_GameplayTagContainer& CallFunc_BreakGameplayCueParameters_AggregatedSourceTags, const struct GameplayTags_GameplayTagContainer& CallFunc_BreakGameplayCueParameters_AggregatedTargetTags, const struct CoreUObject_Vector& CallFunc_BreakGameplayCueParameters_Location, const struct CoreUObject_Vector& CallFunc_BreakGameplayCueParameters_Normal, class AActor* CallFunc_BreakGameplayCueParameters_Instigator, class AActor* CallFunc_BreakGameplayCueParameters_EffectCauser, class UObject* CallFunc_BreakGameplayCueParameters_SourceObject, class UPhysicalMaterial* CallFunc_BreakGameplayCueParameters_PhysicalMaterial, int32 CallFunc_BreakGameplayCueParameters_GameplayEffectLevel, int32 CallFunc_BreakGameplayCueParameters_AbilityLevel, class USceneComponent* CallFunc_BreakGameplayCueParameters_TargetAttachComponent, bool CallFunc_BreakGameplayCueParameters_bReplicateLocationWhenUsingMinimalRepProxy, class APlayerController* CallFunc_GetPlayerController_ReturnValue, class AValPlayerController* K2Node_DynamicCast_AsVal_Player_Controller, bool K2Node_DynamicCast_bSuccess, class AValCharacter* CallFunc_GetValCharacter_ReturnValue, bool CallFunc_EqualEqual_ObjectObject_ReturnValue, bool CallFunc_IsLocallyViewed_ReturnValue)
{
	...
	Params::AGC_Turret_Detection_C_WhileActive_Params Parms{};
...
bool AGC_Turret_Detection_C::OnRemove(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters)
{
	static class UFunction* Func = nullptr;
	...
	Params::AGC_Turret_Detection_C_OnRemove_Params Parms{};
...
void AGC_Turret_Detection_C::ReceiveTick(float DeltaSeconds)
{
	...
	Params::AGC_Turret_Detection_C_ReceiveTick_Params Parms{};
...
void AGC_Turret_Detection_C::ExecuteUbergraph_GC_Turret_Detection(int32 EntryPoint, float K2Node_Event_DeltaSeconds)
{
	static class UFunction* Func = nullptr;
	...
	Params::AGC_Turret_Detection_C_ExecuteUbergraph_GC_Turret_Detection_Params Parms{};
