...
struct ResonanceAudio_ResonanceAudioReverbPluginSettings
{
public:
	...
	uint8                                        Pad_1A26[0x6];                                     // Fixing Size After Last Property  
	struct CoreUObject_Vector                    RoomPosition;                                      // 0x8(0x18)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Quat                      RoomRotation;                                      // 0x20(0x20)(Edit, BlueprintVisible, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    RoomDimensions;                                    // 0x40(0x18)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1A33[0x2];                                     // Fixing Size After Last Property  
