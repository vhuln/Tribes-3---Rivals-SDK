...
// struct GameplayTags_GameplayTag    RequiredState                                                    (Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool UGameFrameworkComponentManager::RegisterAndCallForClassInitState(TSoftClassPtr<class AActor> ActorClass, class FName FeatureName, const struct GameplayTags_GameplayTag& RequiredState, FDelegateProperty_ Delegate, bool bCallImmediately)
{
	static class UFunction* Func = nullptr;
...
bool UGameFrameworkComponentManager::RegisterAndCallForActorInitState(class AActor* Actor, class FName FeatureName, const struct GameplayTags_GameplayTag& RequiredState, FDelegateProperty_ Delegate, bool bCallImmediately)
{
	static class UFunction* Func = nullptr;
...
bool IGameFrameworkInitStateInterface::RegisterAndCallForInitStateChange(const struct GameplayTags_GameplayTag& RequiredState, FDelegateProperty_ Delegate, bool bCallImmediately)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct GameplayTags_GameplayTag    DesiredState                                                     (Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool IGameFrameworkInitStateInterface::HasReachedInitState(const struct GameplayTags_GameplayTag& DesiredState)
{
	static class UFunction* Func = nullptr;
...
struct GameplayTags_GameplayTag IGameFrameworkInitStateInterface::GetInitState()
{
	static class UFunction* Func = nullptr;
