...
class UClass* AGC_DamageBuff_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_DamageBuff_C");

	return Clss;
}


// GC_DamageBuff_C GC_DamageBuff.Default__GC_DamageBuff_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_DamageBuff_C* AGC_DamageBuff_C::GetDefaultObj()
{
	static class AGC_DamageBuff_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_DamageBuff_C*>(AGC_DamageBuff_C::StaticClass()->DefaultObject);
...
bool AGC_DamageBuff_C::OnActive(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters, class ABP_CharPlayer_C* K2Node_DynamicCast_AsBP_Char_Player, bool K2Node_DynamicCast_bSuccess, class AValCharacter* K2Node_DynamicCast_AsVal_Character, bool K2Node_DynamicCast_bSuccess_1, class USkeletalMeshComponent* CallFunc_GetGunMesh1P_ReturnValue, class USkeletalMeshComponent* CallFunc_GetVFXFP_Gun_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class UNiagaraComponent* CallFunc_Create_1P3P_VFX_Active_1PVFX, class UNiagaraSystem* CallFunc_Create_1P3P_VFX_1P_System_Ref, class UNiagaraComponent* CallFunc_Create_1P3P_VFX_Active_3PVFX, class UNiagaraSystem* CallFunc_Create_1P3P_VFX_3P_System_Ref)
{
	...
	Params::AGC_DamageBuff_C_OnActive_Params Parms{};
...
void AGC_DamageBuff_C::UpdateTeamColor(class AActor* Instigator, class AController* CallFunc_GetController_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, class APlayerController* CallFunc_GetPlayerController_ReturnValue, bool CallFunc_IsEnemyWith_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::AGC_DamageBuff_C_UpdateTeamColor_Params Parms{};
...
void AGC_DamageBuff_C::Update_VFX(class UNiagaraComponent* CallFunc_Update_1P3P_VFX_Active_1P, class UNiagaraComponent* CallFunc_Update_1P3P_VFX_Active_3P)
{
	static class UFunction* Func = nullptr;
	...
	Params::AGC_DamageBuff_C_Update_VFX_Params Parms{};
...
bool AGC_DamageBuff_C::OnRemove(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class USkeletalMeshComponent* CallFunc_GetVFXFP_Gun_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::AGC_DamageBuff_C_OnRemove_Params Parms{};
