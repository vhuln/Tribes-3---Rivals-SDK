...
struct InterchangeNodes_InterchangeAnimationPayLoadKey
{
public:
	...
	uint8                                        Pad_3BE2[0x7];                                     // Fixing Size Of Struct 
};

// 0x18 (0x18 - 0x0)
// ScriptStruct InterchangeNodes.InterchangeMeshPayLoadKey
struct InterchangeNodes_InterchangeMeshPayLoadKey
{
public:
	class FString                                UniqueID;                                          // 0x0(0x10)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_3BF8[0x7];                                     // Fixing Size Of Struct 
};
