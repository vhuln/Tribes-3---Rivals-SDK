...
struct AGC_MortarTargeter_C_WhileActive_Params
{
public:
	...
	uint8                                        Pad_10D0[0x7];                                     // Fixing Size After Last Property  
	...
	double                                       CallFunc_ActiveMortarTargeter_Lifetime_ImplicitCast; // 0x1E0(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};

// 0x11 (0x11 - 0x0)
// Function GC_MortarTargeter.GC_MortarTargeter_C.DisableMortarTargeter
struct AGC_MortarTargeter_C_DisableMortarTargeter_Params
{
public:
...
struct AGC_MortarTargeter_C_ActiveMortarTargeter_Params
{
public:
	class AActor*                                Target;                                            // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	class ABP_CharPlayer_C*                      K2Node_DynamicCast_AsBP_Char_Player;               // 0x18(0x8)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
struct AGC_MortarTargeter_C_OnRemove_Params
{
public:
	class AActor*                                MyTarget;                                          // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	struct GameplayAbilities_GameplayCueParameters Parameters;                                        // 0x8(0xD8)(ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
struct AGC_MortarTargeter_C_ExecuteUbergraph_GC_MortarTargeter_Params
{
public:
