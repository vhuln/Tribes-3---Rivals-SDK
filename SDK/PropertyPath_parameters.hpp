...
{
public:
	struct PropertyPath_PropertyPathTestStruct   InStruct;                                          // 0x0(0x50)(Parm, NativeAccessSpecifierPublic)
};
...
{
public:
	struct PropertyPath_PropertyPathTestStruct   ReturnValue;                                       // 0x0(0x50)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
{
public:
	struct PropertyPath_PropertyPathTestStruct   ReturnValue;                                       // 0x0(0x50)(ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, NativeAccessSpecifierPublic)
};
