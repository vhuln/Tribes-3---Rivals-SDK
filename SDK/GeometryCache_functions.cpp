...
// Parameters:
// struct CoreUObject_LinearColor     Color                                                            (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UGeometryCacheComponent::SetWireframeOverrideColor(const struct CoreUObject_LinearColor& Color)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_LinearColor UGeometryCacheComponent::GetWireframeOverrideColor()
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct GeometryCache_GeometryCacheMeshDataMeshData                                                         (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
void UGeometryCacheTrack_FlipbookAnimation::AddMeshSample(struct GeometryCache_GeometryCacheMeshData& MeshData, float SampleTime)
{
	static class UFunction* Func = nullptr;
...
// (Final, Native, Public, HasOutParams)
// Parameters:
// struct GeometryCache_GeometryCacheMeshDataNewMeshData                                                      (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void UGeometryCacheTrack_TransformAnimation::SetMesh(struct GeometryCache_GeometryCacheMeshData& NewMeshData)
{
	static class UFunction* Func = nullptr;
...
void UGeometryCacheTrack_TransformGroupAnimation::SetMesh(struct GeometryCache_GeometryCacheMeshData& NewMeshData)
{
	static class UFunction* Func = nullptr;
