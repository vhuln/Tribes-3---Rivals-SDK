...
class ABP_BoostItem_Dungeon_C : public AValPickup_Upgrade
{
public:
	...
	uint8                                        Pad_3974[0x7];                                     // Fixing Size After Last Property  
	...
	static class ABP_BoostItem_Dungeon_C* GetDefaultObj();
