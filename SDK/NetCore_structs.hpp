...
struct NetCore_FastArraySerializerItem
{
public:
...
struct NetCore_FastArraySerializer
{
public:
	uint8                                        Pad_36A[0x54];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_36F[0xA8];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_371[0x7];                                      // Fixing Size Of Struct 
};

// 0xC (0xC - 0x0)
// ScriptStruct NetCore.NetAnalyticsDataConfig
struct NetCore_NetAnalyticsDataConfig
{
public:
	...
	uint8                                        Pad_37B[0x3];                                      // Fixing Size Of Struct 
};

// 0x18 (0x18 - 0x0)
// ScriptStruct NetCore.StateStruct
struct NetCore_StateStruct
{
public:
	uint8                                        Pad_37F[0x8];                                      // Fixing Size After Last Property  
...
struct NetCore_EscalationState : public NetCore_StateStruct
{
public:
	...
	uint8                                        Pad_38C[0x1];                                      // Fixing Size After Last Property  
...
struct NetCore_NetFaultState : public NetCore_EscalationState
{
public:
	...
	uint8                                        Pad_3A6[0x1];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_3AE[0x1];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_3B4[0x6];                                      // Fixing Size Of Struct 
};
