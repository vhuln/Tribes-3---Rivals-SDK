...
public:
	...
	struct CoreUObject_Vector                    RelativeLocation;                                  // 0x8(0x18)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct CoreUObject_Vector                    LocalForce;                                        // 0x28(0x18)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    CenterLocation;                                    // 0x40(0x18)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_16FC[0x8];                                     // Fixing Size After Last Property  
	struct CoreUObject_Quat                      SocketRotation;                                    // 0x60(0x20)(BlueprintVisible, BlueprintReadOnly, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    Offset;                                            // 0x80(0x18)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	struct CoreUObject_Vector                    WaterPlaneLocation;                                // 0xA8(0x18)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    WaterPlaneNormal;                                  // 0xC0(0x18)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    WaterSurfacePosition;                              // 0xD8(0x18)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    WaterVelocity;                                     // 0xF0(0x18)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_171A[0x1AB];                                   // Fixing Size After Last Property  
	...
	uint8                                        Pad_171C[0x10];                                    // Fixing Size Of Struct 
};

// 0x90 (0x90 - 0x0)
// ScriptStruct Water.BuoyancyData
struct Water_BuoyancyData
{
public:
	TArray<struct Water_SphericalPontoon>        Pontoons;                                          // 0x0(0x10)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, ContainsInstancedReference, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1743[0x3];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_1749[0x3];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_175A[0x5];                                     // Fixing Size After Last Property  
	struct CoreUObject_Vector                    DownstreamAxisOfRotation;                          // 0x68(0x18)(Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct Water_WaterBodyStaticMeshSettings
{
public:
...
struct Water_WaterBodyWeightmapSettings
{
public:
...
struct Water_WaterCurveSettings
{
public:
	...
	uint8                                        Pad_1774[0x4];                                     // Fixing Size Of Struct 
};

// 0x48 (0x48 - 0x0)
// ScriptStruct Water.GerstnerWave
struct Water_GerstnerWave
{
public:
	...
	struct CoreUObject_Vector                    Direction;                                         // 0x10(0x18)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector2D                  WaveVector;                                        // 0x28(0x10)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct Water_GerstnerWaveOctave
{
public:
	...
	uint8                                        Pad_1788[0x3];                                     // Fixing Size Of Struct 
};

// 0x700 (0x700 - 0x0)
// ScriptStruct Water.UnderwaterPostProcessSettings
struct Water_UnderwaterPostProcessSettings
{
public:
	...
	uint8                                        Pad_1791[0x3];                                     // Fixing Size After Last Property  
	...
	struct Engine_PostProcessSettings            PostProcessSettings;                               // 0x10(0x6E0)(Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1796[0x8];                                     // Fixing Size Of Struct 
};

// 0x14 (0x14 - 0x0)
// ScriptStruct Water.WaterFalloffSettings
struct Water_WaterFalloffSettings
{
public:
	...
	uint8                                        Pad_17A4[0x3];                                     // Fixing Size After Last Property  
...
struct Water_WaterBrushEffectBlurring
{
public:
	...
	uint8                                        Pad_17AA[0x3];                                     // Fixing Size After Last Property  
...
struct Water_WaterBrushEffectCurlNoise
{
public:
...
struct Water_WaterBrushEffectDisplacement
{
public:
...
struct Water_WaterBrushEffectSmoothBlending
{
public:
...
struct Water_WaterBrushEffectTerracing
{
public:
...
struct Water_WaterBrushEffects
{
public:
	struct Water_WaterBrushEffectBlurring        Blurring;                                          // 0x0(0x8)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct Water_WaterBrushEffectCurlNoise       CurlNoise;                                         // 0x8(0x10)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct Water_WaterBrushEffectDisplacement    Displacement;                                      // 0x18(0x28)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct Water_WaterBrushEffectSmoothBlending  SmoothBlending;                                    // 0x40(0x8)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct Water_WaterBrushEffectTerracing       Terracing;                                         // 0x48(0x14)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_17DD[0x4];                                     // Fixing Size Of Struct 
};

// 0x80 (0x80 - 0x0)
// ScriptStruct Water.WaterBodyHeightmapSettings
struct Water_WaterBodyHeightmapSettings
{
public:
	...
	struct Water_WaterFalloffSettings            FalloffSettings;                                   // 0x4(0x14)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct Water_WaterBrushEffects               Effects;                                           // 0x18(0x60)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_17E9[0x4];                                     // Fixing Size Of Struct 
};

// 0x20 (0x20 - 0x0)
// ScriptStruct Water.WaterBrushEffectCurves
struct Water_WaterBrushEffectCurves
{
public:
	bool                                         bUseCurveChannel;                                  // 0x0(0x1)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_17F1[0x7];                                     // Fixing Size After Last Property  
	class UCurveFloat*                           ElevationCurveAsset;                               // 0x8(0x8)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        ChannelEdgeOffset;                                 // 0x10(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        ChannelDepth;                                      // 0x14(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                        CurveRampWidth;                                    // 0x18(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_17FA[0x4];                                     // Fixing Size Of Struct 
};

// 0x10 (0x10 - 0x0)
// ScriptStruct Water.WaterSplineCurveDefaults
struct Water_WaterSplineCurveDefaults
{
public:
