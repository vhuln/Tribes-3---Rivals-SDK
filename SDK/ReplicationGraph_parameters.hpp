...
public:
	...
	uint8                                        Pad_1217[0x4];                                     // Fixing Size Of Struct 
};
...
public:
	...
	uint8                                        Pad_1240[0x4];                                     // Fixing Size Of Struct 
};
...
{
public:
	struct CoreUObject_Vector                    CellLocation;                                      // 0x0(0x18)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    CellExtent;                                        // 0x18(0x18)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
