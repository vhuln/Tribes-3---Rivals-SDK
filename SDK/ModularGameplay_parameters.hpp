...
public:
	...
	uint8                                        Pad_375[0x7];                                      // Fixing Size Of Struct 
};
...
public:
	...
	struct GameplayTags_GameplayTag              RequiredState;                                     // 0x30(0x8)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_403[0x6];                                      // Fixing Size Of Struct 
};
...
public:
	...
	struct GameplayTags_GameplayTag              RequiredState;                                     // 0x10(0x8)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_440[0x6];                                      // Fixing Size Of Struct 
};
...
public:
	...
	uint8                                        Pad_4B7[0x3];                                      // Fixing Size Of Struct 
};
...
{
public:
	struct GameplayTags_GameplayTag              RequiredState;                                     // 0x0(0x8)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_4F0[0x2];                                      // Fixing Size Of Struct 
};
...
{
public:
	struct GameplayTags_GameplayTag              DesiredState;                                      // 0x0(0x8)(Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
