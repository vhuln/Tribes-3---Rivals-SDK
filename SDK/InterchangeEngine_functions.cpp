...
// struct InterchangeEngine_InterchangeFilePickerParametersParameters                                                       (Parm, OutParm, NativeAccessSpecifierPublic)
// TArray<class FString>              OutFilenames                                                     (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UInterchangeFilePickerBase::ScriptedFilePickerForTranslatorType(enum class EInterchangeTranslatorType TranslatorType, struct InterchangeEngine_InterchangeFilePickerParameters* Parameters, TArray<class FString>* OutFilenames)
{
...
bool UInterchangeFilePickerBase::ScriptedFilePickerForTranslatorAssetType(enum class EInterchangeTranslatorAssetType TranslatorAssetType, struct InterchangeEngine_InterchangeFilePickerParameters* Parameters, TArray<class FString>* OutFilenames)
{
	static class UFunction* Func = nullptr;
...
// (RequiredAPI, Native, Event, Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// TArray<struct InterchangeEngine_InterchangeStackInfo>PipelineStacks                                                   (Parm, OutParm, ZeroConstructor, NativeAccessSpecifierPublic)
...
enum class EInterchangePipelineConfigurationDialogResult UInterchangePipelineConfigurationBase::ScriptedShowScenePipelineConfigurationDialog(TArray<struct InterchangeEngine_InterchangeStackInfo>* PipelineStacks, TArray<class UInterchangePipelineBase*>* OutPipelines, class UInterchangeSourceData* SourceData)
{
	static class UFunction* Func = nullptr;
...
enum class EInterchangePipelineConfigurationDialogResult UInterchangePipelineConfigurationBase::ScriptedShowReimportPipelineConfigurationDialog(TArray<struct InterchangeEngine_InterchangeStackInfo>* PipelineStacks, TArray<class UInterchangePipelineBase*>* OutPipelines, class UInterchangeSourceData* SourceData)
{
	static class UFunction* Func = nullptr;
...
enum class EInterchangePipelineConfigurationDialogResult UInterchangePipelineConfigurationBase::ScriptedShowPipelineConfigurationDialog(TArray<struct InterchangeEngine_InterchangeStackInfo>* PipelineStacks, TArray<class UInterchangePipelineBase*>* OutPipelines, class UInterchangeSourceData* SourceData)
{
	static class UFunction* Func = nullptr;
...
// struct InterchangeEngine_ImportAssetParametersImportAssetParameters                                            (ConstParm, Parm, OutParm, ReferenceParm, ContainsInstancedReference, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UInterchangeManager::ImportScene(const class FString& ContentPath, class UInterchangeSourceData* SourceData, struct InterchangeEngine_ImportAssetParameters& ImportAssetParameters)
{
	static class UFunction* Func = nullptr;
...
bool UInterchangeManager::ImportAsset(const class FString& ContentPath, class UInterchangeSourceData* SourceData, struct InterchangeEngine_ImportAssetParameters& ImportAssetParameters)
{
	static class UFunction* Func = nullptr;
