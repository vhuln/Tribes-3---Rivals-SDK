...
public:
	...
	uint8                                        Pad_25B[0x4];                                      // Fixing Size After Last Property  
	TArray<struct EngineSettings_AutoCompleteCommand> ManualAutoCompleteList;                            // 0x30(0x10)(Edit, ZeroConstructor, Config, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_25D[0x2];                                      // Fixing Size After Last Property  
	struct CoreUObject_Color                     InputColor;                                        // 0x58(0x4)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Color                     HistoryColor;                                      // 0x5C(0x4)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Color                     AutoCompleteCommandColor;                          // 0x60(0x4)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Color                     AutoCompleteCVarColor;                             // 0x64(0x4)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Color                     AutoCompleteFadedColor;                            // 0x68(0x4)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_265[0x4];                                      // Fixing Size Of Struct 
...
public:
	...
	struct CoreUObject_SoftObjectPath            TransitionMap;                                     // 0x38(0x20)(Edit, ZeroConstructor, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_288[0x3];                                      // Fixing Size After Last Property  
	struct CoreUObject_SoftClassPath             GameInstanceClass;                                 // 0x60(0x20)(Edit, ZeroConstructor, Config, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_SoftObjectPath            GameDefaultMap;                                    // 0x80(0x20)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct CoreUObject_SoftObjectPath            ServerDefaultMap;                                  // 0xA0(0x20)(Edit, ZeroConstructor, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct CoreUObject_SoftClassPath             GlobalDefaultGameMode;                             // 0xC0(0x20)(Edit, ZeroConstructor, Config, NoClear, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	struct CoreUObject_SoftClassPath             GlobalDefaultServerGameMode;                       // 0xE0(0x20)(Edit, ZeroConstructor, Config, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
	TArray<struct EngineSettings_GameModeName>   GameModeMapPrefixes;                               // 0x100(0x10)(Edit, ZeroConstructor, Config, AdvancedDisplay, NativeAccessSpecifierPrivate)
	TArray<struct EngineSettings_GameModeName>   GameModeClassAliases;                              // 0x110(0x10)(Edit, ZeroConstructor, Config, AdvancedDisplay, NativeAccessSpecifierPrivate)
...
public:
	...
	uint8                                        BitPad_C : 7;                                      // Fixing Bit-Field Size  
	uint8                                        Pad_29A[0x3];                                      // Fixing Size After Last Property  
	...
	uint8                                        Pad_2A1[0x4];                                      // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_2AB[0x7];                                      // Fixing Size Of Struct 
...
public:
	...
	struct CoreUObject_Guid                      ProjectID;                                         // 0x98(0x10)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_2CD[0x1];                                      // Fixing Size After Last Property  
...
public:
	...
	uint8                                        Pad_2D5[0x7];                                      // Fixing Size After Last Property  
