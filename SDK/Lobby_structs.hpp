...
struct Lobby_LobbyPlayerStateActorInfo : public NetCore_FastArraySerializerItem
{
public:
...
struct Lobby_LobbyPlayerStateInfoArray : public NetCore_FastArraySerializer
{
public:
	TArray<struct Lobby_LobbyPlayerStateActorInfo> Players;                                           // 0x108(0x10)(ZeroConstructor, NativeAccessSpecifierPrivate)
