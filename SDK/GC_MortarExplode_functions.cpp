...
// BlueprintGeneratedClass GC_MortarExplode.GC_MortarExplode_C
// (Actor)

class UClass* AGC_MortarExplode_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_MortarExplode_C");

	return Clss;
}


// GC_MortarExplode_C GC_MortarExplode.Default__GC_MortarExplode_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_MortarExplode_C* AGC_MortarExplode_C::GetDefaultObj()
{
	static class AGC_MortarExplode_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_MortarExplode_C*>(AGC_MortarExplode_C::StaticClass()->DefaultObject);

	return Default;
}


// Function GC_MortarExplode.GC_MortarExplode_C.OnRemove
...
// Function GC_MortarExplode.GC_MortarExplode_C.PlayFX
...
void AGC_MortarExplode_C::PlayFX(double ExplosionRadius, const struct CoreUObject_Vector& Location, class AValCharacter* ValChar, class UNiagaraComponent* CallFunc_SpawnSystemAtLocation_ReturnValue, float CallFunc_SetVariableFloat_InValue_ImplicitCast)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GC_MortarExplode_C", "PlayFX");

	Params::AGC_MortarExplode_C_PlayFX_Params Parms{};
...
// Function GC_MortarExplode.GC_MortarExplode_C.WhileActive
// (Event, Public, HasOutParams, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// class AActor*                      MyTarget                                                         (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
// struct GameplayAbilities_GameplayCueParametersParameters                                                       (ConstParm, BlueprintVisible, BlueprintReadOnly, Parm, OutParm, ReferenceParm, ContainsInstancedReference)
...
bool AGC_MortarExplode_C::WhileActive(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters, const struct CoreUObject_Vector& Location, double Magnitude, float CallFunc_BreakGameplayCueParameters_NormalizedMagnitude, float CallFunc_BreakGameplayCueParameters_RawMagnitude, const struct GameplayAbilities_GameplayEffectContextHandle& CallFunc_BreakGameplayCueParameters_EffectContext, const struct GameplayTags_GameplayTag& CallFunc_BreakGameplayCueParameters_MatchedTagName, const struct GameplayTags_GameplayTag& CallFunc_BreakGameplayCueParameters_OriginalTag, const struct GameplayTags_GameplayTagContainer& CallFunc_BreakGameplayCueParameters_AggregatedSourceTags, const struct GameplayTags_GameplayTagContainer& CallFunc_BreakGameplayCueParameters_AggregatedTargetTags, const struct CoreUObject_Vector& CallFunc_BreakGameplayCueParameters_Location, const struct CoreUObject_Vector& CallFunc_BreakGameplayCueParameters_Normal, class AActor* CallFunc_BreakGameplayCueParameters_Instigator, class AActor* CallFunc_BreakGameplayCueParameters_EffectCauser, class UObject* CallFunc_BreakGameplayCueParameters_SourceObject, class UPhysicalMaterial* CallFunc_BreakGameplayCueParameters_PhysicalMaterial, int32 CallFunc_BreakGameplayCueParameters_GameplayEffectLevel, int32 CallFunc_BreakGameplayCueParameters_AbilityLevel, class USceneComponent* CallFunc_BreakGameplayCueParameters_TargetAttachComponent, bool CallFunc_BreakGameplayCueParameters_bReplicateLocationWhenUsingMinimalRepProxy, double K2Node_VariableSet_Magnitude_ImplicitCast)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GC_MortarExplode_C", "WhileActive");

	Params::AGC_MortarExplode_C_WhileActive_Params Parms{};
...
// Function GC_MortarExplode.GC_MortarExplode_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void AGC_MortarExplode_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GC_MortarExplode_C", "ReceiveBeginPlay");
...
// Function GC_MortarExplode.GC_MortarExplode_C.ExecuteUbergraph_GC_MortarExplode
// (Final, UbergraphFunction)
// Parameters:
// int32                              EntryPoint                                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void AGC_MortarExplode_C::ExecuteUbergraph_GC_MortarExplode(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("GC_MortarExplode_C", "ExecuteUbergraph_GC_MortarExplode");

	Params::AGC_MortarExplode_C_ExecuteUbergraph_GC_MortarExplode_Params Parms{};
