...
void UUDS_PlayerOcclusion_C::Get_Occlusion_Location(class APlayerCameraManager* CallFunc_GetPlayerCameraManager_ReturnValue, bool CallFunc_IsValid_ReturnValue, const struct CoreUObject_Vector& CallFunc_GetCameraLocation_ReturnValue)
{
...
// struct Engine_TimerHandle          CallFunc_K2_SetTimerForNextTick_ReturnValue                      (NoDestructor, HasGetValueTypeHash)
...
void UUDS_PlayerOcclusion_C::Get_Starting_Occlusion_Profile(const struct Engine_TimerHandle& CallFunc_K2_SetTimer_ReturnValue, const struct Engine_TimerHandle& CallFunc_K2_SetTimerForNextTick_ReturnValue, bool CallFunc_EqualEqual_VectorVector_ReturnValue, float CallFunc_K2_SetTimer_Time_ImplicitCast)
{
	static class UFunction* Func = nullptr;
...
void UUDS_PlayerOcclusion_C::Initialize(const struct Engine_TimerHandle& CallFunc_K2_SetTimerForNextTick_ReturnValue)
{
	static class UFunction* Func = nullptr;
...
// TArray<struct CoreUObject_Vector>  K2Node_MakeArray_Array_1                                         (ReferenceParm)
// struct CoreUObject_Vector          CallFunc_Array_Get_Item                                          (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// struct CoreUObject_Vector          CallFunc_Multiply_VectorFloat_ReturnValue_3                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// TArray<struct CoreUObject_Vector>  K2Node_MakeArray_Array_2                                         (ReferenceParm)
// int32                              CallFunc_Array_Length_ReturnValue                                (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct CoreUObject_Vector          CallFunc_Array_Get_Item_2                                        (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// bool                               CallFunc_Less_IntInt_ReturnValue                                 (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// struct CoreUObject_Vector          CallFunc_Normal_ReturnValue_2                                    (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct CoreUObject_Vector          CallFunc_Multiply_VectorFloat_ReturnValue_4                      (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
void UUDS_PlayerOcclusion_C::Update_Target_Occlusion_Profile(const TArray<class AActor*>& Actors_to_Ignore, int32 Directional_Hits, double Distance_Occluded, double Total_Occlusion, int32 Total_Hits, bool Overhead_Blocked, const TArray<double>& New_Occlusion_Profile, double Temp_real_Variable, int32 Temp_int_Variable, double CallFunc_Multiply_IntFloat_ReturnValue, double CallFunc_Add_DoubleDouble_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue, const struct CoreUObject_Vector& CallFunc_MakeVector_ReturnValue, int32 CallFunc_Add_IntInt_ReturnValue, int32 Temp_int_Variable_1, double CallFunc_Multiply_IntFloat_ReturnValue_1, bool CallFunc_LessEqual_IntInt_ReturnValue_1, int32 CallFunc_Add_IntInt_ReturnValue_1, int32 Temp_int_Variable_2, int32 Temp_int_Variable_3, bool CallFunc_LessEqual_IntInt_ReturnValue_2, int32 CallFunc_Add_IntInt_ReturnValue_2, int32 Temp_int_Loop_Counter_Variable, int32 CallFunc_Add_IntInt_ReturnValue_3, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Variable_4, TArray<double>& K2Node_MakeArray_Array, double CallFunc_BreakVector_X, double CallFunc_BreakVector_Y, double CallFunc_BreakVector_Z, bool CallFunc_Less_DoubleDouble_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, bool CallFunc_BooleanAND_ReturnValue, bool CallFunc_BooleanOR_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue_1, int32 CallFunc_Array_Add_ReturnValue, const struct CoreUObject_Vector& CallFunc_Multiply_VectorFloat_ReturnValue, class APawn* CallFunc_GetPlayerPawn_ReturnValue, const struct CoreUObject_Vector& CallFunc_Normal_ReturnValue, bool CallFunc_IsValid_ReturnValue, const struct CoreUObject_Vector& CallFunc_Multiply_VectorFloat_ReturnValue_1, const struct CoreUObject_Vector& CallFunc_Add_VectorVector_ReturnValue, const struct Engine_HitResult& CallFunc_LineTraceSingle_OutHit, bool CallFunc_LineTraceSingle_ReturnValue, double CallFunc_SelectFloat_ReturnValue, int32 CallFunc_Array_Add_ReturnValue_1, double CallFunc_Multiply_DoubleDouble_ReturnValue_2, double CallFunc_Lerp_ReturnValue, int32 CallFunc_Array_Add_ReturnValue_2, int32 CallFunc_Add_IntInt_ReturnValue_4, double CallFunc_Conv_IntToDouble_ReturnValue, double CallFunc_MapRangeClamped_ReturnValue, double CallFunc_MapRangeClamped_ReturnValue_1, double CallFunc_Conv_IntToDouble_ReturnValue_1, double CallFunc_MapRangeClamped_ReturnValue_2, int32 CallFunc_Add_IntInt_ReturnValue_5, TArray<struct CoreUObject_Vector>& K2Node_MakeArray_Array_1, const struct CoreUObject_Vector& CallFunc_Array_Get_Item, int32 CallFunc_Add_IntInt_ReturnValue_6, const struct CoreUObject_Vector& CallFunc_Multiply_VectorFloat_ReturnValue_2, const struct CoreUObject_Vector& CallFunc_Add_VectorVector_ReturnValue_1, int32 Temp_int_Variable_5, const struct CoreUObject_Vector& CallFunc_Normal_ReturnValue_1, double CallFunc_Array_Get_Item_1, double CallFunc_Lerp_ReturnValue_1, bool CallFunc_LessEqual_IntInt_ReturnValue_3, double CallFunc_Multiply_DoubleDouble_ReturnValue_3, int32 CallFunc_Array_Add_ReturnValue_3, int32 CallFunc_Add_IntInt_ReturnValue_7, int32 Temp_int_Variable_6, int32 CallFunc_Array_Add_ReturnValue_4, const struct CoreUObject_Vector& CallFunc_Multiply_VectorFloat_ReturnValue_3, const struct CoreUObject_Vector& CallFunc_Add_VectorVector_ReturnValue_2, const struct Engine_HitResult& CallFunc_LineTraceSingle_OutHit_1, bool CallFunc_LineTraceSingle_ReturnValue_1, int32 CallFunc_Array_Add_ReturnValue_5, TArray<struct CoreUObject_Vector>& K2Node_MakeArray_Array_2, int32 CallFunc_Array_Length_ReturnValue, const struct CoreUObject_Vector& CallFunc_Array_Get_Item_2, bool CallFunc_Less_IntInt_ReturnValue, const struct CoreUObject_Vector& CallFunc_RotateAngleAxis_ReturnValue, const struct CoreUObject_Vector& CallFunc_Add_VectorVector_ReturnValue_3, const struct CoreUObject_Vector& CallFunc_Normal_ReturnValue_2, const struct CoreUObject_Vector& CallFunc_Multiply_VectorFloat_ReturnValue_4, const struct CoreUObject_Vector& CallFunc_Add_VectorVector_ReturnValue_4, const struct Engine_HitResult& CallFunc_LineTraceSingle_OutHit_2, bool CallFunc_LineTraceSingle_ReturnValue_2, float CallFunc_RotateAngleAxis_AngleDeg_ImplicitCast)
{
	static class UFunction* Func = nullptr;
...
// Function UDS_PlayerOcclusion.UDS_PlayerOcclusion_C.ReceiveBeginPlay
// (Event, Public, BlueprintEvent)
// Parameters:

void UUDS_PlayerOcclusion_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("UDS_PlayerOcclusion_C", "ReceiveBeginPlay");
...
void UUDS_PlayerOcclusion_C::ExecuteUbergraph_UDS_PlayerOcclusion(int32 EntryPoint, float K2Node_Event_DeltaSeconds, bool CallFunc_IsDedicatedServer_ReturnValue)
{
	static class UFunction* Func = nullptr;
