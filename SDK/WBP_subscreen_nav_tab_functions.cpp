...
class UClass* UWBP_subscreen_nav_tab_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("WBP_subscreen_nav_tab_C");

	return Clss;
}


// WBP_subscreen_nav_tab_C WBP_subscreen_nav_tab.Default__WBP_subscreen_nav_tab_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UWBP_subscreen_nav_tab_C* UWBP_subscreen_nav_tab_C::GetDefaultObj()
{
	static class UWBP_subscreen_nav_tab_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UWBP_subscreen_nav_tab_C*>(UWBP_subscreen_nav_tab_C::StaticClass()->DefaultObject);
...
void UWBP_subscreen_nav_tab_C::SetSelected(bool bNewSelected, float CallFunc_GetAnimationCurrentTime_ReturnValue, float CallFunc_GetEndTime_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue_1)
{
	...
	Params::UWBP_subscreen_nav_tab_C_SetSelected_Params Parms{};
...
void UWBP_subscreen_nav_tab_C::SetDisabled(bool bNewDisabled, enum class ESlateVisibility Temp_byte_Variable, bool Temp_bool_Variable, double Temp_real_Variable, double Temp_real_Variable_1, bool Temp_bool_Variable_1, double K2Node_Select_Default, enum class ESlateVisibility Temp_byte_Variable_1, enum class ESlateVisibility Temp_byte_Variable_2, enum class ESlateVisibility Temp_byte_Variable_3, enum class ESlateVisibility K2Node_Select_Default_1, bool Temp_bool_Variable_2, enum class ESlateVisibility K2Node_Select_Default_2, float CallFunc_SetRenderOpacity_InOpacity_ImplicitCast)
{
	...
	Params::UWBP_subscreen_nav_tab_C_SetDisabled_Params Parms{};
...
void UWBP_subscreen_nav_tab_C::TryCreateCalloutWidget(bool* Created, class URHWidget* K2Node_DynamicCast_AsRHWidget, bool K2Node_DynamicCast_bSuccess, class UClass* CallFunc_LoadClassAsset_Blocking_ReturnValue, class UClass* K2Node_ClassDynamicCast_AsUser_Widget, bool K2Node_ClassDynamicCast_bSuccess, bool CallFunc_IsValidSoftClassReference_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UUserWidget* CallFunc_Create_ReturnValue, bool CallFunc_IsValid_ReturnValue, class UPanelSlot* CallFunc_AddChild_ReturnValue, class UOverlaySlot* K2Node_DynamicCast_AsOverlay_Slot, bool K2Node_DynamicCast_bSuccess_1)
{
	...
	Params::UWBP_subscreen_nav_tab_C_TryCreateCalloutWidget_Params Parms{};
...
void UWBP_subscreen_nav_tab_C::SetShowCallout(bool Show, bool Temp_bool_Variable, enum class ESlateVisibility Temp_byte_Variable, enum class ESlateVisibility Temp_byte_Variable_1, bool CallFunc_TryCreateCalloutWidget_Created, bool CallFunc_IsValid_ReturnValue, enum class ESlateVisibility K2Node_Select_Default)
{
	static class UFunction* Func = nullptr;
	...
	Params::UWBP_subscreen_nav_tab_C_SetShowCallout_Params Parms{};
...
void UWBP_subscreen_nav_tab_C::SetButtonText(class FText ButtonText)
{
	static class UFunction* Func = nullptr;
	...
	Params::UWBP_subscreen_nav_tab_C_SetButtonText_Params Parms{};
...
void UWBP_subscreen_nav_tab_C::PreConstruct(bool IsDesignTime)
{
	...
	Params::UWBP_subscreen_nav_tab_C_PreConstruct_Params Parms{};
...
void UWBP_subscreen_nav_tab_C::Handle_View_State_Changed(class FName CurrentRoute, class FName PreviousRoute, enum class EViewManagerLayer Layer)
{
	static class UFunction* Func = nullptr;
	...
	Params::UWBP_subscreen_nav_tab_C_Handle_View_State_Changed_Params Parms{};
...
void UWBP_subscreen_nav_tab_C::ExecuteUbergraph_WBP_subscreen_nav_tab(int32 EntryPoint, class FText K2Node_CustomEvent_ButtonText, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue, bool K2Node_Event_IsDesignTime, bool CallFunc_TryCreateCalloutWidget_Created, bool CallFunc_RemoveChild_ReturnValue, bool CallFunc_TryCreateCalloutWidget_Created_1, class UUMGSequencePlayer* CallFunc_PlayAnimation_ReturnValue_1, bool CallFunc_BooleanOR_ReturnValue, bool CallFunc_BooleanOR_ReturnValue_1, bool CallFunc_TextIsEmpty_ReturnValue, class URHViewManager* CallFunc_GetViewManager_ReturnValue, FDelegateProperty_ K2Node_CreateDelegate_OutputDelegate, class FName K2Node_CustomEvent_CurrentRoute, class FName K2Node_CustomEvent_PreviousRoute, enum class EViewManagerLayer K2Node_CustomEvent_Layer)
{
	...
	Params::UWBP_subscreen_nav_tab_C_ExecuteUbergraph_WBP_subscreen_nav_tab_Params Parms{};
