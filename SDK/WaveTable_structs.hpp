...
struct WaveTable_WaveTableData
{
public:
...
struct WaveTable_WaveTableTransform
{
public:
	...
	struct Engine_RichCurve                      CurveCustom;                                       // 0x8(0x80)(NativeAccessSpecifierPublic)
	...
	struct WaveTable_WaveTableData               TableData;                                         // 0x90(0x20)(Protected, NativeAccessSpecifierProtected)
...
struct WaveTable_WaveTableBankEntry
{
public:
	struct WaveTable_WaveTableTransform          Transform;                                         // 0x0(0xB8)(Edit, NativeAccessSpecifierPublic)
};

// 0x58 (0x58 - 0x0)
// ScriptStruct WaveTable.WaveTableSettings
struct WaveTable_WaveTableSettings
{
public:
	struct CoreUObject_FilePath                  FilePath;                                          // 0x0(0x10)(Edit, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_10C6[0x4];                                     // Fixing Size After Last Property  
	struct WaveTable_WaveTableData               SourceData;                                        // 0x18(0x20)(Edit, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_10DB[0x6];                                     // Fixing Size Of Struct 
};
