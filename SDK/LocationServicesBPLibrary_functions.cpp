...
// (Final, Native, Static, Public, BlueprintCallable)
// Parameters:
// struct LocationServicesBPLibrary_LocationServicesDataReturnValue                                                      (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)

struct LocationServicesBPLibrary_LocationServicesData ULocationServices::GetLastKnownLocation()
{
	static class UFunction* Func = nullptr;
