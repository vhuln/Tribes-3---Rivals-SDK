...
public:
	...
	TArray<struct ClothingSystemRuntimeCommon_ClothLODDataCommon> LODData;                                           // 0xA0(0x10)(ZeroConstructor, NativeAccessSpecifierPublic)
...
public:
	...
	struct ClothingSystemRuntimeCommon_ClothPhysicalMeshData ClothPhysicalMeshData;                             // 0x30(0xD8)(NativeAccessSpecifierPublic)
	struct ClothingSystemRuntimeInterface_ClothCollisionData CollisionData;                                     // 0x108(0x40)(NativeAccessSpecifierPublic)
	uint8                                        Pad_D8[0x20];                                      // Fixing Size Of Struct 
