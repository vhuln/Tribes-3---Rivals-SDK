...
struct SequencerScripting_SequencerScriptingRange
{
public:
	...
	uint8                                        BitPad_12B : 6;                                    // Fixing Bit-Field Size  
	uint8                                        Pad_473A[0x3];                                     // Fixing Size After Last Property  
	...
	struct CoreUObject_FrameRate                 InternalRate;                                      // 0xC(0x8)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
