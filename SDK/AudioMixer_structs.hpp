...
struct AudioMixer_AudioOutputDeviceInfo
{
public:
	...
	uint8                                        Pad_1FC8[0x7];                                     // Fixing Size After Last Property  
...
struct AudioMixer_SwapAudioOutputResult
{
public:
...
struct AudioMixer_SubmixEffectDynamicProcessorFilterSettings
{
public:
	...
	uint8                                        Pad_2100[0x3];                                     // Fixing Size After Last Property  
...
struct AudioMixer_SubmixEffectDynamicsProcessorSettings
{
public:
	...
	uint8                                        Pad_213A[0x1];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_217C[0x7];                                     // Fixing Size After Last Property  
	...
	uint8                                        BitPad_9F : 4;                                     // Fixing Bit-Field Size  
	...
	struct AudioMixer_SubmixEffectDynamicProcessorFilterSettings KeyHighshelf;                                      // 0x44(0xC)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	struct AudioMixer_SubmixEffectDynamicProcessorFilterSettings KeyLowshelf;                                       // 0x50(0xC)(Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                        Pad_21C4[0x4];                                     // Fixing Size Of Struct 
};

// 0x10 (0x10 - 0x0)
// ScriptStruct AudioMixer.SubmixEffectEQBand
struct AudioMixer_SubmixEffectEQBand
{
public:
...
struct AudioMixer_SubmixEffectSubmixEQSettings
{
public:
	TArray<struct AudioMixer_SubmixEffectEQBand> EQBands;                                           // 0x0(0x10)(Edit, BlueprintVisible, ZeroConstructor, NativeAccessSpecifierPublic)
};

// 0x40 (0x40 - 0x0)
// ScriptStruct AudioMixer.SubmixEffectReverbSettings
struct AudioMixer_SubmixEffectReverbSettings
{
public:
	...
	uint8                                        Pad_2256[0x3];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_22B6[0x3];                                     // Fixing Size Of Struct 
};
