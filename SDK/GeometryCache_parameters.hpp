...
public:
	...
	uint8                                        Pad_194D[0x1];                                     // Fixing Size Of Struct 
};
...
{
public:
	struct CoreUObject_LinearColor               Color;                                             // 0x0(0x10)(ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
...
public:
	...
	uint8                                        Pad_1B73[0x7];                                     // Fixing Size Of Struct 
};
...
{
public:
	struct GeometryCache_GeometryCacheMeshData   MeshData;                                          // 0x0(0xC8)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
{
public:
	struct GeometryCache_GeometryCacheMeshData   NewMeshData;                                       // 0x0(0xC8)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
};
