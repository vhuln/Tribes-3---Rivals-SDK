...
class UClass* AGC_Despawn_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("GC_Despawn_C");

	return Clss;
}


// GC_Despawn_C GC_Despawn.Default__GC_Despawn_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class AGC_Despawn_C* AGC_Despawn_C::GetDefaultObj()
{
	static class AGC_Despawn_C* Default = nullptr;

	if (!Default)
		Default = static_cast<AGC_Despawn_C*>(AGC_Despawn_C::StaticClass()->DefaultObject);
...
bool AGC_Despawn_C::WhileActive(class AActor* MyTarget, struct GameplayAbilities_GameplayCueParameters& Parameters, class AValCharacter* K2Node_DynamicCast_AsVal_Character, bool K2Node_DynamicCast_bSuccess, class USkeletalMeshComponent* CallFunc_GetMesh3P_ReturnValue, class UAnimInstance* CallFunc_GetAnimInstance_ReturnValue, class UValCharacterAnimInstance* K2Node_DynamicCast_AsVal_Character_Anim_Instance, bool K2Node_DynamicCast_bSuccess_1)
{
	...
	Params::AGC_Despawn_C_WhileActive_Params Parms{};
