...
class ABP_Pickup_ShieldPack_C : public ABP_Pickup_Master_C
{
public:
	uint8                                        Pad_311B[0x7];                                     // Fixing Size After Last Property  
	...
	static class ABP_Pickup_ShieldPack_C* GetDefaultObj();
