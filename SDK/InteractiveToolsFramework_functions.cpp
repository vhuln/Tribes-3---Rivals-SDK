...
void IGizmoTransformSource::SetTransform(struct CoreUObject_Transform& NewTransform)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Transform IGizmoTransformSource::GetTransform()
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct CoreUObject_Vector          TangentXOut                                                      (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector          TangentYOut                                                      (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void IGizmoAxisSource::GetTangentVectors(struct CoreUObject_Vector* TangentXOut, struct CoreUObject_Vector* TangentYOut)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector IGizmoAxisSource::GetOrigin()
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector IGizmoAxisSource::GetDirection()
{
	static class UFunction* Func = nullptr;
...
// (Native, Public, HasOutParams, HasDefaults)
// Parameters:
// struct CoreUObject_Vector2D        NewValue                                                         (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void IGizmoVec2ParameterSource::SetParameter(struct CoreUObject_Vector2D& NewValue)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D IGizmoVec2ParameterSource::GetParameter()
{
	static class UFunction* Func = nullptr;
