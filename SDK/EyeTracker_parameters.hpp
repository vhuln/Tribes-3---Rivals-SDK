...
{
public:
	struct EyeTracker_EyeTrackerStereoGazeData   OutGazeData;                                       // 0x0(0x80)(Parm, OutParm, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_28A[0x7];                                      // Fixing Size Of Struct 
};
...
{
public:
	struct EyeTracker_EyeTrackerGazeData         OutGazeData;                                       // 0x0(0x58)(Parm, OutParm, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_292[0x7];                                      // Fixing Size Of Struct 
};
