...
// struct ActorLayerUtilities_ActorLayerLayer                                                            (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void ULayersBlueprintLibrary::RemoveActorFromLayer(class AActor* InActor, struct ActorLayerUtilities_ActorLayer& Layer)
{
...
// struct ActorLayerUtilities_ActorLayerActorLayer                                                       (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// TArray<class AActor*>              ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, NativeAccessSpecifierPublic)

TArray<class AActor*> ULayersBlueprintLibrary::GetActors(class UObject* WorldContextObject, struct ActorLayerUtilities_ActorLayer& ActorLayer)
{
	static class UFunction* Func = nullptr;
...
void ULayersBlueprintLibrary::AddActorToLayer(class AActor* InActor, struct ActorLayerUtilities_ActorLayer& Layer)
{
	static class UFunction* Func = nullptr;
