...
public:
	...
	uint8                                        Pad_EC8[0x7];                                      // Fixing Size Of Struct 
};
...
public:
	...
	uint8                                        Pad_F23[0x4];                                      // Fixing Size After Last Property  
	struct Engine_PostProcessSettings            OutPPSettings;                                     // 0x10(0x6E0)(Parm, OutParm, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_F27[0xB];                                      // Fixing Size Of Struct 
};
...
public:
	class APlayerController*                     PlayerController;                                  // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_F2E[0x8];                                      // Fixing Size After Last Property  
	struct Engine_MinimalViewInfo                ReturnValue;                                       // 0x10(0x7C0)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
...
public:
	class APlayerController*                     PlayerController;                                  // 0x0(0x8)(Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                        Pad_F37[0x8];                                      // Fixing Size After Last Property  
	struct Engine_MinimalViewInfo                ReturnValue;                                       // 0x10(0x7C0)(Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)
};
