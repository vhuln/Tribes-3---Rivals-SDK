...
void UWidget::Show(bool Visible)
{
	...
	Params::UWidget_Show_Params Parms{};
...
void UWidget::SetRenderTranslation(const struct CoreUObject_Vector2D& Translation)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_Vector2D        Pivot                                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWidget::SetRenderTransformPivot(const struct CoreUObject_Vector2D& Pivot)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// struct UMG_WidgetTransform         InTransform                                                      (Parm, NoDestructor, NativeAccessSpecifierPublic)

void UWidget::SetRenderTransform(const struct UMG_WidgetTransform& InTransform)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_Vector2D        Shear                                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWidget::SetRenderShear(const struct CoreUObject_Vector2D& Shear)
{
	static class UFunction* Func = nullptr;
...
void UWidget::SetRenderScale(const struct CoreUObject_Vector2D& Scale)
{
	static class UFunction* Func = nullptr;
...
// (Public, Delegate)
// Parameters:
// struct UMG_EventReply              ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct UMG_EventReply UWidget::OnReply__DelegateSignature()
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct SlateCore_Geometry          MyGeometry                                                       (Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct SlateCore_PointerEvent      MouseEvent                                                       (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct UMG_EventReply              ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct UMG_EventReply UWidget::OnPointerEvent__DelegateSignature(const struct SlateCore_Geometry& MyGeometry, struct SlateCore_PointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// struct FieldNotification_FieldNotificationIdFieldId                                                          (Parm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// FDelegateProperty_                 Delegate                                                         (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWidget::K2_RemoveFieldValueChangedDelegate(const struct FieldNotification_FieldNotificationId& FieldId, FDelegateProperty_ Delegate)
{
	static class UFunction* Func = nullptr;
...
void UWidget::K2_BroadcastFieldValueChanged(const struct FieldNotification_FieldNotificationId& FieldId)
{
	static class UFunction* Func = nullptr;
...
void UWidget::K2_AddFieldValueChangedDelegate(const struct FieldNotification_FieldNotificationId& FieldId, FDelegateProperty_ Delegate)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// struct SlateCore_Geometry          ReturnValue                                                      (ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)

struct SlateCore_Geometry UWidget::GetTickSpaceGeometry()
{
	static class UFunction* Func = nullptr;
...
// (Public, Delegate)
// Parameters:
// struct SlateCore_SlateColor        ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct SlateCore_SlateColor UWidget::GetSlateColor__DelegateSignature()
{
	static class UFunction* Func = nullptr;
...
struct SlateCore_SlateBrush UWidget::GetSlateBrush__DelegateSignature()
{
	static class UFunction* Func = nullptr;
...
struct SlateCore_Geometry UWidget::GetPaintSpaceGeometry()
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_LinearColor UWidget::GetLinearColor__DelegateSignature()
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D UWidget::GetDesiredSize()
{
	static class UFunction* Func = nullptr;
...
struct SlateCore_Geometry UWidget::GetCachedGeometry()
{
	static class UFunction* Func = nullptr;
...
void UUserWidget::Tick(const struct SlateCore_Geometry& MyGeometry, float InDeltaTime)
{
	static class UFunction* Func = nullptr;
...
void UUserWidget::SetPositionInViewport(const struct CoreUObject_Vector2D& Position, bool bRemoveDPIScale)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, BlueprintCosmetic, Native, Public, BlueprintCallable)
// Parameters:
// struct SlateCore_Margin            InPadding                                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)

void UUserWidget::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, BlueprintCosmetic, Native, Public, BlueprintCallable)
// Parameters:
// struct SlateCore_SlateColor        InForegroundColor                                                (Parm, NativeAccessSpecifierPublic)

void UUserWidget::SetForegroundColor(const struct SlateCore_SlateColor& InForegroundColor)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, BlueprintCosmetic, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_Vector2D        Size                                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UUserWidget::SetDesiredSizeInViewport(const struct CoreUObject_Vector2D& Size)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, BlueprintCosmetic, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_LinearColor     InColorAndOpacity                                                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UUserWidget::SetColorAndOpacity(const struct CoreUObject_LinearColor& InColorAndOpacity)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, BlueprintCosmetic, Native, Public, BlueprintCallable)
// Parameters:
// struct Slate_Anchors               Anchors                                                          (Parm, NoDestructor, NativeAccessSpecifierPublic)

void UUserWidget::SetAnchorsInViewport(const struct Slate_Anchors& Anchors)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, BlueprintCosmetic, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_Vector2D        Alignment                                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UUserWidget::SetAlignmentInViewport(const struct CoreUObject_Vector2D& Alignment)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct SlateCore_Geometry          MyGeometry                                                       (Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct SlateCore_PointerEvent      InTouchEvent                                                     (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct UMG_EventReply              ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct UMG_EventReply UUserWidget::OnTouchStarted(const struct SlateCore_Geometry& MyGeometry, struct SlateCore_PointerEvent& InTouchEvent)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UUserWidget::OnTouchMoved(const struct SlateCore_Geometry& MyGeometry, struct SlateCore_PointerEvent& InTouchEvent)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct SlateCore_Geometry          MyGeometry                                                       (Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct SlateCore_PointerEvent      GestureEvent                                                     (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct UMG_EventReply              ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct UMG_EventReply UUserWidget::OnTouchGesture(const struct SlateCore_Geometry& MyGeometry, struct SlateCore_PointerEvent& GestureEvent)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UUserWidget::OnTouchForceChanged(const struct SlateCore_Geometry& MyGeometry, struct SlateCore_PointerEvent& InTouchEvent)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UUserWidget::OnTouchEnded(const struct SlateCore_Geometry& MyGeometry, struct SlateCore_PointerEvent& InTouchEvent)
{
	static class UFunction* Func = nullptr;
...
// (RequiredAPI, BlueprintCosmetic, Event, Public, BlueprintEvent)
// Parameters:
// struct SlateCore_FocusEvent        InFocusEvent                                                     (Parm, NoDestructor, NativeAccessSpecifierPublic)

void UUserWidget::OnRemovedFromFocusPath(const struct SlateCore_FocusEvent& InFocusEvent)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UUserWidget::OnPreviewMouseButtonDown(const struct SlateCore_Geometry& MyGeometry, struct SlateCore_PointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct SlateCore_Geometry          MyGeometry                                                       (Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct SlateCore_KeyEvent          InKeyEvent                                                       (Parm, NativeAccessSpecifierPublic)
// struct UMG_EventReply              ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct UMG_EventReply UUserWidget::OnPreviewKeyDown(const struct SlateCore_Geometry& MyGeometry, const struct SlateCore_KeyEvent& InKeyEvent)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct UMG_PaintContext            Context                                                          (Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void UUserWidget::OnPaint(struct UMG_PaintContext& Context)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UUserWidget::OnMouseWheel(const struct SlateCore_Geometry& MyGeometry, struct SlateCore_PointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UUserWidget::OnMouseMove(const struct SlateCore_Geometry& MyGeometry, struct SlateCore_PointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;
...
void UUserWidget::OnMouseLeave(struct SlateCore_PointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;
...
void UUserWidget::OnMouseEnter(const struct SlateCore_Geometry& MyGeometry, struct SlateCore_PointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UUserWidget::OnMouseButtonUp(const struct SlateCore_Geometry& MyGeometry, struct SlateCore_PointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UUserWidget::OnMouseButtonDown(const struct SlateCore_Geometry& MyGeometry, struct SlateCore_PointerEvent& MouseEvent)
{
	static class UFunction* Func = nullptr;
...
// (RequiredAPI, BlueprintCosmetic, Event, Public, HasOutParams, BlueprintEvent)
// Parameters:
// struct SlateCore_Geometry          InMyGeometry                                                     (Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct SlateCore_PointerEvent      InMouseEvent                                                     (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct UMG_EventReply              ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct UMG_EventReply UUserWidget::OnMouseButtonDoubleClick(const struct SlateCore_Geometry& InMyGeometry, struct SlateCore_PointerEvent& InMouseEvent)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct SlateCore_Geometry          MyGeometry                                                       (Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct SlateCore_MotionEvent       InMotionEvent                                                    (Parm, NativeAccessSpecifierPublic)
// struct UMG_EventReply              ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct UMG_EventReply UUserWidget::OnMotionDetected(const struct SlateCore_Geometry& MyGeometry, const struct SlateCore_MotionEvent& InMotionEvent)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UUserWidget::OnKeyUp(const struct SlateCore_Geometry& MyGeometry, const struct SlateCore_KeyEvent& InKeyEvent)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UUserWidget::OnKeyDown(const struct SlateCore_Geometry& MyGeometry, const struct SlateCore_KeyEvent& InKeyEvent)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct SlateCore_Geometry          MyGeometry                                                       (Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct SlateCore_CharacterEvent    InCharacterEvent                                                 (Parm, NativeAccessSpecifierPublic)
// struct UMG_EventReply              ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct UMG_EventReply UUserWidget::OnKeyChar(const struct SlateCore_Geometry& MyGeometry, const struct SlateCore_CharacterEvent& InCharacterEvent)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UUserWidget::OnFocusReceived(const struct SlateCore_Geometry& MyGeometry, const struct SlateCore_FocusEvent& InFocusEvent)
{
	static class UFunction* Func = nullptr;
...
void UUserWidget::OnFocusLost(const struct SlateCore_FocusEvent& InFocusEvent)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct SlateCore_Geometry          MyGeometry                                                       (Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct SlateCore_PointerEvent      PointerEvent                                                     (Parm, NativeAccessSpecifierPublic)
// class UDragDropOperation*          Operation                                                        (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UUserWidget::OnDrop(const struct SlateCore_Geometry& MyGeometry, const struct SlateCore_PointerEvent& PointerEvent, class UDragDropOperation* Operation)
{
	static class UFunction* Func = nullptr;
...
bool UUserWidget::OnDragOver(const struct SlateCore_Geometry& MyGeometry, const struct SlateCore_PointerEvent& PointerEvent, class UDragDropOperation* Operation)
{
	static class UFunction* Func = nullptr;
...
void UUserWidget::OnDragLeave(const struct SlateCore_PointerEvent& PointerEvent, class UDragDropOperation* Operation)
{
	static class UFunction* Func = nullptr;
...
void UUserWidget::OnDragEnter(const struct SlateCore_Geometry& MyGeometry, const struct SlateCore_PointerEvent& PointerEvent, class UDragDropOperation* Operation)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct SlateCore_Geometry          MyGeometry                                                       (Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct SlateCore_PointerEvent      PointerEvent                                                     (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
...
void UUserWidget::OnDragDetected(const struct SlateCore_Geometry& MyGeometry, struct SlateCore_PointerEvent& PointerEvent, class UDragDropOperation** Operation)
{
	static class UFunction* Func = nullptr;
...
void UUserWidget::OnDragCancelled(struct SlateCore_PointerEvent& PointerEvent, class UDragDropOperation* Operation)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct SlateCore_Geometry          MyGeometry                                                       (Parm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct SlateCore_AnalogInputEvent  InAnalogInputEvent                                               (Parm, NativeAccessSpecifierPublic)
// struct UMG_EventReply              ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct UMG_EventReply UUserWidget::OnAnalogValueChanged(const struct SlateCore_Geometry& MyGeometry, const struct SlateCore_AnalogInputEvent& InAnalogInputEvent)
{
	static class UFunction* Func = nullptr;
...
void UUserWidget::OnAddedToFocusPath(const struct SlateCore_FocusEvent& InFocusEvent)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, BlueprintCosmetic, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// struct Slate_Anchors               ReturnValue                                                      (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)

struct Slate_Anchors UUserWidget::GetAnchorsInViewport()
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D UUserWidget::GetAlignmentInViewport()
{
	static class UFunction* Func = nullptr;
...
struct SlateCore_SlateBrush UBrushBinding::GetValue()
{
	static class UFunction* Func = nullptr;
...
struct SlateCore_SlateColor UColorBinding::GetSlateValue()
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_LinearColor UColorBinding::GetLinearValue()
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct UMG_GameViewportWidgetSlot  Slot                                                             (Parm, NoDestructor, NativeAccessSpecifierPublic)
...
// struct CoreUObject_Vector2D        Position                                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               bRemoveDPIScale                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct UMG_GameViewportWidgetSlot  ReturnValue                                                      (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)

struct UMG_GameViewportWidgetSlot UGameViewportSubsystem::SetWidgetSlotPosition(const struct UMG_GameViewportWidgetSlot& Slot, class UWidget* Widget, const struct CoreUObject_Vector2D& Position, bool bRemoveDPIScale)
{
	static class UFunction* Func = nullptr;
...
struct UMG_GameViewportWidgetSlot UGameViewportSubsystem::SetWidgetSlotDesiredSize(const struct UMG_GameViewportWidgetSlot& Slot, const struct CoreUObject_Vector2D& Size)
{
	static class UFunction* Func = nullptr;
...
void UGameViewportSubsystem::SetWidgetSlot(class UWidget* Widget, const struct UMG_GameViewportWidgetSlot& Slot)
{
	static class UFunction* Func = nullptr;
...
struct UMG_GameViewportWidgetSlot UGameViewportSubsystem::GetWidgetSlot(class UWidget* Widget)
{
	static class UFunction* Func = nullptr;
...
bool UGameViewportSubsystem::AddWidgetForPlayer(class UWidget* Widget, class ULocalPlayer* Player, const struct UMG_GameViewportWidgetSlot& Slot)
{
	static class UFunction* Func = nullptr;
...
bool UGameViewportSubsystem::AddWidget(class UWidget* Widget, const struct UMG_GameViewportWidgetSlot& Slot)
{
	static class UFunction* Func = nullptr;
...
void UBackgroundBlur::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct SlateCore_SlateBrush        InBrush                                                          (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void UBackgroundBlur::SetLowQualityFallbackBrush(struct SlateCore_SlateBrush& InBrush)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct CoreUObject_Vector4         InCornerRadius                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UBackgroundBlur::SetCornerRadius(const struct CoreUObject_Vector4& InCornerRadius)
{
	static class UFunction* Func = nullptr;
...
void UBackgroundBlurSlot::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
void UBorder::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_Vector2D        InScale                                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UBorder::SetDesiredSizeScale(const struct CoreUObject_Vector2D& InScale)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_LinearColor     InContentColorAndOpacity                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UBorder::SetContentColorAndOpacity(const struct CoreUObject_LinearColor& InContentColorAndOpacity)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_LinearColor     InBrushColor                                                     (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UBorder::SetBrushColor(const struct CoreUObject_LinearColor& InBrushColor)
{
	static class UFunction* Func = nullptr;
...
void UBorder::SetBrush(struct SlateCore_SlateBrush& InBrush)
{
	static class UFunction* Func = nullptr;
...
void UBorderSlot::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct SlateCore_ButtonStyle       InStyle                                                          (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void UButton::SetStyle(struct SlateCore_ButtonStyle& InStyle)
{
	static class UFunction* Func = nullptr;
...
void UButton::SetColorAndOpacity(const struct CoreUObject_LinearColor& InColorAndOpacity)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_LinearColor     InBackgroundColor                                                (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UButton::SetBackgroundColor(const struct CoreUObject_LinearColor& InBackgroundColor)
{
	static class UFunction* Func = nullptr;
...
void UButtonSlot::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_Vector2D        InSize                                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UCanvasPanelSlot::SetSize(const struct CoreUObject_Vector2D& InSize)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_Vector2D        InPosition                                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UCanvasPanelSlot::SetPosition(const struct CoreUObject_Vector2D& InPosition)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// struct SlateCore_Margin            InOffset                                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)

void UCanvasPanelSlot::SetOffsets(const struct SlateCore_Margin& InOffset)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct CoreUObject_Vector2D        InMinimumAnchors                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UCanvasPanelSlot::SetMinimum(const struct CoreUObject_Vector2D& InMinimumAnchors)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults)
// Parameters:
// struct CoreUObject_Vector2D        InMaximumAnchors                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UCanvasPanelSlot::SetMaximum(const struct CoreUObject_Vector2D& InMaximumAnchors)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct UMG_AnchorData              InLayoutData                                                     (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void UCanvasPanelSlot::SetLayout(struct UMG_AnchorData& InLayoutData)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// struct Slate_Anchors               InAnchors                                                        (Parm, NoDestructor, NativeAccessSpecifierPublic)

void UCanvasPanelSlot::SetAnchors(const struct Slate_Anchors& InAnchors)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_Vector2D        InAlignment                                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UCanvasPanelSlot::SetAlignment(const struct CoreUObject_Vector2D& InAlignment)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D UCanvasPanelSlot::GetSize()
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D UCanvasPanelSlot::GetPosition()
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// struct SlateCore_Margin            ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)

struct SlateCore_Margin UCanvasPanelSlot::GetOffsets()
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// struct UMG_AnchorData              ReturnValue                                                      (Parm, OutParm, ReturnParm, NoDestructor, NativeAccessSpecifierPublic)

struct UMG_AnchorData UCanvasPanelSlot::GetLayout()
{
	static class UFunction* Func = nullptr;
...
struct Slate_Anchors UCanvasPanelSlot::GetAnchors()
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D UCanvasPanelSlot::GetAlignment()
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct UMG_RadialBoxSettings       InSettings                                                       (ConstParm, Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)

void UDynamicEntryBoxBase::SetRadialSettings(struct UMG_RadialBoxSettings& InSettings)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct CoreUObject_Vector2D        InEntrySpacing                                                   (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UDynamicEntryBoxBase::SetEntrySpacing(struct CoreUObject_Vector2D& InEntrySpacing)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// struct SlateCore_SlateFontInfo     InFontInfo                                                       (Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UEditableText::SetFont(const struct SlateCore_SlateFontInfo& InFontInfo)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// struct SlateCore_SlateFontInfo     ReturnValue                                                      (ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

struct SlateCore_SlateFontInfo UEditableText::GetFont()
{
	static class UFunction* Func = nullptr;
...
void UEditableTextBox::SetForegroundColor(const struct CoreUObject_LinearColor& Color)
{
	static class UFunction* Func = nullptr;
...
void UGridSlot::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_Vector2D        InNudge                                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UGridSlot::SetNudge(const struct CoreUObject_Vector2D& InNudge)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// struct UMG_SlateChildSize          InSize                                                           (Parm, NoDestructor, NativeAccessSpecifierPublic)

void UHorizontalBoxSlot::SetSize(const struct UMG_SlateChildSize& InSize)
{
	static class UFunction* Func = nullptr;
...
void UHorizontalBoxSlot::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_Vector2D        DesiredSize                                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UImage::SetDesiredSizeOverride(const struct CoreUObject_Vector2D& DesiredSize)
{
	static class UFunction* Func = nullptr;
...
void UImage::SetColorAndOpacity(const struct CoreUObject_LinearColor& InColorAndOpacity)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// struct SlateCore_SlateColor        TintColor                                                        (Parm, NativeAccessSpecifierPublic)

void UImage::SetBrushTintColor(const struct SlateCore_SlateColor& TintColor)
{
	static class UFunction* Func = nullptr;
...
void UImage::SetBrush(struct SlateCore_SlateBrush& InBrush)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct Slate_InputChord            InSelectedKey                                                    (ConstParm, Parm, OutParm, ReferenceParm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UInputKeySelector::SetSelectedKey(struct Slate_InputChord& InSelectedKey)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// TArray<struct InputCore_Key>       InKeys                                                           (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)

void UInputKeySelector::SetEscapeKeys(TArray<struct InputCore_Key>& InKeys)
{
	static class UFunction* Func = nullptr;
...
// (MulticastDelegate, Public, Delegate)
// Parameters:
// struct Slate_InputChord            SelectedKey                                                      (Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UInputKeySelector::OnKeySelected__DelegateSignature(const struct Slate_InputChord& SelectedKey)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D UMenuAnchor::GetMenuPosition()
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct SlateCore_TextBlockStyle    InWidgetStyle                                                    (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void UMultiLineEditableText::SetWidgetStyle(struct SlateCore_TextBlockStyle& InWidgetStyle)
{
	static class UFunction* Func = nullptr;
...
void UMultiLineEditableText::SetFont(const struct SlateCore_SlateFontInfo& InFontInfo)
{
	static class UFunction* Func = nullptr;
...
struct SlateCore_SlateFontInfo UMultiLineEditableText::GetFont()
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct SlateCore_TextBlockStyle    InTextStyle                                                      (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void UMultiLineEditableTextBox::SetTextStyle(struct SlateCore_TextBlockStyle& InTextStyle)
{
	static class UFunction* Func = nullptr;
...
void UMultiLineEditableTextBox::SetForegroundColor(const struct CoreUObject_LinearColor& Color)
{
	static class UFunction* Func = nullptr;
...
void UOverlaySlot::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
void UProgressBar::SetUseImageSize(bool InbUseImageSize)
{
	...
	Params::UProgressBar_SetUseImageSize_Params Parms{};
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_LinearColor     InColor                                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UProgressBar::SetFillColorAndOpacity(const struct CoreUObject_LinearColor& InColor)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct SlateCore_TextBlockStyle    InDefaultTextStyle                                               (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void URichTextBlock::SetDefaultTextStyle(struct SlateCore_TextBlockStyle& InDefaultTextStyle)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct SlateCore_SlateBrush        InStrikeBrush                                                    (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)

void URichTextBlock::SetDefaultStrikeBrush(struct SlateCore_SlateBrush& InStrikeBrush)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_Vector2D        InShadowOffset                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void URichTextBlock::SetDefaultShadowOffset(const struct CoreUObject_Vector2D& InShadowOffset)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_LinearColor     InShadowColorAndOpacity                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void URichTextBlock::SetDefaultShadowColorAndOpacity(const struct CoreUObject_LinearColor& InShadowColorAndOpacity)
{
	static class UFunction* Func = nullptr;
...
void URichTextBlock::SetDefaultFont(const struct SlateCore_SlateFontInfo& InFontInfo)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// struct SlateCore_SlateColor        InColorAndOpacity                                                (Parm, NativeAccessSpecifierPublic)

void URichTextBlock::SetDefaultColorAndOpacity(const struct SlateCore_SlateColor& InColorAndOpacity)
{
	static class UFunction* Func = nullptr;
...
void UScaleBoxSlot::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasOutParams, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_Vector2D        NewScrollbarThickness                                            (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UScrollBox::SetScrollbarThickness(struct CoreUObject_Vector2D& NewScrollbarThickness)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasOutParams, BlueprintCallable)
// Parameters:
// struct SlateCore_Margin            NewScrollbarPadding                                              (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)

void UScrollBox::SetScrollbarPadding(struct SlateCore_Margin& NewScrollbarPadding)
{
	static class UFunction* Func = nullptr;
...
void UScrollBoxSlot::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
void USizeBoxSlot::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_LinearColor     InValue                                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void USlider::SetSliderHandleColor(const struct CoreUObject_LinearColor& InValue)
{
	static class UFunction* Func = nullptr;
...
void USlider::SetSliderBarColor(const struct CoreUObject_LinearColor& InValue)
{
	static class UFunction* Func = nullptr;
...
void USpacer::SetSize(const struct CoreUObject_Vector2D& InSize)
{
	static class UFunction* Func = nullptr;
...
void USpinBox::SetForegroundColor(const struct SlateCore_SlateColor& InForegroundColor)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// struct SlateCore_SlateBrush        InStrikeBrush                                                    (Parm, NativeAccessSpecifierPublic)

void UTextBlock::SetStrikeBrush(const struct SlateCore_SlateBrush& InStrikeBrush)
{
	static class UFunction* Func = nullptr;
...
void UTextBlock::SetShadowOffset(const struct CoreUObject_Vector2D& InShadowOffset)
{
	static class UFunction* Func = nullptr;
...
void UTextBlock::SetShadowColorAndOpacity(const struct CoreUObject_LinearColor& InShadowColorAndOpacity)
{
	static class UFunction* Func = nullptr;
...
void UTextBlock::SetFont(const struct SlateCore_SlateFontInfo& InFontInfo)
{
	static class UFunction* Func = nullptr;
...
void UTextBlock::SetColorAndOpacity(const struct SlateCore_SlateColor& InColorAndOpacity)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// struct SlateCore_Margin            InSlotPadding                                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)

void UUniformGridPanel::SetSlotPadding(const struct SlateCore_Margin& InSlotPadding)
{
	static class UFunction* Func = nullptr;
...
void UVerticalBoxSlot::SetSize(const struct UMG_SlateChildSize& InSize)
{
	static class UFunction* Func = nullptr;
...
void UVerticalBoxSlot::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
void UViewport::SetViewRotation(const struct CoreUObject_Rotator& Rotation)
{
	static class UFunction* Func = nullptr;
...
void UViewport::SetViewLocation(const struct CoreUObject_Vector& Location)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Rotator UViewport::GetViewRotation()
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector UViewport::GetViewLocation()
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_LinearColor     NewTintColorAndOpacity                                           (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWidgetComponent::SetTintColorAndOpacity(const struct CoreUObject_LinearColor& NewTintColorAndOpacity)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct CoreUObject_Vector2D        InPivot                                                          (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWidgetComponent::SetPivot(struct CoreUObject_Vector2D& InPivot)
{
	static class UFunction* Func = nullptr;
...
void UWidgetComponent::SetDrawSize(const struct CoreUObject_Vector2D& Size)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_LinearColor     NewBackgroundColor                                               (ConstParm, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWidgetComponent::SetBackgroundColor(const struct CoreUObject_LinearColor& NewBackgroundColor)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D UWidgetComponent::GetPivot()
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D UWidgetComponent::GetDrawSize()
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D UWidgetComponent::GetCurrentDrawSize()
{
	static class UFunction* Func = nullptr;
...
void UWidgetInteractionComponent::SetCustomHitResult(struct Engine_HitResult& HitResult)
{
	static class UFunction* Func = nullptr;
...
void UWidgetInteractionComponent::ReleasePointerKey(const struct InputCore_Key& Key)
{
	static class UFunction* Func = nullptr;
...
bool UWidgetInteractionComponent::ReleaseKey(const struct InputCore_Key& Key)
{
	static class UFunction* Func = nullptr;
...
void UWidgetInteractionComponent::PressPointerKey(const struct InputCore_Key& Key)
{
	static class UFunction* Func = nullptr;
...
bool UWidgetInteractionComponent::PressKey(const struct InputCore_Key& Key, bool bRepeat)
{
	static class UFunction* Func = nullptr;
...
bool UWidgetInteractionComponent::PressAndReleaseKey(const struct InputCore_Key& Key)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable, BlueprintPure, Const)
// Parameters:
// struct Engine_HitResult            ReturnValue                                                      (ConstParm, Parm, OutParm, ReturnParm, ReferenceParm, IsPlainOldData, NoDestructor, ContainsInstancedReference, NativeAccessSpecifierPublic)

struct Engine_HitResult UWidgetInteractionComponent::GetLastHitResult()
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D UWidgetInteractionComponent::Get2DHitLocation()
{
	static class UFunction* Func = nullptr;
...
void UWidgetSwitcherSlot::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
void UWindowTitleBarArea::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
void UWindowTitleBarAreaSlot::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Public, HasDefaults, BlueprintCallable)
// Parameters:
// struct CoreUObject_Vector2D        InPadding                                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWrapBox::SetInnerSlotPadding(const struct CoreUObject_Vector2D& InPadding)
{
	static class UFunction* Func = nullptr;
...
void UWrapBoxSlot::SetPadding(const struct SlateCore_Margin& InPadding)
{
	static class UFunction* Func = nullptr;
...
void UDragDropOperation::Drop(struct SlateCore_PointerEvent& PointerEvent)
{
	static class UFunction* Func = nullptr;
...
void UDragDropOperation::Dragged(struct SlateCore_PointerEvent& PointerEvent)
{
	static class UFunction* Func = nullptr;
...
void UDragDropOperation::DragCancelled(struct SlateCore_PointerEvent& PointerEvent)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct SlateCore_Geometry          Geometry                                                         (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        LocalVector                                                      (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

struct CoreUObject_Vector2D USlateBlueprintLibrary::TransformVectorLocalToAbsolute(struct SlateCore_Geometry& Geometry, const struct CoreUObject_Vector2D& LocalVector)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct SlateCore_Geometry          Geometry                                                         (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        AbsoluteVector                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

struct CoreUObject_Vector2D USlateBlueprintLibrary::TransformVectorAbsoluteToLocal(struct SlateCore_Geometry& Geometry, const struct CoreUObject_Vector2D& AbsoluteVector)
{
	static class UFunction* Func = nullptr;
...
float USlateBlueprintLibrary::TransformScalarLocalToAbsolute(struct SlateCore_Geometry& Geometry, float LocalScalar)
{
	static class UFunction* Func = nullptr;
...
float USlateBlueprintLibrary::TransformScalarAbsoluteToLocal(struct SlateCore_Geometry& Geometry, float AbsoluteScalar)
{
	static class UFunction* Func = nullptr;
...
// struct SlateCore_Geometry          Geometry                                                         (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        ScreenPosition                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        LocalCoordinate                                                  (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void USlateBlueprintLibrary::ScreenToWidgetLocal(class UObject* WorldContextObject, struct SlateCore_Geometry& Geometry, const struct CoreUObject_Vector2D& ScreenPosition, struct CoreUObject_Vector2D* LocalCoordinate, bool bIncludeWindowPosition)
{
	static class UFunction* Func = nullptr;
...
// class UObject*                     WorldContextObject                                               (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        ScreenPosition                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        AbsoluteCoordinate                                               (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               bIncludeWindowPosition                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void USlateBlueprintLibrary::ScreenToWidgetAbsolute(class UObject* WorldContextObject, const struct CoreUObject_Vector2D& ScreenPosition, struct CoreUObject_Vector2D* AbsoluteCoordinate, bool bIncludeWindowPosition)
{
	static class UFunction* Func = nullptr;
...
// class UObject*                     WorldContextObject                                               (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        ScreenPosition                                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        ViewportPosition                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void USlateBlueprintLibrary::ScreenToViewport(class UObject* WorldContextObject, const struct CoreUObject_Vector2D& ScreenPosition, struct CoreUObject_Vector2D* ViewportPosition)
{
	static class UFunction* Func = nullptr;
...
// class UObject*                     WorldContextObject                                               (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct SlateCore_Geometry          Geometry                                                         (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        LocalCoordinate                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        PixelPosition                                                    (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        ViewportPosition                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void USlateBlueprintLibrary::LocalToViewport(class UObject* WorldContextObject, struct SlateCore_Geometry& Geometry, const struct CoreUObject_Vector2D& LocalCoordinate, struct CoreUObject_Vector2D* PixelPosition, struct CoreUObject_Vector2D* ViewportPosition)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D USlateBlueprintLibrary::LocalToAbsolute(struct SlateCore_Geometry& Geometry, const struct CoreUObject_Vector2D& LocalCoordinate)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct SlateCore_Geometry          Geometry                                                         (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        AbsoluteCoordinate                                               (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool USlateBlueprintLibrary::IsUnderLocation(struct SlateCore_Geometry& Geometry, struct CoreUObject_Vector2D& AbsoluteCoordinate)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D USlateBlueprintLibrary::GetLocalTopLeft(struct SlateCore_Geometry& Geometry)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D USlateBlueprintLibrary::GetLocalSize(struct SlateCore_Geometry& Geometry)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D USlateBlueprintLibrary::GetAbsoluteSize(struct SlateCore_Geometry& Geometry)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// struct SlateCore_SlateBrush        A                                                                (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct SlateCore_SlateBrush        B                                                                (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool USlateBlueprintLibrary::EqualEqual_SlateBrush(struct SlateCore_SlateBrush& A, struct SlateCore_SlateBrush& B)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class UObject*                     WorldContextObject                                               (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        AbsoluteDesktopCoordinate                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        PixelPosition                                                    (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        ViewportPosition                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void USlateBlueprintLibrary::AbsoluteToViewport(class UObject* WorldContextObject, const struct CoreUObject_Vector2D& AbsoluteDesktopCoordinate, struct CoreUObject_Vector2D* PixelPosition, struct CoreUObject_Vector2D* ViewportPosition)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct SlateCore_Geometry          Geometry                                                         (ConstParm, Parm, OutParm, ReferenceParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        AbsoluteCoordinate                                               (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

struct CoreUObject_Vector2D USlateBlueprintLibrary::AbsoluteToLocal(struct SlateCore_Geometry& Geometry, const struct CoreUObject_Vector2D& AbsoluteCoordinate)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// struct UMG_EventReply              Reply                                                            (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct UMG_EventReply              ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct UMG_EventReply UWidgetBlueprintLibrary::UnlockMouse(struct UMG_EventReply& Reply)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UWidgetBlueprintLibrary::Unhandled()
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UWidgetBlueprintLibrary::SetUserFocus(struct UMG_EventReply& Reply, class UWidget* FocusWidget, bool bInAllUsers)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct UMG_EventReply              Reply                                                            (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        NewMousePosition                                                 (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct UMG_EventReply              ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct UMG_EventReply UWidgetBlueprintLibrary::SetMousePosition(struct UMG_EventReply& Reply, const struct CoreUObject_Vector2D& NewMousePosition)
{
	static class UFunction* Func = nullptr;
...
// struct CoreUObject_Vector2D        HotSpot                                                          (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

bool UWidgetBlueprintLibrary::SetHardwareCursor(class UObject* WorldContextObject, enum class EMouseCursor CursorShape, class FName CursorName, const struct CoreUObject_Vector2D& HotSpot)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct SlateCore_SlateBrush        Brush                                                            (Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// class UTexture2D*                  Texture                                                          (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWidgetBlueprintLibrary::SetBrushResourceToTexture(struct SlateCore_SlateBrush& Brush, class UTexture2D* Texture)
{
	static class UFunction* Func = nullptr;
...
void UWidgetBlueprintLibrary::SetBrushResourceToMaterial(struct SlateCore_SlateBrush& Brush, class UMaterialInterface* Material)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UWidgetBlueprintLibrary::ReleaseMouseCapture(struct UMG_EventReply& Reply)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UWidgetBlueprintLibrary::ReleaseJoystickCapture(struct UMG_EventReply& Reply, bool bInAllJoysticks)
{
	static class UFunction* Func = nullptr;
...
struct SlateCore_SlateBrush UWidgetBlueprintLibrary::NoResourceBrush()
{
	static class UFunction* Func = nullptr;
...
struct SlateCore_SlateBrush UWidgetBlueprintLibrary::MakeBrushFromTexture(class UTexture2D* Texture, int32 Width, int32 Height)
{
	static class UFunction* Func = nullptr;
...
struct SlateCore_SlateBrush UWidgetBlueprintLibrary::MakeBrushFromMaterial(class UMaterialInterface* Material, int32 Width, int32 Height)
{
	static class UFunction* Func = nullptr;
...
struct SlateCore_SlateBrush UWidgetBlueprintLibrary::MakeBrushFromAsset(class USlateBrushAsset* BrushAsset)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UWidgetBlueprintLibrary::LockMouse(struct UMG_EventReply& Reply, class UWidget* CapturingWidget)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UWidgetBlueprintLibrary::Handled()
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class UObject*                     WorldContextObject                                               (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector4         SafePadding                                                      (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        SafePaddingScale                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector4         SpillOverPadding                                                 (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWidgetBlueprintLibrary::GetSafeZonePadding(class UObject* WorldContextObject, struct CoreUObject_Vector4* SafePadding, struct CoreUObject_Vector2D* SafePaddingScale, struct CoreUObject_Vector4* SpillOverPadding)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// struct SlateCore_AnalogInputEvent  Event                                                            (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct SlateCore_KeyEvent          ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct SlateCore_KeyEvent UWidgetBlueprintLibrary::GetKeyEventFromAnalogInputEvent(struct SlateCore_AnalogInputEvent& Event)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// struct SlateCore_PointerEvent      Event                                                            (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct SlateCore_InputEvent        ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct SlateCore_InputEvent UWidgetBlueprintLibrary::GetInputEventFromPointerEvent(struct SlateCore_PointerEvent& Event)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// struct SlateCore_NavigationEvent   Event                                                            (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct SlateCore_InputEvent        ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct SlateCore_InputEvent UWidgetBlueprintLibrary::GetInputEventFromNavigationEvent(struct SlateCore_NavigationEvent& Event)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// struct SlateCore_KeyEvent          Event                                                            (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct SlateCore_InputEvent        ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct SlateCore_InputEvent UWidgetBlueprintLibrary::GetInputEventFromKeyEvent(struct SlateCore_KeyEvent& Event)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// struct SlateCore_CharacterEvent    Event                                                            (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// struct SlateCore_InputEvent        ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct SlateCore_InputEvent UWidgetBlueprintLibrary::GetInputEventFromCharacterEvent(struct SlateCore_CharacterEvent& Event)
{
	static class UFunction* Func = nullptr;
...
class UMaterialInstanceDynamic* UWidgetBlueprintLibrary::GetDynamicMaterial(struct SlateCore_SlateBrush& Brush)
{
	static class UFunction* Func = nullptr;
...
// (Final, RequiredAPI, Native, Static, Public, HasOutParams, BlueprintCallable, BlueprintPure)
// Parameters:
// struct SlateCore_SlateBrush        Brush                                                            (ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
// class UTexture2D*                  ReturnValue                                                      (Parm, OutParm, ZeroConstructor, ReturnParm, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

class UTexture2D* UWidgetBlueprintLibrary::GetBrushResourceAsTexture2D(struct SlateCore_SlateBrush& Brush)
{
	static class UFunction* Func = nullptr;
...
class UMaterialInterface* UWidgetBlueprintLibrary::GetBrushResourceAsMaterial(struct SlateCore_SlateBrush& Brush)
{
	static class UFunction* Func = nullptr;
...
class UObject* UWidgetBlueprintLibrary::GetBrushResource(struct SlateCore_SlateBrush& Brush)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UWidgetBlueprintLibrary::EndDragDrop(struct UMG_EventReply& Reply)
{
	static class UFunction* Func = nullptr;
...
// struct CoreUObject_LinearColor     Tint                                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWidgetBlueprintLibrary::DrawTextFormatted(struct UMG_PaintContext& Context, class FText& Text, const struct CoreUObject_Vector2D& Position, class UFont* Font, float FontSize, class FName FontTypeFace, const struct CoreUObject_LinearColor& Tint)
{
	static class UFunction* Func = nullptr;
...
void UWidgetBlueprintLibrary::DrawText(struct UMG_PaintContext& Context, const class FString& InString, const struct CoreUObject_Vector2D& Position, const struct CoreUObject_LinearColor& Tint)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct UMG_PaintContext            Context                                                          (Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        Start                                                            (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        StartDir                                                         (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        End                                                              (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        EndDir                                                           (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_LinearColor     Tint                                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UWidgetBlueprintLibrary::DrawSpline(struct UMG_PaintContext& Context, const struct CoreUObject_Vector2D& Start, const struct CoreUObject_Vector2D& StartDir, const struct CoreUObject_Vector2D& End, const struct CoreUObject_Vector2D& EndDir, const struct CoreUObject_LinearColor& Tint, float Thickness)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct UMG_PaintContext            Context                                                          (Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// TArray<struct CoreUObject_Vector2D>Points                                                           (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, NativeAccessSpecifierPublic)
// struct CoreUObject_LinearColor     Tint                                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UWidgetBlueprintLibrary::DrawLines(struct UMG_PaintContext& Context, TArray<struct CoreUObject_Vector2D>& Points, const struct CoreUObject_LinearColor& Tint, bool bAntiAlias, float Thickness)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// struct UMG_PaintContext            Context                                                          (Parm, OutParm, ReferenceParm, NoDestructor, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        PositionA                                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector2D        PositionB                                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_LinearColor     Tint                                                             (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// bool                               bAntiAlias                                                       (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                              Thickness                                                        (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UWidgetBlueprintLibrary::DrawLine(struct UMG_PaintContext& Context, const struct CoreUObject_Vector2D& PositionA, const struct CoreUObject_Vector2D& PositionB, const struct CoreUObject_LinearColor& Tint, bool bAntiAlias, float Thickness)
{
	static class UFunction* Func = nullptr;
...
void UWidgetBlueprintLibrary::DrawBox(struct UMG_PaintContext& Context, const struct CoreUObject_Vector2D& Position, const struct CoreUObject_Vector2D& Size, class USlateBrushAsset* Brush, const struct CoreUObject_LinearColor& Tint)
{
	static class UFunction* Func = nullptr;
...
// struct InputCore_Key               DragKey                                                          (Parm, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct UMG_EventReply              ReturnValue                                                      (Parm, OutParm, ReturnParm, NativeAccessSpecifierPublic)

struct UMG_EventReply UWidgetBlueprintLibrary::DetectDragIfPressed(struct SlateCore_PointerEvent& PointerEvent, class UWidget* WidgetDetectingDrag, const struct InputCore_Key& DragKey)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UWidgetBlueprintLibrary::DetectDrag(struct UMG_EventReply& Reply, class UWidget* WidgetDetectingDrag, const struct InputCore_Key& DragKey)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UWidgetBlueprintLibrary::ClearUserFocus(struct UMG_EventReply& Reply, bool bInAllUsers)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UWidgetBlueprintLibrary::CaptureMouse(struct UMG_EventReply& Reply, class UWidget* CapturingWidget)
{
	static class UFunction* Func = nullptr;
...
struct UMG_EventReply UWidgetBlueprintLibrary::CaptureJoystick(struct UMG_EventReply& Reply, class UWidget* CapturingWidget, bool bInAllJoysticks)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class APlayerController*           PlayerController                                                 (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct CoreUObject_Vector          WorldLocation                                                    (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
bool UWidgetLayoutLibrary::ProjectWorldLocationToWidgetPosition(class APlayerController* PlayerController, const struct CoreUObject_Vector& WorldLocation, struct CoreUObject_Vector2D* ScreenPosition, bool bPlayerViewportRelative)
{
	static class UFunction* Func = nullptr;
...
// Parameters:
// class UObject*                     WorldContextObject                                               (Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// struct SlateCore_Geometry          ReturnValue                                                      (Parm, OutParm, ReturnParm, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)

struct SlateCore_Geometry UWidgetLayoutLibrary::GetViewportWidgetGeometry(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D UWidgetLayoutLibrary::GetViewportSize(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
struct SlateCore_Geometry UWidgetLayoutLibrary::GetPlayerScreenWidgetGeometry(class APlayerController* PlayerController)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D UWidgetLayoutLibrary::GetMousePositionOnViewport(class UObject* WorldContextObject)
{
	static class UFunction* Func = nullptr;
...
struct CoreUObject_Vector2D UWidgetLayoutLibrary::GetMousePositionOnPlatform()
{
	static class UFunction* Func = nullptr;
