...
public:
	...
	struct CoreUObject_Color                     VertexOverrideColor;                               // 0xEC(0x4)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
public:
	...
	uint8                                        Pad_18C5[0x1];                                     // Fixing Size Of Struct 
...
{
public:
	TMap<class FString, struct CoreUObject_SoftObjectPath> MaterialParents;                                   // 0x38(0x50)(Edit, Config, NativeAccessSpecifierPublic)
	uint8                                        Pad_18CB[0x8];                                     // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_18D1[0x8];                                     // Fixing Size After Last Property  
...
{
public:
	TMap<enum class EInterchangeMaterialXShaders, struct CoreUObject_SoftObjectPath> PredefinedSurfaceShaders;                          // 0x38(0x50)(Edit, Config, NativeAccessSpecifierPublic)
...
{
public:
	uint8                                        Pad_18F1[0x8];                                     // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_1903[0x1];                                     // Fixing Size After Last Property  
	struct CoreUObject_Int32Interval             FrameImportRange;                                  // 0xFC(0x8)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1911[0x1F];                                    // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_1916[0x6];                                     // Fixing Size After Last Property  
	class FString                                AssetName;                                         // 0xF0(0x10)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Vector                    ImportOffsetTranslation;                           // 0x100(0x18)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct CoreUObject_Rotator                   ImportOffsetRotation;                              // 0x118(0x18)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_191D[0x4];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_1920[0x18];                                    // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_192F[0x7];                                     // Fixing Size After Last Property  
	struct CoreUObject_SoftObjectPath            ParentMaterial;                                    // 0x108(0x20)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1935[0x48];                                    // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_1945[0x2];                                     // Fixing Size After Last Property  
	...
	struct CoreUObject_Vector                    BuildScale3D;                                      // 0x118(0x18)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1963[0x1];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_196B[0x50];                                    // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_1979[0xA];                                     // Fixing Size Of Struct 
...
public:
	...
	uint8                                        Pad_1984[0x7];                                     // Fixing Size After Last Property  
	class FString                                AssetName;                                         // 0xF0(0x10)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	uint8                                        Pad_1987[0x30];                                    // Fixing Size Of Struct 
...
{
public:
	uint8                                        Pad_1A65[0x100];                                   // Fixing Size Of Struct 

	static class UClass* StaticClass();
	static class UInterchangePipelineMeshesUtilities* GetDefaultObj();

	void SetContext(struct InterchangePipelines_InterchangePipelineMeshesUtilitiesContext& Context);
	...
	struct InterchangePipelines_InterchangeMeshInstance GetMeshInstanceByUid(const class FString& MeshInstanceUid);
	class FString GetMeshGeometrySkeletonRootUid(const class FString& MeshGeometryUid);
	struct InterchangePipelines_InterchangeMeshGeometry GetMeshGeometryByUid(const class FString& MeshGeometryUid);
