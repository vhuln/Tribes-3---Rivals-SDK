...
struct ABP_Pickup_ShieldPack_C_GetContextDescriptionOverride_Params
{
public:
...
struct ABP_Pickup_ShieldPack_C_GetContextTitleOverride_Params
{
public:
	class FText                                  ReturnValue;                                       // 0x0(0x18)(Parm, OutParm, ReturnParm)
};
...
struct ABP_Pickup_ShieldPack_C_GetPreviewDetectionOffset_Params
{
public:
...
struct ABP_Pickup_ShieldPack_C_GetContextPingRarity_Params
{
public:
...
struct ABP_Pickup_ShieldPack_C_GetPingOffset_Params
{
public:
	struct CoreUObject_Vector                    ReturnValue;                                       // 0x0(0x18)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
struct ABP_Pickup_ShieldPack_C_GetContextPingType_Params
{
public:
...
struct ABP_Pickup_ShieldPack_C_CustomPickupFunc_Params
{
public:
	...
	uint8                                        Pad_301C[0x3];                                     // Fixing Size After Last Property  
	...
	bool                                         CallFunc_AddShieldPickup_ReturnValue;              // 0x20(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                        Pad_3031[0x3];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_303A[0x3];                                     // Fixing Size After Last Property  
...
struct ABP_Pickup_ShieldPack_C_CharacterPickupCheck_Params
{
public:
	class AValCharacter*                         ValCharacter;                                      // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	bool                                         ReturnValue;                                       // 0x8(0x1)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_3068[0x2];                                     // Fixing Size After Last Property  
	...
	uint8                                        Pad_3072[0x3];                                     // Fixing Size After Last Property  
...
struct ABP_Pickup_ShieldPack_C_ReceiveTick_Params
{
public:
...
struct ABP_Pickup_ShieldPack_C_ExecuteUbergraph_BP_Pickup_ShieldPack_Params
{
public:
	...
	uint8                                        Pad_30F3[0x4];                                     // Fixing Size After Last Property  
