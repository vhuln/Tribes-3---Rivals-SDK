...
// struct CoreUObject_Vector          HurtOrigin                                                       (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UDestructibleComponent::ApplyRadiusDamage(float BaseDamage, struct CoreUObject_Vector& HurtOrigin, float DamageRadius, float ImpulseStrength, bool bFullDamage)
{
	static class UFunction* Func = nullptr;
...
// struct CoreUObject_Vector          ImpulseDir                                                       (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
// float                              ImpulseStrength                                                  (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UDestructibleComponent::ApplyDamage(float DamageAmount, struct CoreUObject_Vector& HitLocation, struct CoreUObject_Vector& ImpulseDir, float ImpulseStrength)
{
	static class UFunction* Func = nullptr;
