...
public:
	...
	struct CoreUObject_Vector                    Occlusion_Location;                                // 0xA8(0x18)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_25E7[0x7];                                     // Fixing Size After Last Property  
	...
	struct CoreUObject_Vector                    Rain_Velocity;                                     // 0xF8(0x18)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                        Pad_25FD[0x5];                                     // Fixing Size After Last Property  
	...
	void Get_Occlusion_Location(class APlayerCameraManager* CallFunc_GetPlayerCameraManager_ReturnValue, bool CallFunc_IsValid_ReturnValue, const struct CoreUObject_Vector& CallFunc_GetCameraLocation_ReturnValue);
	void Get_Starting_Occlusion_Profile(const struct Engine_TimerHandle& CallFunc_K2_SetTimer_ReturnValue, const struct Engine_TimerHandle& CallFunc_K2_SetTimerForNextTick_ReturnValue, bool CallFunc_EqualEqual_VectorVector_ReturnValue, float CallFunc_K2_SetTimer_Time_ImplicitCast);
	void Initialize(const struct Engine_TimerHandle& CallFunc_K2_SetTimerForNextTick_ReturnValue);
