...
{
public:
	struct AudioCapture_AudioCaptureDeviceInfo   OutInfo;                                           // 0x0(0x10)(Parm, OutParm, NoDestructor, NativeAccessSpecifierPublic)
...
{
public:
	struct AudioCapture_AudioInputDeviceInfo     Info;                                              // 0x0(0x30)(ConstParm, Parm, OutParm, ReferenceParm, NativeAccessSpecifierPublic)
