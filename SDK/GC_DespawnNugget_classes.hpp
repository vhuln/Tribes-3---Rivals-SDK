...
class AGC_DespawnNugget_C : public AGameplayCueNotify_Actor
{
public:
	class UNiagaraComponent*                     Niagara;                                           // 0x308(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	static class AGC_DespawnNugget_C* GetDefaultObj();
